...
const meta = {
  ...
  argTypes: {
    platform: {
      control: 'select',
      options: ['facebook', 'google', 'apple', 'figma', 'dribbble', 'x(twitter)'],
    },
...
export const Matrix: Story = {
  ...
  render: () => (
    ...
    >
      ...
      <SocialIcon platform="x(twitter)" state="default" style="white" />
      <SocialIcon platform="x(twitter)" state="default" style="brand" />
    </div>
  ),
};
