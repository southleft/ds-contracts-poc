...
const ICONS: Record<string, string> = {
  'arrow-up':
    '<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n<path d="M12 19V5M19 12L12 5L5 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>\n</svg>',
};

export interface ArrowUpProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'children'> {}
