 ...
 * Source of truth: contracts/au.contract.json (ds.au v0.1.0)
...
export const AU = forwardRef<HTMLSpanElement, AUProps>(function AU({ className, ...rest }, ref) {
  ...
  return (
    <span ref={ref} className={classes} {...rest}>
      <span
        ...
        aria-hidden="true"
        dangerouslySetInnerHTML={{ __html: ICONS['au'] }}
      />
    </span>
  );
});
