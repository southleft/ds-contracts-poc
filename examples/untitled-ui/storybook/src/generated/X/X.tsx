...
export interface XProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'children'> {}
...
export const X = forwardRef<HTMLSpanElement, XProps>(function X({ className, ...rest }, ref) {
