/**
 * Tailwind genesis token sync — `node examples/tailwind/scripts/build-figma-tokens.mjs`
 *
 ...
 * variables — one "Tailwind" collection, Light/Dark modes — plus the minted
...
const base = read('tokens/tailwind.dtcg.json');
let light = {}, dark = {};
try { light = read('tokens/modes/tailwind.light.dtcg.json'); dark = read('tokens/modes/tailwind.dark.dtcg.json'); } catch { /* single-mode theme */ }
...
try {
  ...
  walk(read('tokens/tailwind-minted.dtcg.json'), []);
