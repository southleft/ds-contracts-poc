...
const COMPONENTS = [
  {
    ...
    "stateVariants": [
      ...
      {
        "name": "Checked=Checked, State=Disabled",
        "row": 1,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Checked=Indeterminate, State=Disabled",
        "row": 2,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Checked=Unchecked, State=Focus Visible",
        "row": 0,
        "col": 2,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Checked=Checked, State=Focus Visible",
        "row": 1,
        "col": 2,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Checked=Indeterminate, State=Focus Visible",
        "row": 2,
        "col": 2,
        "spec": {
          "type": "root",
