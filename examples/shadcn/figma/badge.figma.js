...
const COMPONENTS = [
  {
    ...
    "variants": [
      {
        ...
        "spec": {
          ...
          "bindings": {
            "bottomLeftRadius": "imported/shared/size-26",
            "bottomRightRadius": "imported/shared/size-26",
            "strokeBottomWeight": "imported/shared/size-1",
            "strokeLeftWeight": "imported/shared/size-1",
            "strokeRightWeight": "imported/shared/size-1",
            "topLeftRadius": "imported/shared/size-26",
            "topRightRadius": "imported/shared/size-26",
    ...
    "stateVariants": [
      ...
      {
        "name": "Variant=Destructive, State=Active",
        "row": 2,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Variant=Outline, State=Active",
        "row": 3,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Variant=Ghost, State=Active",
        "row": 4,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Variant=Link, State=Active",
        "row": 5,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Variant=Destructive, State=Hover",
        "row": 2,
        "col": 2,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Variant=Outline, State=Hover",
        "row": 3,
        "col": 2,
        "spec": {
          "type": "root",
    ...
    "stateReactions": [
      {
        ...
        "trigger": "ON_HOVER",
        "to": "Variant=Default, State=Hover"
      },
      {
        "from": "Variant=Default, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Default, State=Active"
      },
      {
      ...
      },
      {
        "from": "Variant=Secondary, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Secondary, State=Active"
      },
      {
        "from": "Variant=Destructive, State=Default",
        "trigger": "ON_HOVER",
        "to": "Variant=Destructive, State=Hover"
      },
      {
        "from": "Variant=Destructive, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Destructive, State=Active"
      },
      {
        "from": "Variant=Outline, State=Default",
        "trigger": "ON_HOVER",
        "to": "Variant=Outline, State=Hover"
      },
      {
        "from": "Variant=Outline, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Outline, State=Active"
      },
      {
        "from": "Variant=Ghost, State=Default",
        "trigger": "ON_HOVER",
        "to": "Variant=Ghost, State=Hover"
      },
      {
        "from": "Variant=Ghost, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Ghost, State=Active"
      },
      {
        "from": "Variant=Link, State=Default",
        "trigger": "ON_HOVER",
        "to": "Variant=Link, State=Hover"
      },
      {
        "from": "Variant=Link, State=Default",
        "trigger": "ON_PRESS",
