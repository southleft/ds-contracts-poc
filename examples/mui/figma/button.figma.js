...
const COMPONENTS = [
  {
    ...
    "version": "0.2.0",
    "anchorKey": null,
    "description": "Button — generated from contract mui.button v0.2.0 † (19 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [
      {
        "property": "Disabled",
    ...
    "stateReactions": [
      {
        ...
        "trigger": "ON_HOVER",
        "to": "Variant=Text, Color=Primary, Size=Medium, State=Hover"
      },
      {
        "from": "Variant=Text, Color=Primary, Size=Medium, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Text, Color=Primary, Size=Medium, State=Active"
      },
      {
        "from": "Variant=Contained, Color=Primary, Size=Medium, State=Default",
        "trigger": "ON_HOVER",
        "to": "Variant=Contained, Color=Primary, Size=Medium, State=Hover"
      },
      {
        "from": "Variant=Contained, Color=Primary, Size=Medium, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Contained, Color=Primary, Size=Medium, State=Active"
      },
      {
        "from": "Variant=Outlined, Color=Primary, Size=Medium, State=Default",
        "trigger": "ON_HOVER",
        "to": "Variant=Outlined, Color=Primary, Size=Medium, State=Hover"
      },
      {
        "from": "Variant=Outlined, Color=Primary, Size=Medium, State=Default",
        "trigger": "ON_PRESS",
        "to": "Variant=Outlined, Color=Primary, Size=Medium, State=Active"
      }
    ],
    "codeOnlyFacts": [
      {
      ...
      },
      {
        ...
        "value": "background-color, box-shadow, border-color",
        "reason": "Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.",
        "variants": {
          "count": 75,
          "of": 75
      ...
      },
      {
        ...
        "value": "cubic-bezier(0.4, 0, 0.2, 1), cubic-bezier(0.4, 0, 0.2, 1), cubic-bezier(0.4, 0, 0.2, 1)",
        "reason": "Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.",
        "variants": {
          "count": 75,
          "of": 75
