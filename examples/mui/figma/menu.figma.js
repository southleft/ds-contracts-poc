...
// Source of truth: contracts/menu.contract.json (mui.menu v0.2.0)
...
const COMPONENTS = [
  {
    ...
    "version": "0.2.0",
    "anchorKey": null,
    "description": "Menu — generated from contract mui.menu v0.2.0 † (42 code-only facts — see plugin report)",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
