...
// Source of truth: contracts/divider.contract.json (mui.divider v0.2.0)
...
const COMPONENTS = [
  {
    "setName": "Divider",
    "contractId": "mui.divider",
    "version": "0.2.0",
    "anchorKey": null,
    "description": "Divider — generated from contract mui.divider v0.2.0 † (8 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
    ...
    "variants": [
      {
        ...
        "spec": {
          ...
          "bindings": {
            "strokeBottomWeight": "imported/divider/root/border-bottom-width",
          ...
          "fixedWidth": {
            "px": 288,
            "varName": "imported/divider/root/width/fullWidth"
          },
          "clipsContent": true
        }
      },
      {
        ...
        "spec": {
          ...
          "fixedWidth": {
            "px": 216,
            "varName": "imported/divider/root/width/inset"
          },
          "clipsContent": true
        }
      },
      {
        ...
        "spec": {
          ...
          "fixedWidth": {
            "px": 256,
            "varName": "imported/divider/root/width/middle"
          },
          "clipsContent": true
        }
      }
    ...
    "codeOnlyFacts": [
      {
        ...
        "kind": "channel",
        "channel": "flex-shrink",
        "value": "{imported.divider.root.flex-shrink}",
