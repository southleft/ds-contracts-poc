...
const COMPONENTS = [
  {
    ...
    "version": "0.2.0",
    "anchorKey": null,
    "description": "Chip — generated from contract mui.chip v0.2.0 † (9 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
              ...
              "children": [
                {
                  ...
                  "lineHeightVar": "imported/chip/label/line-height",
    ...
    "codeOnlyFacts": [
      ...
      },
      {
        ...
        "value": "{imported.chip.root.outline-width}",
      ...
      },
      {
        ...
        "value": "background-color, box-shadow",
        "reason": "Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.",
        "variants": {
          "count": 28,
          "of": 28
