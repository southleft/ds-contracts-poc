...
export const TextField = forwardRef<HTMLDivElement, TextFieldProps>(function TextField(
  { type = 'text', inputMode = 'undefined', align = 'undefined', variant = 'inherit', size = 'medium', labelHidden = false, disabled = false, clearButton = false, selectTextOnFocus = false, readOnly = false, autoFocus = false, focused = false, spellCheck = false, ariaExpanded = false, showCharacterCount = false, requiredIndicator = false, monospaced = false, autoSize = false, loading = false, withPrefix = false, withSuffix = false, step = 0, largeStep = 0, maxLength = 0, minLength = 0, placeholder = 'Example', value = '', suggestion, name, role, autoComplete, pattern, ariaOwns, ariaControls, ariaActiveDescendant, ariaAutocomplete, onFocus, className, children, ...rest },
  ref,
) {
