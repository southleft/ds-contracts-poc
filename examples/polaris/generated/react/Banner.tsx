...
export const Banner = forwardRef<HTMLDivElement, BannerProps>(function Banner(
  { tone = 'info', hideIcon, stopAnnouncements, dismissible = false, withAction = false, title, className, children, ...rest },
  ref,
) {
