...
const COMPONENTS = [
  {
    ...
    "anchorKey": null,
    "description": "PROPOSED contract extracted from examples/polaris/.polaris-clone/polaris-react/src/components/RadioButton/RadioButton.tsx (react-tsx + css-module adapters) — API surface AND anatomy (structure, token bindings, layout, states) read from source; design bindings await reconciliation and human review. PROMOTED showcase contract: API surface extracted mechanically from Shopify/polaris @ 2b1ea88625e0613853ca8577c9acd1980a90f382 (polaris-react 13.10.1, MIT © Shopify, extracted 2026-07-18); styling bindings promoted from the component's own module.css under the reviewed class map in examples/polaris/scripts/curation.ts — every carried binding and every named refusal is listed in examples/polaris/extraction/PROMOTION.md. COMPUTED-ENRICHED (extract/computed): unlabeled styled channels minted from computed-style capture of @shopify/polaris@13.9.5 in headless Chromium 148.0.7778.96; overflow channels in the sibling extension file. FLOOR-PROMOTED v0.2.0 (extract/computed round 2): this contract is the computed-floor rebuild — complete browser truth captured from the real @shopify/polaris@13.9.5 npm package rendered in headless Chromium 148.0.7778.96 (every enumerated longhand per element incl. ::before/::after, full state sweep, double-run byte-identity), fused with the static semantic layer (BOUND bindings browser-confirmed, unlabeled channels MINTED as imported.* tokens in tokens/polaris-minted.dtcg.json, uniform registry channels DECLARED), contradictions resolved computed-wins per the decisions ledger (extract/computed/out/radiobutton/decisions.md, human-acked; source enriched.contract.json). Everything the vocabulary cannot carry is named in contracts/radio-button.extension.json. Delta ledger: extract/computed/out/radiobutton/LEDGER.md (supersedes this component's section of extraction/PROMOTION.md). — governed by contract polaris.radio-button v0.2.0\nDeclared (code): backdrop.border-bottom-style: none [disabled] — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.border-bottom-style: solid — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.border-left-style: none [disabled] — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.border-left-style: solid — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.border-right-style: none [disabled] — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.border-right-style: solid — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.border-top-style: none [disabled] — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.border-top-style: solid — This part's borders use different styles per side in code; Figma strokes share one style.\nDeclared (code): backdrop.cursor: default [disabled] — Cursor changes (pointer on hover) exist only in the coded component.\nDeclared (code): backdrop.cursor: pointer — Cursor changes (pointer on hover) exist only in the coded component.\nDeclared (code): backdrop.outline-style: solid [focus-visible] — Focus outlines render as a bound stroke approximation on canvas state previews (standing C5 approximation).\nDeclared (code): backdrop.position: relative — This element is a positioning context (position: relative) in code; Figma frames need no equivalent.\nDeclared (code): backdrop.transition-duration: 0.1s — Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.\nDeclared (code): backdrop.transition-property: border-color — Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.\nDeclared (code): backdrop.transition-timing-function: cubic-bezier(0.19, 0.91, 0.38, 1) — Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.\nDeclared (code): input.appearance: auto — Native form-control appearance is reset only in the coded component.\nDeclared (code): input.cursor: default — Cursor changes (pointer on hover) exist only in the coded component.\nDeclared (code): input.font-feature-settings: normal — Tabular figures / ligature settings apply only in code — Figma's plugin API cannot set OpenType features.\nDeclared (code): input.outline-style: auto [focus-visible] — Focus outlines render as a bound stroke approximation on canvas state previews (standing C5 approximation).\nDeclared (code): input.overflow-x: hidden — Scrolling behavior and overflow clipping on this axis exist only in code.\nDeclared (code): input.overflow-y: hidden — Scrolling behavior and overflow clipping on this axis exist only in code.\nDeclared (code): input.text-rendering: auto — Text rasterization hints (text-rendering) apply only in code.\nDeclared (code): input.text-wrap-mode: nowrap — Line-breaking rules differ: Figma wraps by box width only.\nDeclared (code): root.cursor: default [disabled] — Cursor changes (pointer on hover) exist only in the coded component.\nDeclared (code): root.cursor: pointer — Cursor changes (pointer on hover) exist only in the coded component.",
    "isSet": false,
    "boolProps": [
      {
