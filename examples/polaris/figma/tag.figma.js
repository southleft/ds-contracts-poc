...
const COMPONENTS = [
  {
    ...
    "anchorKey": null,
    "description": "Tag — generated from contract polaris.tag v0.3.2 †",
    "isSet": true,
    "boolProps": [
      {
        "property": "Disabled",
    ...
    "stateReactions": [
      {
        "from": "Size=none, State=Default",
        "trigger": "ON_PRESS",
        "to": "Size=none, State=Active"
      },
      {
        "from": "Size=large, State=Default",
        "trigger": "ON_PRESS",
        "to": "Size=large, State=Active"
      }
    ],
    "colW": 380
  }
