...
const COMPONENTS = [
  {
    ...
    "anchorKey": null,
    "description": "Avatar — generated from contract polaris.avatar v0.3.1 †",
    "isSet": true,
    "boolProps": [
      {
        "property": "Customer",
    ...
    "variants": [
      {
        ...
        "spec": {
          ...
          "bindings": {
            "bottomLeftRadius": "imported/avatar/root/border-bottom-left-radius/md",
            "bottomRightRadius": "imported/avatar/root/border-bottom-right-radius/md",
            "topLeftRadius": "imported/avatar/root/border-top-left-radius/md",
            "topRightRadius": "imported/avatar/root/border-top-right-radius/md"
          },
          "lits": {
            "minWidth": 20,
            "width": 28,
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "p/color-avatar-one-bg-fill",
          "bindings": {
            "bottomLeftRadius": "imported/avatar/root/border-bottom-left-radius/xs",
            "bottomRightRadius": "imported/avatar/root/border-bottom-right-radius/xs",
            "topLeftRadius": "imported/avatar/root/border-top-left-radius/xs",
            "topRightRadius": "imported/avatar/root/border-top-right-radius/xs"
          },
          "lits": {
            "minWidth": 20,
            "width": 20,
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "p/color-avatar-one-bg-fill",
          "bindings": {
            "bottomLeftRadius": "imported/avatar/root/border-bottom-left-radius/lg",
            "bottomRightRadius": "imported/avatar/root/border-bottom-right-radius/lg",
            "topLeftRadius": "imported/avatar/root/border-top-left-radius/lg",
            "topRightRadius": "imported/avatar/root/border-top-right-radius/lg"
          },
          "lits": {
            "minWidth": 20,
            "width": 32,
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "p/color-avatar-one-bg-fill",
          "bindings": {
            "bottomLeftRadius": "imported/avatar/root/border-bottom-left-radius/xl",
            "bottomRightRadius": "imported/avatar/root/border-bottom-right-radius/xl",
            "topLeftRadius": "imported/avatar/root/border-top-left-radius/xl",
            "topRightRadius": "imported/avatar/root/border-top-right-radius/xl"
          },
          "lits": {
            "minWidth": 20,
            "width": 40,
