    ...
    "variants": [
      {
        ...
        "spec": {
          ...
          "fixedHeight": {
            "px": 28,
            "varName": "imported/checkbox/root/height"
          },
          "bindings": {
          ...
          "children": [
            ...
            },
            {
              ...
              "fixedWidth": {
                "px": 108.359,
                "varName": "imported/checkbox/choice-label/width"
              },
              "children": [
                {
                  "type": "text",
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    },
                    {
                      ...
                      "fixedHeight": {
                        "px": 14,
                        "varName": "imported/checkbox/icon-3/height/checked"
                      },
                      "fixedWidth": {
                        "px": 14,
                        "varName": "imported/checkbox/icon-3/width/checked"
                      },
                      "children": [
                        {
                          "type": "svg",
                          "name": "icon-6",
                          "svg": "<svg viewBox=\"0 0 14 14\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M 1.5 5.5 L 3.44655 8.22517 C 3.72862 8.62007 4.30578 8.64717 4.62362 8.28044 L 10.5 1.5\" fill=\"none\" stroke=\"rgba(255, 255, 255, 1)\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/></svg>",
                          "svgPaintVar": "imported/checkbox/icon-6/fill",
                          "iconSize": 14,
                          "absolute": {
                            "h": "MIN",
                            "v": "MIN",
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    },
                    {
                      ...
                      "fixedHeight": {
                        "px": 22,
                        "varName": "imported/checkbox/icon-3/height/indeterminate"
                      },
                      "margins": {
                        "bottom": 0,
                        "left": 0,
                      ...
                      "fixedWidth": {
                        "px": 22,
                        "varName": "imported/checkbox/icon-3/width/indeterminate"
                      },
                      "children": [
                        {
                          "type": "svg",
                          "name": "icon-4",
                          "svg": "<svg viewBox=\"0 0 22 22\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M 5 10 C 5 9.586 5.336 9.25 5.75 9.25 H 14.25 C 14.664 9.25 15 9.586 15 10 S 14.664 10.75 14.25 10.75 H 5.75 C 5.336 10.75 5 10.414 5 10 Z\" fill=\"#ffffff\" fill-rule=\"evenodd\"/></svg>",
    ...
    "codeOnlyFacts": [
      {
        ...
        "value": "{imported.checkbox.backdrop.background-color-state-active.{checked}}",
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.background-color-state-focus-visible.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.background-color-state-hover.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.border-bottom-color-state-hover.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.border-left-color-state-hover.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.border-right-color-state-hover.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.border-top-color-state-hover.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.box-shadow-state-active.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "{imported.checkbox.backdrop.box-shadow-state-hover.{checked}}",
        "reason": "observed by the computed capture and refused by the contract grammar — v13 Part.states carries plain color-kind refs only on non-root parts",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "border-color, border-width, box-shadow",
        "reason": "Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "cubic-bezier(0.19, 0.91, 0.38, 1), cubic-bezier(0.19, 0.91, 0.38, 1), cubic-bezier(0.19, 0.91, 0.38, 1)",
        "reason": "Motion (spin, pulse, easing) runs only in the coded component; the canvas shows one still frame.",
        "variants": {
          "count": 3,
          "of": 3
      ...
      },
      {
        ...
        "value": "default",
        "reason": "observed by the computed capture and refused by the contract grammar — declared-channel state delta on 1/3 combos — partial coverage cannot carry as a state selector (v15); named residue",
        "variants": {
          "count": 3,
          "of": 3
        }
