...
const COMPONENTS = [
  {
    ...
    "anchorKey": null,
    "description": "TextField — generated from contract polaris.text-field v0.3.2 †",
    "isSet": true,
    "boolProps": [
      {
                          ...
                          "children": [
                            {
                              ...
                              "svgPaintVar": "imported/text-field/icon/color",
                              "iconSize": 20,
    ...
    "stateReactions": [
      {
        "from": "Type=Text, Input Mode=Text, Align=Left, Variant=Inherit, Size=Medium, State=Default",
        "trigger": "ON_HOVER",
        "to": "Type=Text, Input Mode=Text, Align=Left, Variant=Inherit, Size=Medium, State=Hover"
      },
      {
        "from": "Type=Text, Input Mode=Text, Align=Left, Variant=Inherit, Size=Medium, State=Default",
        "trigger": "ON_PRESS",
        "to": "Type=Text, Input Mode=Text, Align=Left, Variant=Inherit, Size=Medium, State=Active"
      }
    ],
    "colW": 380
  }
