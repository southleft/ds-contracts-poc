...
Contract: `polaris.radio-button` v0.2.0. Canvas-drawn values are read directly off the
...
computed sweep never mounted): 1. A drawn value of `0px` means the renderer's default
