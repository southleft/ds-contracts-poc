 ...
 *  OBLIQUE gradient fills refused by name (the Alert grounds — axis-aligned
 *  ramps CARRY since dump v1.16 + the REST-RECOVERY graft; see NOTES.md),
 *  icons-* child sets never imported (stub bbox + primary paint only), and
 *  the harness loads no webfonts (FC-FONT-SUBSTRATE — glyph substrate
 *  differs wholesale).
 *
