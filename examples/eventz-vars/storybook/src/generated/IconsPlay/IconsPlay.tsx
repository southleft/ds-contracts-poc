...
import styles from './IconsPlay.module.css';

export interface IconsPlayProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'children'> {
  size?: '20';
}
...
export const IconsPlay = forwardRef<HTMLSpanElement, IconsPlayProps>(function IconsPlay(
  { size = '20', className, ...rest },
  ref,
) {
  // axis-inert (ledgered, not a throw): size — no `.<axis>-*` rule
  // exists in IconsPlay.module.css, so no class is composed for it. A reference
