...
import styles from './IconsPause.module.css';

export interface IconsPauseProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'children'> {
  size?: '20';
}
...
export const IconsPause = forwardRef<HTMLSpanElement, IconsPauseProps>(function IconsPause(
  { size = '20', className, ...rest },
  ref,
) {
  // axis-inert (ledgered, not a throw): size — no `.<axis>-*` rule
  // exists in IconsPause.module.css, so no class is composed for it. A reference
