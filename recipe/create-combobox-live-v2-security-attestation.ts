...
import { verifyComboboxLiveV2Authorization } from "./combobox-live-v2-authorization.js";
import { COMBOBOX_LIVE_V2_TARGET } from "./combobox-live-v2-broker.js";
import {
  COMBOBOX_LIVE_V2_SECURITY_ATTESTATION_DEFAULT_PATH,
...
const proof = verifyComboboxLiveV2Authorization();
...
const attestation: ComboboxLiveV2SecurityAttestation = {
  ...body,
  attestationSha256: comboboxLiveV2AttestationSha256(body),
};
const failures = validateComboboxLiveV2SecurityAttestation(attestation, proof);
if (failures.length)
  throw new Error(
...
const output = path.resolve(
  argument("--output") ?? COMBOBOX_LIVE_V2_SECURITY_ATTESTATION_DEFAULT_PATH,
);
