...
/**
 * Carried Combobox live v36 extract runtime. Keeps the v3 teaching that
 ...
 * scene-readback-combobox-v36. Trigger-slot
 * `componentRef` compile sibling-order
 * recovery also lives there. Does not
 * restamp hashed v1–v35 lineage. Writer
 * bytes stay frozen.
 */
