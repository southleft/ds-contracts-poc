...
import { TABLE_LIVE_V28_CAPTURE_COUNT } from "./table-live-v28-contract.js";

test("Table live v28 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V28_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V28_CAPTURE_COUNT, 20);
