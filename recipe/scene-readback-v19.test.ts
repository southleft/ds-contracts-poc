...
import {
  INPUT_LIVE_V19_SLOT_COLOR_BINDING_MARKER,
  INPUT_LIVE_V19_SLOT_FILL_MARKER,
  INPUT_LIVE_V19_SLOT_ROLES,
  INPUT_LIVE_V19_SURFACE_STROKE_WEIGHT_MARKER,
...
test("v17 surfaces empty leading-slot fills from instancePayload", () => {
  ...
  assert.equal(INPUT_LIVE_V19_SLOT_FILL_MARKER, "INPUT-SLOT-FILL-FROM-PAYLOAD");
  assert.deepEqual([...INPUT_LIVE_V19_SLOT_ROLES], [
