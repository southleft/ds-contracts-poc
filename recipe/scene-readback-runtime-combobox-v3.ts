...
/**
 * Carried Combobox live v3 extract runtime. Teaches that owned
 * COMPONENT_SET roots may omit `envelopeHash` when they already carry
 * `runIdentity` / `adapterIdentity` / `recipeHash` / `ownershipKey`,
 * matching writer `mintSet`. Does not restamp hashed v1/v2 lineage.
 */
