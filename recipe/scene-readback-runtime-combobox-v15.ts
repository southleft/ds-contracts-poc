...
/**
 * Carried Combobox live v15 extract runtime. Keeps the v3 teaching that
 ...
 * trailing-slot compile-carry visible, and trigger empty-effects
 * omit live in scene-readback-combobox-v15. Does not restamp
 * hashed v1–v14 lineage. Writer bytes stay frozen.
 */
