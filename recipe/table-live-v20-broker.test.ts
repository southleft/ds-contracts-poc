...
import { TABLE_LIVE_V20_CAPTURE_COUNT } from "./table-live-v20-contract.js";

test("Table live v20 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V20_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V20_CAPTURE_COUNT, 20);
