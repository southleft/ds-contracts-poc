...
import { CALENDAR_LIVE_V2_CAPTURE_COUNT } from "./calendar-live-v2-contract.js";

test("Calendar live v2 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V2_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V2_CAPTURE_COUNT, 8);
