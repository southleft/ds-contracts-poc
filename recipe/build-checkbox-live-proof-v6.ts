...
const EVIDENCE = "recipe/evidence/checkbox-live-pivot-v6";
...
const receiptOwned = {
      artifactVersion: "checkbox-live-pivot-v6-prepare",
      teaching:
...
if (process.argv.includes("--check")) {
  ...
  if (writer.sourcePlans.length !== 4)
    throw new Error("checkbox prepare requires four library sources (three reviewed + the proposed Chakra)");
  console.log(
    JSON.stringify({
      check: "ok",
      runIdentity: writer.runIdentity,
