...
import { buildFigmaSceneReadbackRuntime } from "./scene-readback-runtime-v56.js";
import {
  INPUT_LIVE_V56_CONTENT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V56_CONTENT_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V56_CONTENT_HIDDEN_HEIGHT_HUG_MARKER,
  INPUT_LIVE_V56_CONTENT_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V56_CONTENT_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V56_CONTENT_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V56_CONTENT_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V56_CONTENT_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V56_LABEL_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V56_LABEL_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V56_LABEL_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V56_LABEL_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V56_LABEL_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V56_LABEL_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V56_LABEL_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V56_LABEL_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V56_LABEL_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V56_SURFACE_STROKE_DASH_PATTERN_OMITTED_MARKER,
  INPUT_LIVE_V56_MESSAGE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V56_MESSAGE_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V56_MESSAGE_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V56_MESSAGE_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V56_MESSAGE_CONTAINER_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V56_MESSAGE_CONTAINER_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V56_MESSAGE_CONTAINER_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V56_MESSAGE_CONTAINER_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V56_VARIANT_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V56_VARIANT_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V56_VARIANT_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V56_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V56_LEADING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V56_LEADING_SLOT_ROLES,
  INPUT_LIVE_V56_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V56_TRAILING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V56_TRAILING_SLOT_ROLES,
  INPUT_LIVE_V56_MESSAGE_ROLES,
  INPUT_LIVE_V56_LABEL_ROLES,
  INPUT_LIVE_V56_CONTENT_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V56_CONTENT_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V56_CONTENT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V56_CONTENT_ROLES,
  INPUT_LIVE_V56_SLOT_COLOR_BINDING_MARKER,
  INPUT_LIVE_V56_SLOT_FILL_MARKER,
  INPUT_LIVE_V56_SLOT_ROLES,
  INPUT_LIVE_V56_SURFACE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V56_SURFACE_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V56_SURFACE_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V56_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER,
  INPUT_LIVE_V56_SURFACE_LAYOUT_HEIGHT_MARKER,
  INPUT_LIVE_V56_SURFACE_STROKE_WEIGHT_MARKER,
  INPUT_LIVE_V56_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER,
  INPUT_LIVE_V56_VARIANT_LAYOUT_WIDTH_COMPILE_INDEX_MARKER,
  INPUT_LIVE_V56_VARIANT_LAYOUT_WIDTH_MARKER,
  SCENE_READBACK_V12_TAUGHT_FILL_KINDS,
  scenePaintToIr,
  sceneToNormalizedIr,
  type SceneNodeSnapshot,
} from "./scene-readback-v56.js";
...
test("v17 surfaces empty leading-slot fills from instancePayload", () => {
  ...
  assert.equal(INPUT_LIVE_V56_SLOT_FILL_MARKER, "INPUT-SLOT-FILL-FROM-PAYLOAD");
  assert.deepEqual([...INPUT_LIVE_V56_SLOT_ROLES], [
...
test("v26 drops duplicate mapped content color bindings", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V56_CONTENT_ROLES], [
...
test("v56 recovers hug height for hidden content text with FIXED vertical sizing", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fills.0.color",
...
test("v56 does not rewrite visible content FIXED height or invent a height variable", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/value", [
      {
        field: "fontSize.0",
...
test("v56 does not lift hidden FIXED height onto non-content text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v10 live host path does not import hashed scene-readback.ts", () => {
  const verifier = readFileSync(
    "recipe/input-field-live-v56-verifier.ts",
    "utf8",
  );
  const contract = readFileSync(
    "recipe/input-field-live-v56-contract.ts",
    "utf8",
  );
...
test("v56 omits content letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v56 does not omit letterSpacing on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
...
test("v56 omits content textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v56 does not omit textCase on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v56 omits content textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v56 does not omit textDecoration on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v56 omits content-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    clipsContent: true,
...
test("v56 omits label-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v56 omits message-container clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v56 does not omit clipsContent on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v56 omits message-container effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    effects: [],
...
test("v56 does not omit effects on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    effects: [],
...
test("v56 omits message-container strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    strokes: [],
...
test("v56 does not omit strokes on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    strokes: [],
...
test("v56 omits message-container cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    cornerRadius: {
...
test("v56 omits variant cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
...
test("v56 omits variant effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v56 omits variant strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v56 orders leading-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V56_LEADING_SLOT_ROLES], [
    "input-field/slot/leading",
  ]);
  assert.equal(
    INPUT_LIVE_V56_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v56 orders trailing-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V56_TRAILING_SLOT_ROLES], [
    "input-field/slot/trailing",
  ]);
  assert.equal(
    INPUT_LIVE_V56_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v56 does not omit cornerRadius on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    cornerRadius: {
...
test("v56 omits content-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    cornerRadius: {
...
test("v56 omits label-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    cornerRadius: {
...
test("v56 omits content-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    effects: [],
...
test("v56 omits label-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    effects: [],
...
test("v56 omits content-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    strokes: [],
...
test("v56 omits label-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    strokes: [],
...
test("v56 omits surface stroke dashPattern that compile never emits", () => {
...
test("v56 orders message/helper bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
  ...
  assert.deepEqual([...INPUT_LIVE_V56_MESSAGE_ROLES], [
    "input-field/message/helper",
    "input-field/message/error",
  ]);
});

test("v56 orders message/error bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
...
test("v56 omits message/helper letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v56 omits message/error letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v56 omits message/helper textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textCase: "ORIGINAL",
  });
...
test("v56 omits message/error textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textCase: "ORIGINAL",
  });
...
test("v56 omits message/helper textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textDecoration: "NONE",
  });
...
test("v56 omits message/error textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textDecoration: "NONE",
  });
...
test("v56 does not omit surface stroke dashPattern when the host value is not empty", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    dashPattern: [2, 2],
  });
...
test("v56 does not lift surface dashPattern omit onto a non-surface frame", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    name: "other :: Frame",
  });
...
test("v56 drops duplicate label bindings and orders remaining fields to compile", () => {
  const ir = sceneToNormalizedIr(
    labelScene([
      {
        field: "fills.0.color",
  ...
  assert.deepEqual([...INPUT_LIVE_V56_LABEL_ROLES], ["input-field/label"]);
});

test("v56 does not apply label binding teaching to surfaces", () => {
  const ir = sceneToNormalizedIr(
    surfaceScene([
      {
        field: "fills.0.color",
...
test("v56 omits label letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v56 omits label textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v56 omits label textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
