...
const EVIDENCE = "recipe/evidence/textarea-live-pivot-v9";
...
const receiptOwned = {
      artifactVersion: "textarea-live-pivot-v9-prepare",
      teaching:
...
if (process.argv.includes("--check")) {
  ...
  if (writer.sourcePlans.length !== 6)
    throw new Error("textarea prepare requires 6 library sources (reviewed + proposed)");
