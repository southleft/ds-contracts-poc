...
/**
 * Carried Combobox live v11 scene-readback. Keeps v1 host-normalize,
 * v2–v4 extract teachings, v5 empty-payload omit, v6 live-root
 * observeSceneFacts, v7 recipe componentRef recovery, v8 writer
 * ARIA stamps, v9 name-before-`#` property recovery, and v10 trigger
 * binding compile-order. Teaches the existing leading-slot
 * compile-order sort to rank `combobox/control/leading` bindings by
 * recipe compile field order so `width.value` precedes `height.value`
 * precedes `fills.0.color`, not live extract order or the inherited
 * fills-first slot list. Same class as Input leading/trailing slot
 * binding-order teachings. Does not invent a Combobox-only
 * `if (combobox)`. Does not patch hashed v1–v10 lineage bytes.
...
export const COMBOBOX_LIVE_V11_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V11_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V11_RECOVER_RECIPE_COMPONENT_REF_MARKER =
  "COMBOBOX-HOST-RECOVER-RECIPE-COMPONENT-REF";
export const COMBOBOX_LIVE_V11_RECOVER_COMPONENT_PROPERTY_NAME_MARKER =
  "COMBOBOX-HOST-RECOVER-COMPONENT-PROPERTY-NAME-BEFORE-HASH";
export const COMBOBOX_LIVE_V11_TRIGGER_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRIGGER-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V11_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V11_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V11_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
export function canonicalizeObservedComponentPropertyName(key: string): string {
  void COMBOBOX_LIVE_V11_RECOVER_COMPONENT_PROPERTY_NAME_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V11_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V11_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
