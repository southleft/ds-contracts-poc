...
import { COMBOBOX_LIVE_V41_CAPTURE_COUNT } from "./combobox-live-v41-contract.js";

test("Combobox live v41 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V41_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V41_CAPTURE_COUNT, 72);
