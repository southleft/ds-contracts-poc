...
import { TABLE_LIVE_V7_CAPTURE_COUNT } from "./table-live-v7-contract.js";

test("Table live v7 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V7_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V7_CAPTURE_COUNT, 20);
