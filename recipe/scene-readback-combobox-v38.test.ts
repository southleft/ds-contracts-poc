...
import {
  ...
  COMBOBOX_LIVE_V38_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V38_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V38_LISTBOX_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V38_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_LISTBOX_CORNER_RADIUS_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_LISTBOX_EMPTY_STROKES_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V38_OBSERVE_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V38_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V38_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER,
  COMBOBOX_LIVE_V38_OPTION_SET_COMPILE_CARRY_LABEL,
  COMBOBOX_LIVE_V38_OPTION_SET_COMPILE_CARRY_LABEL_MARKER,
  COMBOBOX_LIVE_V38_OPTION_SET_COMPILE_CARRY_NAME,
  COMBOBOX_LIVE_V38_OPTION_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V38_OPTION_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER,
  COMBOBOX_LIVE_V38_OPTION_INSTANCE_BINDING_EXTRAS_MARKER,
  COMBOBOX_LIVE_V38_OPTION_INSTANCE_FILLS_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_OVERLAY_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V38_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_SET_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER,
  COMBOBOX_LIVE_V38_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER,
  COMBOBOX_LIVE_V38_RECOVER_COMPONENT_PROPERTY_NAME_MARKER,
  COMBOBOX_LIVE_V38_RECOVER_RECIPE_COMPONENT_REF_MARKER,
  COMBOBOX_LIVE_V38_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V38_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V38_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V38_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V38_TRIGGER_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V38_TRIGGER_COMPILE_CARRY_CHARACTERS,
  COMBOBOX_LIVE_V38_TRIGGER_COMPILE_CARRY_CHARACTERS_MARKER,
  COMBOBOX_LIVE_V38_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER,
  COMBOBOX_LIVE_V38_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER,
  COMBOBOX_LIVE_V38_TRIGGER_SLOT_COMPILE_SIBLING_COMPONENT_REFS,
  COMBOBOX_LIVE_V38_TRIGGER_SLOT_COMPILE_SIBLING_ROLES,
...
test("compile trigger-slot componentRefs are prefix then clear then popup", () => {
  ...
  const refs = walkIr(trigger)
    .filter(
      (node) =>
        node.kind === "instance" &&
        (COMBOBOX_LIVE_V38_TRIGGER_SLOT_COMPILE_SIBLING_ROLES as readonly string[]).includes(
          node.role ?? "",
        ),
    )
    .map((node) =>
...
test("host observe recovers compile-carried option-set name, not the live display name", () => {
  ...
  assert.equal(
    COMBOBOX_LIVE_V38_OPTION_SET_COMPILE_CARRY_NAME,
    "combobox/option-set :: Combobox option",
    "v38 must recover compile's option-set name, not invent a name or parse the live fixture string",
  );
  assert.equal(
    COMBOBOX_LIVE_V38_OPTION_SET_COMPILE_CARRY_LABEL,
    "Combobox option",
    "v38 reuses the v33 compile-carried Combobox option label",
  );
  const fixtures = [
    {
      displayName: "MUI Autocomplete / combobox@1 offline fixture",
  ...
  for (const fixture of fixtures) {
    ...
    assert.equal(
      ...
      undefined,
      "v38 observe must recover compile-carried combobox/option-set :: Combobox option",
    );
    ...
    assert.equal(
      ...
      false,
      "v38 must not change combobox/set names that already match compile identity.name",
    );
    const instance = adaptReviewedCombobox(fixture.reviewed, fixture.config);
    const envelope = compileComboboxRecipe(instance);
    const compiledOptionSet = walkIr(envelope.ir).find(
