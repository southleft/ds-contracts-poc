...
/**
 * Carried Combobox live v12 scene-readback. Keeps v1 host-normalize,
 ...
 * binding compile-order, and v11 leading-slot binding compile-order.
 * Teaches host to emit compile-carried `visible: true` on
 * `combobox/control/leading` instances instead of omitting the
 * default-true visible flag. Same class as Input V81 compile-carry
 * live `visible: true` (occupancy placeholders stay visible; compile
 * carries the live flag). Reuses the existing compile-carry /
 * do-not-omit-default-true path for leading-slot instances so host
 * matches compile `controlInstance`. Does not invent `visible: false`.
 * Does not change occupancy `opacity: 0` teachings. Does not invent
 * a Combobox-only `if (combobox)`. Does not patch hashed v1–v11
...
export const COMBOBOX_LIVE_V12_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V12_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V12_RECOVER_RECIPE_COMPONENT_REF_MARKER =
  "COMBOBOX-HOST-RECOVER-RECIPE-COMPONENT-REF";
export const COMBOBOX_LIVE_V12_RECOVER_COMPONENT_PROPERTY_NAME_MARKER =
  "COMBOBOX-HOST-RECOVER-COMPONENT-PROPERTY-NAME-BEFORE-HASH";
export const COMBOBOX_LIVE_V12_TRIGGER_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRIGGER-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V12_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LEADING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V12_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
...
const compileCarriedLeadingSlotVisible = (
  ...
  void COMBOBOX_LIVE_V12_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V12_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V12_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
export function canonicalizeObservedComponentPropertyName(key: string): string {
  void COMBOBOX_LIVE_V12_RECOVER_COMPONENT_PROPERTY_NAME_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V12_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V12_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
