...
const EVIDENCE = "recipe/evidence/switch-live-pivot-v10";
...
const receiptOwned = {
      artifactVersion: "switch-live-pivot-v10-prepare",
      teaching:
...
if (process.argv.includes("--check")) {
  ...
  if (writer.sourcePlans.length !== 5)
    throw new Error("switch prepare requires five library sources (three reviewed + the proposed MUI and shadcn)");
  console.log(
    JSON.stringify({
      check: "ok",
      runIdentity: writer.runIdentity,
