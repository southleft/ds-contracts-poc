...
import { TABLE_LIVE_V14_CAPTURE_COUNT } from "./table-live-v14-contract.js";

test("Table live v14 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V14_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V14_CAPTURE_COUNT, 20);
