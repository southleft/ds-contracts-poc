...
/**
 * Table live v9 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v8. The v9 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit `clipsContent` on
 * `table/header` and `table/body` because compile header/body frames
 * omit `clipsContent`. Does not omit `table/variant` clipsContent.
 */
