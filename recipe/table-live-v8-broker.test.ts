...
import { TABLE_LIVE_V8_CAPTURE_COUNT } from "./table-live-v8-contract.js";

test("Table live v8 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V8_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V8_CAPTURE_COUNT, 20);
