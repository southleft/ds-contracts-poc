...
/**
 * Table live v13 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v12. The v13 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit Figma-copied bindings on
 * `table/row-instance` because compile row-instances carry none.
 * Row components still compile-carry `fills.0.color`. Does not
 * invent bindings onto compile row-instances.
 */
