...
import { CALENDAR_LIVE_V22_CAPTURE_COUNT } from "./calendar-live-v22-contract.js";

test("Calendar live v22 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V22_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V22_CAPTURE_COUNT, 8);
