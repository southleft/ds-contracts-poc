...
import { COMBOBOX_LIVE_V40_CAPTURE_COUNT } from "./combobox-live-v40-contract.js";

test("Combobox live v40 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V40_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V40_CAPTURE_COUNT, 72);
