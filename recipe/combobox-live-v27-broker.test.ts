...
import { COMBOBOX_LIVE_V27_CAPTURE_COUNT } from "./combobox-live-v27-contract.js";

test("Combobox live v27 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V27_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V27_CAPTURE_COUNT, 72);
