...
import { COMBOBOX_LIVE_V19_CAPTURE_COUNT } from "./combobox-live-v19-contract.js";

test("Combobox live v19 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V19_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V19_CAPTURE_COUNT, 72);
