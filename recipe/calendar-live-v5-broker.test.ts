...
import { CALENDAR_LIVE_V5_CAPTURE_COUNT } from "./calendar-live-v5-contract.js";

test("Calendar live v5 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V5_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V5_CAPTURE_COUNT, 8);
