...
const EVIDENCE = "recipe/evidence/badge-live-pivot-v1";
  ...
  JSON.stringify(
    {
      ...
      teaching:
        "badge@1 anchored overlay from MUI Badge and AntD Badge; Astryx overlay is a named refusal; do not invent an Astryx pip or remint Token",
...
writeFileSync(
  ...
  JSON.stringify(
    {
      artifactVersion: "badge-live-pivot-v1-prepare",
      teaching:
        "Two overlay cells (MUI+AntD). Astryx Badge is an inline label — overlay refused.",
      runIdentity: writer.runIdentity,
      pageName: writer.pageName,
      namespace: writer.namespace,
