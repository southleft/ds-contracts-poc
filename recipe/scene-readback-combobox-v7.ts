...
/**
 * Carried Combobox live v7 scene-readback. Keeps v1 host-normalize,
...
export const COMBOBOX_LIVE_V7_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V7_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V7_RECOVER_RECIPE_COMPONENT_REF_MARKER =
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V7_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V7_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V7_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
