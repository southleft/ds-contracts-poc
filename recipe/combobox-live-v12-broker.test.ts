...
import { COMBOBOX_LIVE_V12_CAPTURE_COUNT } from "./combobox-live-v12-contract.js";

test("Combobox live v12 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V12_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V12_CAPTURE_COUNT, 72);
