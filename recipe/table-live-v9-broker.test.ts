...
import { TABLE_LIVE_V9_CAPTURE_COUNT } from "./table-live-v9-contract.js";

test("Table live v9 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V9_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V9_CAPTURE_COUNT, 20);
