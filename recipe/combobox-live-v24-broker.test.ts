...
import { COMBOBOX_LIVE_V24_CAPTURE_COUNT } from "./combobox-live-v24-contract.js";

test("Combobox live v24 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V24_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V24_CAPTURE_COUNT, 72);
