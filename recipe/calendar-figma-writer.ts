...
export const CALENDAR_FIGMA_RUN_SUFFIX = "calendar-v50";
...
export const FORBIDDEN_CALENDAR_V33_RUN_IDENTITY = "4604bbfe-calendar-v33";
export const FORBIDDEN_CALENDAR_V34_RUN_IDENTITY = "4604bbfe-calendar-v34";
export const FORBIDDEN_CALENDAR_V35_RUN_IDENTITY = "4604bbfe-calendar-v35";
export const FORBIDDEN_CALENDAR_V36_RUN_IDENTITY = "4604bbfe-calendar-v36";
export const FORBIDDEN_CALENDAR_V37_RUN_IDENTITY = "4604bbfe-calendar-v37";
export const FORBIDDEN_CALENDAR_V38_RUN_IDENTITY = "4604bbfe-calendar-v38";
export const FORBIDDEN_CALENDAR_V39_RUN_IDENTITY = "4604bbfe-calendar-v39";
export const FORBIDDEN_CALENDAR_V40_RUN_IDENTITY = "4604bbfe-calendar-v40";
...
export const FORBIDDEN_CALENDAR_V45_RUN_IDENTITY = "4604bbfe-calendar-v45";
export const FORBIDDEN_CALENDAR_V46_RUN_IDENTITY = "4604bbfe-calendar-v46";
export const FORBIDDEN_CALENDAR_V47_RUN_IDENTITY = "4604bbfe-calendar-v47";
export const FORBIDDEN_CALENDAR_V48_RUN_IDENTITY = "4604bbfe-calendar-v48";
export const FORBIDDEN_CALENDAR_V49_RUN_IDENTITY = "4604bbfe-calendar-v49";
...
export function emitCalendarFigmaWriter(
  ...
  if (runtime.includes("CALENDAR-V33-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v33 run identity");
  if (runtime.includes("CALENDAR-V34-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v34 run identity");
  if (runtime.includes("CALENDAR-V35-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v35 run identity");
  if (runtime.includes("CALENDAR-V36-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v36 run identity");
  if (runtime.includes("CALENDAR-V37-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v37 run identity");
  if (runtime.includes("CALENDAR-V38-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v38 run identity");
  if (runtime.includes("CALENDAR-V39-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v39 run identity");
  if (runtime.includes("CALENDAR-V40-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v40 run identity");
  if (runtime.includes("CALENDAR-V41-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v41 run identity");
  if (runtime.includes("CALENDAR-V42-IDENTITY-REUSE") === false)
  ...
  if (runtime.includes("CALENDAR-V45-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v45 run identity");
  if (runtime.includes("CALENDAR-V46-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v46 run identity");
  if (runtime.includes("CALENDAR-V47-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v47 run identity");
  if (runtime.includes("CALENDAR-V48-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v48 run identity");
  if (runtime.includes("CALENDAR-V49-IDENTITY-REUSE") === false)
    throw new TypeError("calendar writer must refuse the v49 run identity");
  ...
  if (
    runtime.includes(
      "CALENDAR-WRITER-FILL-TEXT-NAMED-FALLBACK-AFTER-ZERO-GLYPH",
    ) === false
  )
    throw new TypeError(
      "calendar writer must walk the named zero-glyph fallback for FILL text",
    );
  if (
