...
/**
 * Carried Combobox live v6 scene-readback. Keeps v1 host-normalize,
 * v2–v4 extract teachings, and v5 empty-payload omit. Teaches that
 * observeSceneFacts must project with the live scene root ownershipKey,
 * not default `root`. Live roots are `combobox` / `option`. Does not
 * invent a `root` key. Does not invent glyph text. Does not patch
 * hashed v1–v5 lineage bytes.
 */
...
export const COMBOBOX_LIVE_V6_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V6_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V6_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V6_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
