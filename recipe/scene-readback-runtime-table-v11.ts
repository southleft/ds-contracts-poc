...
/**
 * Table live v11 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v10. The v11 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit `effects` on
 * `table/header` and `table/body` because compile header/body frames
 * omit `effects`. Does not omit `table/variant` empty effects.
 */
