/**
 * Table live v22 host verifier. Table-shaped: table/row/cell ownership,
...
export const TABLE_LIVE_V22_FIXED_VERIFIER_VERSION = "table-live-v22-fixed-point-v1";
export const TABLE_LIVE_V22_FIXED_REQUIRED_GATE_IDS = [
...
export interface TableLiveV22FixedThresholds {
  clipping: { maximumVisibleAreaLoss: number };
  overlap: { maximumPixels: number };
}

export interface TableLiveV22FixedCellValidation {
  cellKey: string;
  source: string;
  kind: "table" | "row" | "cell";
  rolesExact: boolean;
...
export interface TableLiveV22FixedSourceProbe {
...
export interface TableLiveV22FixedSceneProof {
  adapterIdentity: string;
  accounting: SceneComparison;
  fixedPoint: TableLiveV22FixedFixedPoint;
}

export interface TableLiveV22FixedHardGateInput {
  thresholds: TableLiveV22FixedThresholds;
  sourceProbes: TableLiveV22FixedSourceProbe[];
  cells: TableLiveV22FixedCellValidation[];
  sceneProofs: TableLiveV22FixedSceneProof[];
...
export interface TableLiveV22FixedHardGateReport {
  verifierVersion: typeof TABLE_LIVE_V22_FIXED_VERIFIER_VERSION;
...
export interface TableLiveV22FixedFixedPoint {
  stable: boolean;
  sourceIrRead: false;
...
export function verifyTableLiveV22FixedHardGates(
  input: TableLiveV22FixedHardGateInput,
): TableLiveV22FixedHardGateReport {
  ...
  const exactFields: Array<keyof TableLiveV22FixedCellValidation> = [
    "rolesExact",
    "stateSemanticsExact",
    "noFakeLayout",
  ];
  ...
  return {
    verifierVersion: TABLE_LIVE_V22_FIXED_VERIFIER_VERSION,
    technicalPassed,
    overallInputSuccess:
      technicalPassed &&
      input.humanSignoff.status === "passed" &&
...
export function verifyTableLiveV22FixedSceneFixedPoint<Instance>(
...
export function proveSceneMultiset(
  ...
  scene: SceneNodeSnapshot,
): Pick<TableLiveV22FixedSceneProof, "adapterIdentity" | "accounting"> {
  return {
    adapterIdentity,
