...
import { COMBOBOX_LIVE_V8_CAPTURE_COUNT } from "./combobox-live-v8-contract.js";

test("Combobox live v8 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V8_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V8_CAPTURE_COUNT, 72);
