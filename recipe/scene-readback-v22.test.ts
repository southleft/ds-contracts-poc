...
import {
  INPUT_LIVE_V22_SLOT_COLOR_BINDING_MARKER,
  INPUT_LIVE_V22_SLOT_FILL_MARKER,
  INPUT_LIVE_V22_SLOT_ROLES,
  INPUT_LIVE_V22_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER,
  INPUT_LIVE_V22_SURFACE_LAYOUT_HEIGHT_MARKER,
  INPUT_LIVE_V22_SURFACE_STROKE_WEIGHT_MARKER,
  INPUT_LIVE_V22_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER,
  INPUT_LIVE_V22_VARIANT_LAYOUT_WIDTH_MARKER,
...
test("v17 surfaces empty leading-slot fills from instancePayload", () => {
  ...
  assert.equal(INPUT_LIVE_V22_SLOT_FILL_MARKER, "INPUT-SLOT-FILL-FROM-PAYLOAD");
  assert.deepEqual([...INPUT_LIVE_V22_SLOT_ROLES], [
