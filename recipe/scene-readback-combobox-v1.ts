...
/**
 * Carried Combobox live v1 scene-readback. Copies Input V85 host-normalize
 * mechanisms (first-segment role, uniform per-side stroke weight, slot
 * SOLID + fills.0.color, hidden FILL occupancy, compile-omit TEXT extras,
 * collapse omit invented default-1 opacity, compile-carry live visible
 * and occupancy opacity 0). Role lists are Combobox-named. Does not
 * invent Polar 9/30/0, Polar content-row, overlap-zero, or Input
 * runIdentity. Does not patch hashed Input V85 lineage bytes.
 */
