...
import { CALENDAR_LIVE_V20_CAPTURE_COUNT } from "./calendar-live-v20-contract.js";

test("Calendar live v20 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V20_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V20_CAPTURE_COUNT, 8);
