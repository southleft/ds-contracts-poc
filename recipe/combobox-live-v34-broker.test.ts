...
import { COMBOBOX_LIVE_V34_CAPTURE_COUNT } from "./combobox-live-v34-contract.js";

test("Combobox live v34 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V34_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V34_CAPTURE_COUNT, 72);
