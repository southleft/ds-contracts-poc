...
import { COMBOBOX_LIVE_V15_CAPTURE_COUNT } from "./combobox-live-v15-contract.js";

test("Combobox live v15 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V15_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V15_CAPTURE_COUNT, 72);
