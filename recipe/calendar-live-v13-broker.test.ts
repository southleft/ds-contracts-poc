...
import { CALENDAR_LIVE_V13_CAPTURE_COUNT } from "./calendar-live-v13-contract.js";

test("Calendar live v13 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V13_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V13_CAPTURE_COUNT, 8);
