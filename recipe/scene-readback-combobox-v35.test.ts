...
import {
  ...
  COMBOBOX_LIVE_V35_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V35_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V35_LISTBOX_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V35_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_LISTBOX_CORNER_RADIUS_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_LISTBOX_EMPTY_STROKES_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V35_OBSERVE_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V35_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V35_OPTION_SET_COMPILE_CARRY_LABEL,
  COMBOBOX_LIVE_V35_OPTION_SET_COMPILE_CARRY_LABEL_MARKER,
  COMBOBOX_LIVE_V35_OPTION_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V35_OPTION_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER,
  COMBOBOX_LIVE_V35_OPTION_INSTANCE_BINDING_EXTRAS_MARKER,
  COMBOBOX_LIVE_V35_OPTION_INSTANCE_FILLS_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_OVERLAY_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V35_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_SET_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V35_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER,
  COMBOBOX_LIVE_V35_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER,
  COMBOBOX_LIVE_V35_RECOVER_COMPONENT_PROPERTY_NAME_MARKER,
  COMBOBOX_LIVE_V35_RECOVER_RECIPE_COMPONENT_REF_MARKER,
  COMBOBOX_LIVE_V35_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V35_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V35_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V35_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V35_TRIGGER_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V35_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER,
...
test("host observe omits empty instancePayload facts on slot instances that IR and compile omit", () => {
  ...
  for (const slot of slotRoles) {
    ...
    assert.equal(
      ...
      false,
      `v35 compiled plan must not invent instancePayload on ${slot.role}`,
    );
    ...
    assert.equal(
      ...
      false,
      `v35 observe must omit empty instancePayload extras on ${slot.role}`,
    );
    assert.equal(
      ...
      false,
      `v35 observe must not mismatch instancePayload on ${slot.role}`,
    );
  }
});
...
test("host observe omits nonempty option-instance instancePayload extras that IR and compile omit", () => {
  ...
  assert.equal(
    hostPlan.facts.some((fact) => fact.channel === "instancePayload"),
    false,
    "v35 compiled plan must not invent option-instance instancePayload",
  );
  const hostComparison = compareSceneToExpectedPlan(hostPlan, live);
  assert.equal(
    hostComparison.extra.some((fact) => fact.channel === "instancePayload"),
    false,
    "v35 observe must omit nonempty option-instance instancePayload extras",
  );
  assert.equal(
    hostComparison.mismatched.some(
      (pair) => pair.observed.channel === "instancePayload",
    ...
    false,
    "v35 observe must not mismatch option-instance instancePayload",
  );
  assert.equal(hostIr.properties.Label, "Ada Lovelace");
  assert.equal(hostIr.properties.Value, "Ada Lovelace");
  assert.equal(hostIr.properties.Disabled, false);
  ...
  assert.equal(
    ...
    false,
    "v35 must keep the v34 empty slot instancePayload omit",
  );
});
