...
import { CALENDAR_LIVE_V9_CAPTURE_COUNT } from "./calendar-live-v9-contract.js";

test("Calendar live v9 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V9_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V9_CAPTURE_COUNT, 8);
