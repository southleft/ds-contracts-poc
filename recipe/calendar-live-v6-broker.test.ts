...
import { CALENDAR_LIVE_V6_CAPTURE_COUNT } from "./calendar-live-v6-contract.js";

test("Calendar live v6 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V6_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V6_CAPTURE_COUNT, 8);
