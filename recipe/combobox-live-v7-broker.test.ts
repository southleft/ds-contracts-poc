...
import { COMBOBOX_LIVE_V7_CAPTURE_COUNT } from "./combobox-live-v7-contract.js";

test("Combobox live v7 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V7_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V7_CAPTURE_COUNT, 72);
