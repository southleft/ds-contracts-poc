...
/**
 * Table live v12 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v11. The v12 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit `strokes` on
 * `table/header` and `table/body` because compile header/body frames
 * omit `strokes`. Does not omit `table/variant` strokes.
 */
