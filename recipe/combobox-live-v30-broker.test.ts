...
import { COMBOBOX_LIVE_V30_CAPTURE_COUNT } from "./combobox-live-v30-contract.js";

test("Combobox live v30 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V30_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V30_CAPTURE_COUNT, 72);
