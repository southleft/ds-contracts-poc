...
import { COMBOBOX_LIVE_V36_CAPTURE_COUNT } from "./combobox-live-v36-contract.js";

test("Combobox live v36 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V36_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V36_CAPTURE_COUNT, 72);
