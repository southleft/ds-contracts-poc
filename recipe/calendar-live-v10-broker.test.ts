...
import { CALENDAR_LIVE_V10_CAPTURE_COUNT } from "./calendar-live-v10-contract.js";

test("Calendar live v10 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V10_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V10_CAPTURE_COUNT, 8);
