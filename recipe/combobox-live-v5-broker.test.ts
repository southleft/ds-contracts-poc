...
import { COMBOBOX_LIVE_V5_CAPTURE_COUNT } from "./combobox-live-v5-contract.js";

test("Combobox live v4 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V5_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V5_CAPTURE_COUNT, 72);
