...
import { COMBOBOX_LIVE_V9_CAPTURE_COUNT } from "./combobox-live-v9-contract.js";

test("Combobox live v9 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V9_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V9_CAPTURE_COUNT, 72);
