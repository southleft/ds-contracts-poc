...
/**
 * Carried Combobox live v10 extract runtime. Keeps the v3 teaching that
 ...
 * name-before-`#` property recovery, and trigger compile-order binding
 * sort live in scene-readback-combobox-v10. Does not restamp hashed
 * v1–v9 lineage. Writer bytes stay frozen.
 */
