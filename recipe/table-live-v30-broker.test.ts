...
import { TABLE_LIVE_V30_CAPTURE_COUNT } from "./table-live-v30-contract.js";

test("Table live v30 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V30_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V30_CAPTURE_COUNT, 20);
