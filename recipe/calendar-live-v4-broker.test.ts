...
import { CALENDAR_LIVE_V4_CAPTURE_COUNT } from "./calendar-live-v4-contract.js";

test("Calendar live v4 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V4_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V4_CAPTURE_COUNT, 8);
