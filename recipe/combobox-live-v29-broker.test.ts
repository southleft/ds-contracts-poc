...
import { COMBOBOX_LIVE_V29_CAPTURE_COUNT } from "./combobox-live-v29-contract.js";

test("Combobox live v29 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V29_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V29_CAPTURE_COUNT, 72);
