...
import {
  INPUT_LIVE_V18_SLOT_COLOR_BINDING_MARKER,
  INPUT_LIVE_V18_SLOT_FILL_MARKER,
  INPUT_LIVE_V18_SLOT_ROLES,
...
test("v17 surfaces empty leading-slot fills from instancePayload", () => {
  ...
  assert.equal(INPUT_LIVE_V18_SLOT_FILL_MARKER, "INPUT-SLOT-FILL-FROM-PAYLOAD");
  assert.deepEqual([...INPUT_LIVE_V18_SLOT_ROLES], [
