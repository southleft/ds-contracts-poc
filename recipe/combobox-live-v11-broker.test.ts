...
import { COMBOBOX_LIVE_V11_CAPTURE_COUNT } from "./combobox-live-v11-contract.js";

test("Combobox live v11 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V11_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V11_CAPTURE_COUNT, 72);
