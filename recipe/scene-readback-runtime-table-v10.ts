...
/**
 * Table live v10 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v9. The v10 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit `cornerRadius` on
 * `table/header` and `table/body` because compile header/body frames
 * omit `cornerRadius`. Does not omit `table/variant` cornerRadius.
 */
