...
import { COMBOBOX_LIVE_V6_CAPTURE_COUNT } from "./combobox-live-v6-contract.js";

test("Combobox live v6 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V6_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V6_CAPTURE_COUNT, 72);
