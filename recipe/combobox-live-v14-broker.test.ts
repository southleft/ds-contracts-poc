...
import { COMBOBOX_LIVE_V14_CAPTURE_COUNT } from "./combobox-live-v14-contract.js";

test("Combobox live v14 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V14_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V14_CAPTURE_COUNT, 72);
