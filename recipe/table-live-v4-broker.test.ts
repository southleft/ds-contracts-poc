...
import { TABLE_LIVE_V4_CAPTURE_COUNT } from "./table-live-v4-contract.js";

test("Table live v4 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V4_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V4_CAPTURE_COUNT, 20);
