...
import { CALENDAR_LIVE_V11_CAPTURE_COUNT } from "./calendar-live-v11-contract.js";

test("Calendar live v11 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V11_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V11_CAPTURE_COUNT, 8);
