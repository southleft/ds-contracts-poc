...
import { COMBOBOX_LIVE_V22_CAPTURE_COUNT } from "./combobox-live-v22-contract.js";

test("Combobox live v22 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V22_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V22_CAPTURE_COUNT, 72);
