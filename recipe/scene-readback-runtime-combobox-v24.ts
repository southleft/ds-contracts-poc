...
/**
 * Carried Combobox live v24 extract runtime. Keeps the v3 teaching that
 ...
 * clipsContent omit, listbox cornerRadius omit, and
 * listbox empty-effects omit live in
 * scene-readback-combobox-v24.
 * Does not restamp hashed v1–v23 lineage. Writer bytes
 * stay frozen.
 */
