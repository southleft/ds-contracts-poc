...
import { TABLE_LIVE_V29_CAPTURE_COUNT } from "./table-live-v29-contract.js";

test("Table live v29 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V29_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V29_CAPTURE_COUNT, 20);
