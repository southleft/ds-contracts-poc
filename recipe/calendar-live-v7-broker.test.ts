...
import { CALENDAR_LIVE_V7_CAPTURE_COUNT } from "./calendar-live-v7-contract.js";

test("Calendar live v7 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V7_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V7_CAPTURE_COUNT, 8);
