...
test("status gate rejects chronology, success, capture, hash, and criterion lies", () => {
  const plants: Array<(value: ReturnType<typeof fixtures>) => void> = [
    ...
    (value) => {
      value.status.input.liveV83.taughtCollapseOmitInventedContentTextOpacity =
        false;
    },
    (value) => {
      value.status.input.liveV83.inventCompileTextOpacityForbidden = false;
    },
    (value) => {
      value.status.input.liveV83.v82SceneReadbackUnchanged = false;
    },
    (value) => {
      value.status.input.liveV83.authorizationPresent = false;
    },
    (value) => {
      value.status.input.liveV83.v19WriterMinted = false;
    },
    (value) => {
      value.status.input.liveV83.inventOverlapZeroForbidden = false;
    },
    (value) => {
      value.status.input.liveV83.liveExecutionOccurred = false;
    },
    (value) => {
      value.status.input.liveV83.taughtContentOpacityOmitted = false;
    },
    (value) => {
      value.status.input.liveV83.taughtCompileCarryLiveOpacity = false;
    },
    (value) => {
      value.status.input.liveV83.taughtCollapseOmitInventedContentTextOpacityHeld =
        false;
    },
    (value) => {
      value.status.input.liveV83.taughtCompileCarryLiveOpacityHeld = false;
    },
    (value) => {
      value.status.input.liveV83.independentRootAccountingPassed = false;
    },
    (value) => {
      value.status.input.liveV83.recipeCollapseFixedPointStable = false;
    },
    (value) => {
      value.status.input.liveV83.probeIssued = false;
    },
    (value) => {
      value.status.input.liveV83.mintStayed = true;
    },
    (value) => {
      value.status.input.liveV83.probeOtherwiseGreen = true;
    },
    (value) => {
      value.status.input.liveV84.taughtProbeExcludeOpacityZeroOccupancyOverlap =
        false;
    },
    (value) => {
      value.status.input.liveV84.v83SceneReadbackUnchanged = false;
    },
    (value) => {
      value.status.input.liveV84.authorizationPresent = false;
    },
    (value) => {
      value.status.input.liveV84.v19WriterMinted = false;
    },
    (value) => {
    ...
    (value) => {
      value.status.input.liveV84.taughtWriterHiddenFillOccupancy = false;
    },
    (value) => {
      value.status.input.liveV85.taughtCleanupOnFailureOnly = false;
    },
    (value) => {
      value.status.input.liveV85.v84SceneReadbackUnchanged = false;
    },
    (value) => {
      value.status.input.liveV85.authorizationPresent = false;
    },
    (value) => {
