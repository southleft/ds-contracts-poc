...
import { TABLE_LIVE_V26_CAPTURE_COUNT } from "./table-live-v26-contract.js";

test("Table live v26 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V26_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V26_CAPTURE_COUNT, 20);
