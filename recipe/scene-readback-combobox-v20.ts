...
/**
 * Carried Combobox live v20 scene-readback. Keeps v1 host-normalize,
 ...
 * alias, v18 listbox compile-order sort, and v19 option-instance
 * binding extras-drop. Teaches host to omit inherited `fills` on
 * `combobox/option-instance` that compile never emits, not also
 * emit the inherited solid paint. Reuses the Input variant
 * fills/effects omit path: strip the key compile omits.
 * Does not invent a fill. Does not also teach listbox empty
 * effects. Does not also drop the extra instance `payload` key.
 * Does not invent a Combobox-only `if (combobox)`. Does not
 * patch hashed v1–v19 lineage bytes. Writer bytes stay frozen.
 */
...
export const COMBOBOX_LIVE_V20_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V20_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V20_RECOVER_RECIPE_COMPONENT_REF_MARKER =
  "COMBOBOX-HOST-RECOVER-RECIPE-COMPONENT-REF";
export const COMBOBOX_LIVE_V20_RECOVER_COMPONENT_PROPERTY_NAME_MARKER =
  "COMBOBOX-HOST-RECOVER-COMPONENT-PROPERTY-NAME-BEFORE-HASH";
export const COMBOBOX_LIVE_V20_TRIGGER_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRIGGER-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V20_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LEADING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V20_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-LEADING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V20_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRAILING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V20_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-TRAILING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V20_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-TRIGGER-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V20_OVERLAY_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OVERLAY-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V20_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER =
  "COMBOBOX-OVERLAY-LAYOUT-WIDTH-ALIAS-FROM-WIDTH-VALUE";
export const COMBOBOX_LIVE_V20_LISTBOX_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LISTBOX-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V20_OPTION_INSTANCE_BINDING_EXTRAS_MARKER =
  "COMBOBOX-OPTION-INSTANCE-BINDING-EXTRAS-DROPPED";
export const COMBOBOX_LIVE_V20_OPTION_INSTANCE_FILLS_OMITTED_MARKER =
...
const surfaceVariantLayoutWidthBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V20_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER;
...
const compileCarriedLeadingSlotVisible = (
  ...
  void COMBOBOX_LIVE_V20_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V20_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V20_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderTrailingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V20_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderOverlayBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V20_OVERLAY_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderListboxBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V20_LISTBOX_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const dropExtraOptionInstanceBindings = (
  ...
  void COMBOBOX_LIVE_V20_OPTION_INSTANCE_BINDING_EXTRAS_MARKER;
  const role = sceneRole(scene);
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V20_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
export function canonicalizeObservedComponentPropertyName(key: string): string {
  void COMBOBOX_LIVE_V20_RECOVER_COMPONENT_PROPERTY_NAME_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V20_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const omitOptionInstanceFills = <T extends { fills?: unknown }>(
  ...
  void COMBOBOX_LIVE_V20_OPTION_INSTANCE_FILLS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitSurfaceEffects = (
  ...
  void COMBOBOX_LIVE_V20_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
export function sceneToNormalizedIr(scene: SceneNodeSnapshot): IRNode {
  ...
  if (
    ...
    result = omitOptionInstanceFills(scene, {
      kind: "instance",
      ...common,
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V20_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
