...
import { TABLE_LIVE_V16_CAPTURE_COUNT } from "./table-live-v16-contract.js";

test("Table live v16 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V16_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V16_CAPTURE_COUNT, 20);
