...
/**
 * Carried Combobox live v5 scene-readback. Keeps v1 host-normalize and
 * v2–v4 extract teachings. Teaches that host must omit instance payload
 * when extract instancePayload has empty text and empty fills, matching
 * compile omit and the measured childless control/indicator payload.
 * Does not invent glyph text. Does not patch hashed v1–v4 lineage bytes.
 */
...
export const COMBOBOX_LIVE_V5_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V5_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
