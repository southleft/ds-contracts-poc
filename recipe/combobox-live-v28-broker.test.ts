...
import { COMBOBOX_LIVE_V28_CAPTURE_COUNT } from "./combobox-live-v28-contract.js";

test("Combobox live v28 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V28_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V28_CAPTURE_COUNT, 72);
