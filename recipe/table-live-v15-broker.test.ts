...
import { TABLE_LIVE_V15_CAPTURE_COUNT } from "./table-live-v15-contract.js";

test("Table live v15 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V15_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V15_CAPTURE_COUNT, 20);
