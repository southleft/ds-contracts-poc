...
import { COMBOBOX_LIVE_V13_CAPTURE_COUNT } from "./combobox-live-v13-contract.js";

test("Combobox live v13 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V13_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V13_CAPTURE_COUNT, 72);
