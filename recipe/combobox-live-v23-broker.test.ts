...
import { COMBOBOX_LIVE_V23_CAPTURE_COUNT } from "./combobox-live-v23-contract.js";

test("Combobox live v23 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V23_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V23_CAPTURE_COUNT, 72);
