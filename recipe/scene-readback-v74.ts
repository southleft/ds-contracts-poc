...
/**
 * Carried Input live v74 scene-readback. Keeps the v17–v72 teachings,
 * including Size axis order and instancePayload fill kind vs type.
 * Writer teaching (set `layoutSizingHorizontal` HUG) lives in the
 * unfrozen v17 writer, not here. Classifies fixture-measured
 * `instancePayload.intrinsicSize.width` and focus-effect `spread`
 * as carried / not required-equals when the cited library source
 * does not name those pixels. Named facts stay required (characters,
 * type role, fills, ring color, presence of effects). Does not
 * rewrite those pixels as compile truth. Does not invent 9/30/0.
 * Does not teach a library branch. Does not teach FIXED. Hashed
 * v72 scene-readback stays frozen.
 */
...
export const INPUT_LIVE_V74_SLOT_FILL_MARKER = "INPUT-SLOT-FILL-FROM-PAYLOAD";
export const INPUT_LIVE_V74_SLOT_COLOR_BINDING_MARKER =
  "INPUT-SLOT-COLOR-BINDING-FROM-CHILD";
export const INPUT_LIVE_V74_SURFACE_STROKE_WEIGHT_MARKER =
  "INPUT-SURFACE-STROKE-WEIGHT-FROM-PER-SIDE";
export const INPUT_LIVE_V74_VARIANT_LAYOUT_WIDTH_MARKER =
  "INPUT-VARIANT-LAYOUT-WIDTH-FROM-WIDTH";
export const INPUT_LIVE_V74_SURFACE_LAYOUT_HEIGHT_MARKER =
  "INPUT-SURFACE-LAYOUT-HEIGHT-FROM-HEIGHT";
export const INPUT_LIVE_V74_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER =
  "INPUT-VARIANT-LAYOUT-WIDTH-ALIAS-NO-DUPLICATE-WIDTH-VALUE";
export const INPUT_LIVE_V74_VARIANT_LAYOUT_WIDTH_COMPILE_INDEX_MARKER =
  "INPUT-VARIANT-LAYOUT-WIDTH-ALIAS-COMPILE-INDEX";
export const INPUT_LIVE_V74_SURFACE_BINDING_EXTRAS_MARKER =
  "INPUT-SURFACE-BINDING-EXTRAS-DROPPED";
export const INPUT_LIVE_V74_SURFACE_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-SURFACE-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_CONTENT_BINDING_EXTRAS_MARKER =
  "INPUT-CONTENT-BINDING-EXTRAS-DROPPED";
export const INPUT_LIVE_V74_CONTENT_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-CONTENT-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_CONTENT_HIDDEN_HEIGHT_HUG_MARKER =
  "INPUT-CONTENT-HIDDEN-FIXED-HEIGHT-AS-HUG";
export const INPUT_LIVE_V74_CONTENT_LETTER_SPACING_OMITTED_MARKER =
  "INPUT-CONTENT-LETTER-SPACING-OMITTED";
export const INPUT_LIVE_V74_CONTENT_TEXT_CASE_OMITTED_MARKER =
  "INPUT-CONTENT-TEXT-CASE-OMITTED";
export const INPUT_LIVE_V74_CONTENT_TEXT_DECORATION_OMITTED_MARKER =
  "INPUT-CONTENT-TEXT-DECORATION-OMITTED";
export const INPUT_LIVE_V74_CONTENT_ROW_CLIPS_CONTENT_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-CLIPS-CONTENT-OMITTED";
export const INPUT_LIVE_V74_CONTENT_ROW_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V74_CONTENT_ROW_EFFECTS_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-EFFECTS-OMITTED";
export const INPUT_LIVE_V74_CONTENT_ROW_STROKES_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-STROKES-OMITTED";
export const INPUT_LIVE_V74_LABEL_BINDING_EXTRAS_MARKER =
  "INPUT-LABEL-BINDING-EXTRAS-DROPPED";
export const INPUT_LIVE_V74_LABEL_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-LABEL-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_LABEL_LETTER_SPACING_OMITTED_MARKER =
  "INPUT-LABEL-LETTER-SPACING-OMITTED";
export const INPUT_LIVE_V74_LABEL_TEXT_CASE_OMITTED_MARKER =
  "INPUT-LABEL-TEXT-CASE-OMITTED";
export const INPUT_LIVE_V74_LABEL_TEXT_DECORATION_OMITTED_MARKER =
  "INPUT-LABEL-TEXT-DECORATION-OMITTED";
export const INPUT_LIVE_V74_LABEL_ROW_CLIPS_CONTENT_OMITTED_MARKER =
  "INPUT-LABEL-ROW-CLIPS-CONTENT-OMITTED";
export const INPUT_LIVE_V74_LABEL_ROW_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-LABEL-ROW-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V74_LABEL_ROW_EFFECTS_OMITTED_MARKER =
  "INPUT-LABEL-ROW-EFFECTS-OMITTED";
export const INPUT_LIVE_V74_LABEL_ROW_STROKES_OMITTED_MARKER =
  "INPUT-LABEL-ROW-STROKES-OMITTED";
export const INPUT_LIVE_V74_SURFACE_STROKE_DASH_PATTERN_OMITTED_MARKER =
  "INPUT-SURFACE-STROKE-DASH-PATTERN-OMITTED";
export const INPUT_LIVE_V74_MESSAGE_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-MESSAGE-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_MESSAGE_LETTER_SPACING_OMITTED_MARKER =
  "INPUT-MESSAGE-LETTER-SPACING-OMITTED";
export const INPUT_LIVE_V74_MESSAGE_TEXT_CASE_OMITTED_MARKER =
  "INPUT-MESSAGE-TEXT-CASE-OMITTED";
export const INPUT_LIVE_V74_MESSAGE_TEXT_DECORATION_OMITTED_MARKER =
  "INPUT-MESSAGE-TEXT-DECORATION-OMITTED";
export const INPUT_LIVE_V74_MESSAGE_CONTAINER_CLIPS_CONTENT_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-CLIPS-CONTENT-OMITTED";
export const INPUT_LIVE_V74_MESSAGE_CONTAINER_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V74_MESSAGE_CONTAINER_EFFECTS_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-EFFECTS-OMITTED";
export const INPUT_LIVE_V74_MESSAGE_CONTAINER_STROKES_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-STROKES-OMITTED";
export const INPUT_LIVE_V74_VARIANT_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-VARIANT-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V74_VARIANT_EFFECTS_OMITTED_MARKER =
  "INPUT-VARIANT-EFFECTS-OMITTED";
export const INPUT_LIVE_V74_VARIANT_STROKES_OMITTED_MARKER =
  "INPUT-VARIANT-STROKES-OMITTED";
export const INPUT_LIVE_V74_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-LEADING-SLOT-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_LEADING_SLOT_COMPILE_BINDING_FIELDS = [
  "fills.0.color",
  "width.value",
  "height.value",
] as const;
export const INPUT_LIVE_V74_LEADING_SLOT_ROLES = [
  "input-field/slot/leading",
] as const;
export const INPUT_LIVE_V74_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-TRAILING-SLOT-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_TRAILING_SLOT_COMPILE_BINDING_FIELDS = [
  "fills.0.color",
  "width.value",
  "height.value",
] as const;
export const INPUT_LIVE_V74_TRAILING_SLOT_ROLES = [
  "input-field/slot/trailing",
] as const;
export const INPUT_LIVE_V74_REQUIRED_INDICATOR_BINDING_EXTRAS_MARKER =
  "INPUT-REQUIRED-INDICATOR-BINDING-EXTRAS-DROP";
export const INPUT_LIVE_V74_REQUIRED_INDICATOR_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-REQUIRED-INDICATOR-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_REQUIRED_INDICATOR_COMPILE_BINDING_FIELDS = [
  "type.fontSize",
  "type.lineHeight.value",
  "fills.0.color",
] as const;
export const INPUT_LIVE_V74_REQUIRED_INDICATOR_ROLES = [
  "input-field/required-indicator",
] as const;
export const INPUT_LIVE_V74_REQUIRED_INDICATOR_LETTER_SPACING_OMITTED_MARKER =
  "INPUT-REQUIRED-INDICATOR-LETTER-SPACING-OMITTED";
export const INPUT_LIVE_V74_REQUIRED_INDICATOR_TEXT_CASE_OMITTED_MARKER =
  "INPUT-REQUIRED-INDICATOR-TEXT-CASE-OMITTED";
export const INPUT_LIVE_V74_REQUIRED_INDICATOR_TEXT_DECORATION_OMITTED_MARKER =
  "INPUT-REQUIRED-INDICATOR-TEXT-DECORATION-OMITTED";
export const INPUT_LIVE_V74_SET_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-SET-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V74_SET_EFFECTS_OMITTED_MARKER =
  "INPUT-SET-EFFECTS-OMITTED";
export const INPUT_LIVE_V74_SET_FILLS_OMITTED_MARKER =
  "INPUT-SET-FILLS-OMITTED";
export const INPUT_LIVE_V74_SET_STROKES_OMITTED_MARKER =
  "INPUT-SET-STROKES-OMITTED";
export const INPUT_LIVE_V74_LABEL_ROW_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-LABEL-ROW-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V74_LABEL_ROW_COMPILE_BINDING_FIELDS = [
  "layout.itemSpacing",
  "layout.padding.top",
  "layout.padding.left",
] as const;
export const INPUT_LIVE_V74_LABEL_ROW_ROLES = [
  "input-field/label-row",
] as const;
export const INPUT_LIVE_V74_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER =
  "INPUT-SURFACE-LAYOUT-HEIGHT-ALIAS-NO-DUPLICATE-HEIGHT-VALUE";
export const INPUT_LIVE_V74_SURFACE_BINDING_ITEM_SPACING_COMPILE_ORDER_MARKER =
  "INPUT-SURFACE-BINDING-ITEM-SPACING-COMPILE-ORDER";
export const INPUT_LIVE_V74_FONT_PROVENANCE_NAME_ORDER_MARKER =
  "INPUT-FONT-PROVENANCE-NAME-KEY-ORDER-COMPILE";
export const INPUT_LIVE_V74_INSTANCE_PAYLOAD_FILL_KIND_MARKER =
  "INPUT-INSTANCE-PAYLOAD-FILL-KIND-COMPILE";
export const INPUT_LIVE_V74_VARIANT_AXIS_SIZE_ORDER_MARKER =
  "INPUT-VARIANT-AXIS-SIZE-ORDER-COMPILE";
export const INPUT_LIVE_V74_UNNAMED_SOURCE_PX_CARRIED_MARKER =
  "INPUT-UNNAMED-SOURCE-PX-CARRIED-NOT-REQUIRED-EQUALS";
export const INPUT_LIVE_V74_SIZE_AXIS_COMPILE_VALUES = [
  "small",
  "medium",
] as const;
export const INPUT_LIVE_V74_SURFACE_COMPILE_BINDING_FIELDS = [
  "layout.itemSpacing",
...
export const INPUT_LIVE_V74_CONTENT_COMPILE_BINDING_FIELDS = [
  "type.fontSize",
  "type.lineHeight.value",
  "fills.0.color",
] as const;
export const INPUT_LIVE_V74_SLOT_ROLES = [
  "input-field/slot/leading",
  "input-field/slot/trailing",
] as const;
export const INPUT_LIVE_V74_SURFACE_ROLES = ["input-field/surface"] as const;
export const INPUT_LIVE_V74_CONTENT_ROLES = [
  "input-field/content/placeholder",
  "input-field/content/value",
] as const;
export const INPUT_LIVE_V74_LABEL_ROLES = ["input-field/label"] as const;
export const INPUT_LIVE_V74_MESSAGE_ROLES = [
  "input-field/message/helper",
  "input-field/message/error",
] as const;
export const INPUT_LIVE_V74_VARIANT_ROLE_PREFIX = "input-field/variant/";
export const INPUT_LIVE_V74_PER_SIDE_STROKE_WEIGHT_FIELDS = [
  "strokeTopWeight",
  "strokeRightWeight",
  "strokeBottomWeight",
  "strokeLeftWeight",
...
const SURFACE_ROLES = new Set<string>(INPUT_LIVE_V74_SURFACE_ROLES);
...
const surfaceVariantLayoutWidthBinding = (
  ...
  if (
    role === undefined ||
    !role.startsWith(INPUT_LIVE_V74_VARIANT_ROLE_PREFIX)
  )
    return own;
...
const orderSurfaceBindingsToCompileFields = (
  ...
  if (role === undefined || !SURFACE_ROLES.has(role)) return own;
  const rank = new Map(
    INPUT_LIVE_V74_SURFACE_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const CONTENT_ROLES = new Set<string>(INPUT_LIVE_V74_CONTENT_ROLES);
const LABEL_ROLES = new Set<string>(INPUT_LIVE_V74_LABEL_ROLES);
const MESSAGE_ROLES = new Set<string>(INPUT_LIVE_V74_MESSAGE_ROLES);
...
const orderContentBindingsToCompileFields = (
  ...
  const rank = new Map(
    INPUT_LIVE_V74_CONTENT_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  const rank = new Map(
    INPUT_LIVE_V74_LEADING_SLOT_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const orderTrailingSlotBindingsToCompileFields = (
  ...
  const rank = new Map(
    INPUT_LIVE_V74_TRAILING_SLOT_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const orderRequiredIndicatorBindingsToCompileFields = (
  ...
  if (role === undefined || !REQUIRED_INDICATOR_ROLES.has(role)) return own;
  const rank = new Map(
    INPUT_LIVE_V74_REQUIRED_INDICATOR_COMPILE_BINDING_FIELDS.map(
...
const LABEL_ROW_ROLES = new Set<string>(INPUT_LIVE_V74_LABEL_ROW_ROLES);
...
const orderLabelRowBindingsToCompileFields = (
  ...
  const rank = new Map(
    INPUT_LIVE_V74_LABEL_ROW_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const SLOT_ROLES = new Set<string>(INPUT_LIVE_V74_SLOT_ROLES);
...
export function canonicalizeObservedVariantAxisSizeOrder(
  ...
  const compile = [...INPUT_LIVE_V74_SIZE_AXIS_COMPILE_VALUES];
