...
/**
 * Carried Combobox live v40 scene-readback. Keeps v1 host-normalize,
 ...
 * sibling-order recovery. v40 teaching is
 * probe-only: keep exactSceneRestoration
 * after the open-variant walk when resize
 * and property restore already pass. This
 * file does not change host normalize.
 * Does not invent `if (combobox)`. Does
 * not change the writer. Does not patch
 * hashed v1–v39 lineage bytes. Writer
 * bytes stay frozen.
 */
...
export const COMBOBOX_LIVE_V40_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V40_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V40_RECOVER_RECIPE_COMPONENT_REF_MARKER =
  "COMBOBOX-HOST-RECOVER-RECIPE-COMPONENT-REF";
export const COMBOBOX_LIVE_V40_RECOVER_COMPONENT_PROPERTY_NAME_MARKER =
  "COMBOBOX-HOST-RECOVER-COMPONENT-PROPERTY-NAME-BEFORE-HASH";
export const COMBOBOX_LIVE_V40_TRIGGER_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRIGGER-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V40_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LEADING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V40_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-LEADING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V40_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRAILING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V40_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-TRAILING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V40_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-TRIGGER-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V40_OVERLAY_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OVERLAY-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V40_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER =
  "COMBOBOX-OVERLAY-LAYOUT-WIDTH-ALIAS-FROM-WIDTH-VALUE";
export const COMBOBOX_LIVE_V40_LISTBOX_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LISTBOX-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V40_OPTION_INSTANCE_BINDING_EXTRAS_MARKER =
  "COMBOBOX-OPTION-INSTANCE-BINDING-EXTRAS-DROPPED";
export const COMBOBOX_LIVE_V40_OPTION_INSTANCE_FILLS_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-INHERITED-FILLS-OMITTED";
export const COMBOBOX_LIVE_V40_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-PAYLOAD-OMITTED";
export const COMBOBOX_LIVE_V40_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V40_LISTBOX_CORNER_RADIUS_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CORNER-RADIUS-OMITTED";
export const COMBOBOX_LIVE_V40_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V40_LISTBOX_EMPTY_STROKES_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-EMPTY-STROKES-OMITTED";
export const COMBOBOX_LIVE_V40_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER =
  "COMBOBOX-OVERLAY-EMPTY-DASH-PATTERN-OMITTED";
export const COMBOBOX_LIVE_V40_SET_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-SET-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V40_OPTION_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OPTION-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V40_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER =
  "COMBOBOX-OPTION-LAYOUT-HEIGHT-ALIAS-FROM-HEIGHT-VALUE";
export const COMBOBOX_LIVE_V40_OPTION_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-OPTION-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V40_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-SELECTED-INDICATOR-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V40_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-SELECTED-INDICATOR-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V40_OPTION_SET_COMPILE_CARRY_LABEL_MARKER =
  "COMBOBOX-OPTION-SET-COMPILE-CARRY-LABEL";
export const COMBOBOX_LIVE_V40_OBSERVE_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OBSERVE-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V40_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OBSERVE-OMIT-OPTION-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V40_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER =
  "COMBOBOX-HOST-TRIGGER-SLOT-COMPONENT-REF-COMPILE-SIBLING-ORDER";
export const COMBOBOX_LIVE_V40_TRIGGER_COMPILE_CARRY_CHARACTERS_MARKER =
  "COMBOBOX-TRIGGER-COMPILE-CARRY-CHARACTERS";
export const COMBOBOX_LIVE_V40_TRIGGER_COMPILE_CARRY_CHARACTERS =
  "Choose a person";
export const COMBOBOX_LIVE_V40_OPTION_SET_COMPILE_CARRY_LABEL =
  "Combobox option";
export const COMBOBOX_LIVE_V40_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER =
  "COMBOBOX-HOST-OBSERVE-OPTION-SET-COMPILE-CARRY-NAME";
export const COMBOBOX_LIVE_V40_OPTION_SET_COMPILE_CARRY_NAME =
  `combobox/option-set :: ${COMBOBOX_LIVE_V40_OPTION_SET_COMPILE_CARRY_LABEL}`;
...
export const COMBOBOX_LIVE_V40_TRIGGER_SLOT_COMPILE_SIBLING_ROLES = [
  ...COMBOBOX_LIVE_V1_LEADING_SLOT_ROLES,
  ...COMBOBOX_LIVE_V1_TRAILING_SLOT_ROLES,
] as const;
export const COMBOBOX_LIVE_V40_TRIGGER_SLOT_COMPILE_SIBLING_COMPONENT_REFS = [
  "prefix",
  "clear",
  "popup",
] as const;
...
const surfaceVariantLayoutWidthBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V40_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER;
...
const surfaceLayoutHeightBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V40_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER;
...
const compileCarriedLeadingSlotVisible = (
  ...
  void COMBOBOX_LIVE_V40_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V40_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V40_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER;
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V40_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderTrailingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V40_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderSelectedIndicatorBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V40_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderOverlayBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V40_OVERLAY_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderListboxBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V40_LISTBOX_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderOptionBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V40_OPTION_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const dropExtraOptionInstanceBindings = (
  ...
  void COMBOBOX_LIVE_V40_OPTION_INSTANCE_BINDING_EXTRAS_MARKER;
  const role = sceneRole(scene);
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V40_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
export function canonicalizeObservedTriggerSlotComponentRef(
  ...
  void COMBOBOX_LIVE_V40_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER;
  const recovered = canonicalizeObservedComponentRef(liveRef, role);
  const index = (
    COMBOBOX_LIVE_V40_TRIGGER_SLOT_COMPILE_SIBLING_ROLES as readonly string[]
  ).indexOf(role ?? "");
  if (index < 0) return recovered;
  return replaceLastComponentRefSegment(
    recovered,
    COMBOBOX_LIVE_V40_TRIGGER_SLOT_COMPILE_SIBLING_COMPONENT_REFS[index]!,
  );
}

export function canonicalizeObservedComponentPropertyName(key: string): string {
  void COMBOBOX_LIVE_V40_RECOVER_COMPONENT_PROPERTY_NAME_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V40_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const shouldOmitObservedInstancePayload = (
  ...
  void COMBOBOX_LIVE_V40_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER;
...
const compileCarriedOptionSetLabel = (scene: SceneNodeSnapshot): string => {
  void COMBOBOX_LIVE_V40_OPTION_SET_COMPILE_CARRY_LABEL_MARKER;
  if (sceneRole(scene) === "combobox/option-set")
    return COMBOBOX_LIVE_V40_OPTION_SET_COMPILE_CARRY_LABEL;
  return sceneLabel(scene);
};

const compileCarriedObservedName = (scene: SceneNodeSnapshot): string => {
  void COMBOBOX_LIVE_V40_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER;
  if (sceneRole(scene) === "combobox/option-set")
    return COMBOBOX_LIVE_V40_OPTION_SET_COMPILE_CARRY_NAME;
  return scene.name;
};
...
const compileCarriedTriggerCharacters = (
  ...
  void COMBOBOX_LIVE_V40_TRIGGER_COMPILE_CARRY_CHARACTERS_MARKER;
  if (
    sceneRole(scene) === "combobox/input" &&
    variantProperties?.Content === "empty"
  )
    return COMBOBOX_LIVE_V40_TRIGGER_COMPILE_CARRY_CHARACTERS;
...
const omitContentRowClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
...
const omitContentRowCornerRadius = <T extends { cornerRadius?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_LISTBOX_CORNER_RADIUS_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
    role !== "combobox/trailing-controls" &&
    role !== "combobox/label-row-absent" &&
...
const omitContentRowStrokes = <T extends { strokes?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_LISTBOX_EMPTY_STROKES_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
    role !== "combobox/trailing-controls" &&
    role !== "combobox/label-row-absent" &&
...
const omitOptionInstanceFills = <T extends { fills?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_OPTION_INSTANCE_FILLS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitOptionInstancePayload = <T extends { payload?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (!isOptionInstanceRole(role)) return frame;
  if (scene.type !== "INSTANCE") return frame;
...
const omitSetClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_SET_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (role !== "combobox/set" && role !== "combobox/option-set") return frame;
  if (scene.type !== "COMPONENT_SET") return frame;
  if (frame.clipsContent === undefined) return frame;
...
const omitOptionClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_OPTION_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitSurfaceStrokeDashPattern = <T extends { dashPattern?: unknown }>(
  ...
  void COMBOBOX_LIVE_V40_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitSurfaceEffects = (
  ...
  void COMBOBOX_LIVE_V40_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER;
  void COMBOBOX_LIVE_V40_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V40_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
  void COMBOBOX_LIVE_V40_OBSERVE_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
  void COMBOBOX_LIVE_V40_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER;
  void COMBOBOX_LIVE_V40_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER;
  void COMBOBOX_LIVE_V40_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER;
