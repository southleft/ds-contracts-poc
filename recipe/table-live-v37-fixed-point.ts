/**
 * Table live v37 host verifier. Table-shaped: table/row/cell ownership,
...
export const TABLE_LIVE_V37_FIXED_VERIFIER_VERSION = "table-live-v37-fixed-point-v1";
export const TABLE_LIVE_V37_FIXED_REQUIRED_GATE_IDS = [
...
export interface TableLiveV37FixedThresholds {
  clipping: { maximumVisibleAreaLoss: number };
  overlap: { maximumPixels: number };
}

export interface TableLiveV37FixedCellValidation {
  cellKey: string;
  source: string;
  kind: "table" | "row" | "cell";
  rolesExact: boolean;
...
export interface TableLiveV37FixedSourceProbe {
...
export interface TableLiveV37FixedSceneProof {
  adapterIdentity: string;
  accounting: SceneComparison;
  fixedPoint: TableLiveV37FixedFixedPoint;
}

export interface TableLiveV37FixedHardGateInput {
  thresholds: TableLiveV37FixedThresholds;
  sourceProbes: TableLiveV37FixedSourceProbe[];
  cells: TableLiveV37FixedCellValidation[];
  sceneProofs: TableLiveV37FixedSceneProof[];
...
export interface TableLiveV37FixedHardGateReport {
  verifierVersion: typeof TABLE_LIVE_V37_FIXED_VERIFIER_VERSION;
...
export interface TableLiveV37FixedFixedPoint {
  stable: boolean;
  sourceIrRead: false;
...
export function verifyTableLiveV37FixedHardGates(
  input: TableLiveV37FixedHardGateInput,
): TableLiveV37FixedHardGateReport {
  ...
  const exactFields: Array<keyof TableLiveV37FixedCellValidation> = [
    "rolesExact",
    "stateSemanticsExact",
    "noFakeLayout",
  ];
  ...
  return {
    verifierVersion: TABLE_LIVE_V37_FIXED_VERIFIER_VERSION,
    technicalPassed,
    overallInputSuccess:
      technicalPassed &&
      input.humanSignoff.status === "passed" &&
...
export function verifyTableLiveV37FixedSceneFixedPoint<Instance>(
...
export function proveSceneMultiset(
  ...
  scene: SceneNodeSnapshot,
): Pick<TableLiveV37FixedSceneProof, "adapterIdentity" | "accounting"> {
  return {
    adapterIdentity,
