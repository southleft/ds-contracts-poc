...
import { COMBOBOX_LIVE_V35_CAPTURE_COUNT } from "./combobox-live-v35-contract.js";

test("Combobox live v35 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V35_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V35_CAPTURE_COUNT, 72);
