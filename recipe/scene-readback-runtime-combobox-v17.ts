...
/**
 * Carried Combobox live v17 extract runtime. Keeps the v3 teaching that
 ...
 * omit, overlay compile-order binding sort, and overlay
 * `width.value` → `layout.width.value` alias live in
 * scene-readback-combobox-v17. Does not restamp hashed v1–v16
