...
/**
 * Carried Combobox live v33 scene-readback. Keeps v1 host-normalize,
 ...
 * visible. Teaches the existing compile-carry
 * label path for `combobox/option-set` so host
 * emits compile-carried `Combobox option`
 * instead of the live display name after ` :: `.
 * Does not invent a label. Does not parse the
 * live fixture string. Does not invent
 * Button-style set chrome. Does not change
 * `combobox/set` labels that already match
 * compile `identity.name`. Does not invent
 * `if (combobox)` beyond option-set. Does not
 * change the writer. Does not patch hashed
 * v1–v32 lineage bytes. Writer bytes stay
 * frozen.
 */
...
export const COMBOBOX_LIVE_V33_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V33_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V33_RECOVER_RECIPE_COMPONENT_REF_MARKER =
  "COMBOBOX-HOST-RECOVER-RECIPE-COMPONENT-REF";
export const COMBOBOX_LIVE_V33_RECOVER_COMPONENT_PROPERTY_NAME_MARKER =
  "COMBOBOX-HOST-RECOVER-COMPONENT-PROPERTY-NAME-BEFORE-HASH";
export const COMBOBOX_LIVE_V33_TRIGGER_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRIGGER-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V33_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LEADING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V33_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-LEADING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V33_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRAILING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V33_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-TRAILING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V33_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-TRIGGER-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V33_OVERLAY_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OVERLAY-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V33_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER =
  "COMBOBOX-OVERLAY-LAYOUT-WIDTH-ALIAS-FROM-WIDTH-VALUE";
export const COMBOBOX_LIVE_V33_LISTBOX_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LISTBOX-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V33_OPTION_INSTANCE_BINDING_EXTRAS_MARKER =
  "COMBOBOX-OPTION-INSTANCE-BINDING-EXTRAS-DROPPED";
export const COMBOBOX_LIVE_V33_OPTION_INSTANCE_FILLS_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-INHERITED-FILLS-OMITTED";
export const COMBOBOX_LIVE_V33_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-PAYLOAD-OMITTED";
export const COMBOBOX_LIVE_V33_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V33_LISTBOX_CORNER_RADIUS_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CORNER-RADIUS-OMITTED";
export const COMBOBOX_LIVE_V33_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V33_LISTBOX_EMPTY_STROKES_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-EMPTY-STROKES-OMITTED";
export const COMBOBOX_LIVE_V33_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER =
  "COMBOBOX-OVERLAY-EMPTY-DASH-PATTERN-OMITTED";
export const COMBOBOX_LIVE_V33_SET_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-SET-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V33_OPTION_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OPTION-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V33_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER =
  "COMBOBOX-OPTION-LAYOUT-HEIGHT-ALIAS-FROM-HEIGHT-VALUE";
export const COMBOBOX_LIVE_V33_OPTION_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-OPTION-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V33_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-SELECTED-INDICATOR-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V33_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-SELECTED-INDICATOR-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V33_OPTION_SET_COMPILE_CARRY_LABEL_MARKER =
  "COMBOBOX-OPTION-SET-COMPILE-CARRY-LABEL";
export const COMBOBOX_LIVE_V33_OPTION_SET_COMPILE_CARRY_LABEL =
  "Combobox option";
...
const surfaceVariantLayoutWidthBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V33_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER;
...
const surfaceLayoutHeightBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V33_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER;
...
const compileCarriedLeadingSlotVisible = (
  ...
  void COMBOBOX_LIVE_V33_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V33_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V33_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER;
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V33_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderTrailingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V33_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderSelectedIndicatorBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V33_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderOverlayBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V33_OVERLAY_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderListboxBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V33_LISTBOX_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderOptionBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V33_OPTION_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const dropExtraOptionInstanceBindings = (
  ...
  void COMBOBOX_LIVE_V33_OPTION_INSTANCE_BINDING_EXTRAS_MARKER;
  const role = sceneRole(scene);
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V33_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
export function canonicalizeObservedComponentPropertyName(key: string): string {
  void COMBOBOX_LIVE_V33_RECOVER_COMPONENT_PROPERTY_NAME_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V33_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const compileCarriedOptionSetLabel = (scene: SceneNodeSnapshot): string => {
  void COMBOBOX_LIVE_V33_OPTION_SET_COMPILE_CARRY_LABEL_MARKER;
  if (sceneRole(scene) === "combobox/option-set")
    return COMBOBOX_LIVE_V33_OPTION_SET_COMPILE_CARRY_LABEL;
...
const omitContentRowClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
...
const omitContentRowCornerRadius = <T extends { cornerRadius?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_LISTBOX_CORNER_RADIUS_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
    role !== "combobox/trailing-controls" &&
    role !== "combobox/label-row-absent" &&
...
const omitContentRowStrokes = <T extends { strokes?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_LISTBOX_EMPTY_STROKES_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
    role !== "combobox/trailing-controls" &&
    role !== "combobox/label-row-absent" &&
...
const omitOptionInstanceFills = <T extends { fills?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_OPTION_INSTANCE_FILLS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitOptionInstancePayload = <T extends { payload?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (!isOptionInstanceRole(role)) return frame;
  if (scene.type !== "INSTANCE") return frame;
...
const omitSetClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_SET_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (role !== "combobox/set" && role !== "combobox/option-set") return frame;
  if (scene.type !== "COMPONENT_SET") return frame;
  if (frame.clipsContent === undefined) return frame;
...
const omitOptionClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_OPTION_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitSurfaceStrokeDashPattern = <T extends { dashPattern?: unknown }>(
  ...
  void COMBOBOX_LIVE_V33_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitSurfaceEffects = (
  ...
  void COMBOBOX_LIVE_V33_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER;
  void COMBOBOX_LIVE_V33_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V33_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
