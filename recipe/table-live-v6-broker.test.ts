...
import { TABLE_LIVE_V6_CAPTURE_COUNT } from "./table-live-v6-contract.js";

test("Table live v6 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V6_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V6_CAPTURE_COUNT, 20);
