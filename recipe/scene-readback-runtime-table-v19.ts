...
/**
 * Table live v19 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v18. The v19 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit `strokes` on
 * `table/set`, `table/row-set`, and `table/cell-set` because compile
 * component-sets omit `strokes`. Does not omit `table/variant`
 * `strokes` or `cornerRadius`. Does not invent `strokes` onto compile
 * sets.
 */
