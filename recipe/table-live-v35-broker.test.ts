...
import { TABLE_LIVE_V35_CAPTURE_COUNT } from "./table-live-v35-contract.js";

test("Table live v35 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V35_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V35_CAPTURE_COUNT, 20);
