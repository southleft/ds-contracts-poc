...
import { COMBOBOX_LIVE_V37_CAPTURE_COUNT } from "./combobox-live-v37-contract.js";

test("Combobox live v37 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V37_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V37_CAPTURE_COUNT, 72);
