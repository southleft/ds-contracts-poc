...
import { TABLE_LIVE_V36_CAPTURE_COUNT } from "./table-live-v36-contract.js";

test("Table live v36 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V36_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V36_CAPTURE_COUNT, 20);
