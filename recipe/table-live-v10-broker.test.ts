...
import { TABLE_LIVE_V10_CAPTURE_COUNT } from "./table-live-v10-contract.js";

test("Table live v10 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V10_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V10_CAPTURE_COUNT, 20);
