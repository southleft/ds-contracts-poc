...
/**
 * Carried Input live v51 scene-readback. Keeps the v17–v45 teachings,
...
export const INPUT_LIVE_V51_SLOT_FILL_MARKER = "INPUT-SLOT-FILL-FROM-PAYLOAD";
export const INPUT_LIVE_V51_SLOT_COLOR_BINDING_MARKER =
  "INPUT-SLOT-COLOR-BINDING-FROM-CHILD";
export const INPUT_LIVE_V51_SURFACE_STROKE_WEIGHT_MARKER =
  "INPUT-SURFACE-STROKE-WEIGHT-FROM-PER-SIDE";
export const INPUT_LIVE_V51_VARIANT_LAYOUT_WIDTH_MARKER =
  "INPUT-VARIANT-LAYOUT-WIDTH-FROM-WIDTH";
export const INPUT_LIVE_V51_SURFACE_LAYOUT_HEIGHT_MARKER =
  "INPUT-SURFACE-LAYOUT-HEIGHT-FROM-HEIGHT";
export const INPUT_LIVE_V51_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER =
  "INPUT-VARIANT-LAYOUT-WIDTH-ALIAS-NO-DUPLICATE-WIDTH-VALUE";
export const INPUT_LIVE_V51_VARIANT_LAYOUT_WIDTH_COMPILE_INDEX_MARKER =
  "INPUT-VARIANT-LAYOUT-WIDTH-ALIAS-COMPILE-INDEX";
export const INPUT_LIVE_V51_SURFACE_BINDING_EXTRAS_MARKER =
  "INPUT-SURFACE-BINDING-EXTRAS-DROPPED";
export const INPUT_LIVE_V51_SURFACE_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-SURFACE-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V51_CONTENT_BINDING_EXTRAS_MARKER =
  "INPUT-CONTENT-BINDING-EXTRAS-DROPPED";
export const INPUT_LIVE_V51_CONTENT_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-CONTENT-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V51_CONTENT_HIDDEN_HEIGHT_HUG_MARKER =
  "INPUT-CONTENT-HIDDEN-FIXED-HEIGHT-AS-HUG";
export const INPUT_LIVE_V51_CONTENT_LETTER_SPACING_OMITTED_MARKER =
  "INPUT-CONTENT-LETTER-SPACING-OMITTED";
export const INPUT_LIVE_V51_CONTENT_TEXT_CASE_OMITTED_MARKER =
  "INPUT-CONTENT-TEXT-CASE-OMITTED";
export const INPUT_LIVE_V51_CONTENT_TEXT_DECORATION_OMITTED_MARKER =
  "INPUT-CONTENT-TEXT-DECORATION-OMITTED";
export const INPUT_LIVE_V51_CONTENT_ROW_CLIPS_CONTENT_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-CLIPS-CONTENT-OMITTED";
export const INPUT_LIVE_V51_CONTENT_ROW_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V51_CONTENT_ROW_EFFECTS_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-EFFECTS-OMITTED";
export const INPUT_LIVE_V51_CONTENT_ROW_STROKES_OMITTED_MARKER =
  "INPUT-CONTENT-ROW-STROKES-OMITTED";
export const INPUT_LIVE_V51_LABEL_BINDING_EXTRAS_MARKER =
  "INPUT-LABEL-BINDING-EXTRAS-DROPPED";
export const INPUT_LIVE_V51_LABEL_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-LABEL-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V51_LABEL_LETTER_SPACING_OMITTED_MARKER =
  "INPUT-LABEL-LETTER-SPACING-OMITTED";
export const INPUT_LIVE_V51_LABEL_TEXT_CASE_OMITTED_MARKER =
  "INPUT-LABEL-TEXT-CASE-OMITTED";
export const INPUT_LIVE_V51_LABEL_TEXT_DECORATION_OMITTED_MARKER =
  "INPUT-LABEL-TEXT-DECORATION-OMITTED";
export const INPUT_LIVE_V51_LABEL_ROW_CLIPS_CONTENT_OMITTED_MARKER =
  "INPUT-LABEL-ROW-CLIPS-CONTENT-OMITTED";
export const INPUT_LIVE_V51_LABEL_ROW_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-LABEL-ROW-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V51_LABEL_ROW_EFFECTS_OMITTED_MARKER =
  "INPUT-LABEL-ROW-EFFECTS-OMITTED";
export const INPUT_LIVE_V51_LABEL_ROW_STROKES_OMITTED_MARKER =
  "INPUT-LABEL-ROW-STROKES-OMITTED";
export const INPUT_LIVE_V51_SURFACE_STROKE_DASH_PATTERN_OMITTED_MARKER =
  "INPUT-SURFACE-STROKE-DASH-PATTERN-OMITTED";
export const INPUT_LIVE_V51_MESSAGE_BINDING_COMPILE_ORDER_MARKER =
  "INPUT-MESSAGE-BINDING-COMPILE-ORDER";
export const INPUT_LIVE_V51_MESSAGE_LETTER_SPACING_OMITTED_MARKER =
  "INPUT-MESSAGE-LETTER-SPACING-OMITTED";
export const INPUT_LIVE_V51_MESSAGE_TEXT_CASE_OMITTED_MARKER =
  "INPUT-MESSAGE-TEXT-CASE-OMITTED";
export const INPUT_LIVE_V51_MESSAGE_TEXT_DECORATION_OMITTED_MARKER =
  "INPUT-MESSAGE-TEXT-DECORATION-OMITTED";
export const INPUT_LIVE_V51_MESSAGE_CONTAINER_CLIPS_CONTENT_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-CLIPS-CONTENT-OMITTED";
export const INPUT_LIVE_V51_MESSAGE_CONTAINER_CORNER_RADIUS_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-CORNER-RADIUS-OMITTED";
export const INPUT_LIVE_V51_MESSAGE_CONTAINER_EFFECTS_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-EFFECTS-OMITTED";
export const INPUT_LIVE_V51_MESSAGE_CONTAINER_STROKES_OMITTED_MARKER =
  "INPUT-MESSAGE-CONTAINER-STROKES-OMITTED";
export const INPUT_LIVE_V51_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER =
  "INPUT-SURFACE-LAYOUT-HEIGHT-ALIAS-NO-DUPLICATE-HEIGHT-VALUE";
export const INPUT_LIVE_V51_SURFACE_COMPILE_BINDING_FIELDS = [
...
export const INPUT_LIVE_V51_CONTENT_COMPILE_BINDING_FIELDS = [
  "type.fontSize",
  "type.lineHeight.value",
  "fills.0.color",
] as const;
export const INPUT_LIVE_V51_SLOT_ROLES = [
  "input-field/slot/leading",
  "input-field/slot/trailing",
] as const;
export const INPUT_LIVE_V51_SURFACE_ROLES = ["input-field/surface"] as const;
export const INPUT_LIVE_V51_CONTENT_ROLES = [
  "input-field/content/placeholder",
  "input-field/content/value",
] as const;
export const INPUT_LIVE_V51_LABEL_ROLES = ["input-field/label"] as const;
export const INPUT_LIVE_V51_MESSAGE_ROLES = [
  "input-field/message/helper",
  "input-field/message/error",
] as const;
export const INPUT_LIVE_V51_VARIANT_ROLE_PREFIX = "input-field/variant/";
export const INPUT_LIVE_V51_PER_SIDE_STROKE_WEIGHT_FIELDS = [
  "strokeTopWeight",
  "strokeRightWeight",
  "strokeBottomWeight",
  "strokeLeftWeight",
...
const SURFACE_ROLES = new Set<string>(INPUT_LIVE_V51_SURFACE_ROLES);
...
const surfaceVariantLayoutWidthBinding = (
  ...
  if (
    role === undefined ||
    !role.startsWith(INPUT_LIVE_V51_VARIANT_ROLE_PREFIX)
  )
    return own;
...
const orderSurfaceBindingsToCompileFields = (
  ...
  if (role === undefined || !SURFACE_ROLES.has(role)) return own;
  const rank = new Map(
    INPUT_LIVE_V51_SURFACE_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const CONTENT_ROLES = new Set<string>(INPUT_LIVE_V51_CONTENT_ROLES);
const LABEL_ROLES = new Set<string>(INPUT_LIVE_V51_LABEL_ROLES);
const MESSAGE_ROLES = new Set<string>(INPUT_LIVE_V51_MESSAGE_ROLES);
...
const orderContentBindingsToCompileFields = (
  ...
  const rank = new Map(
    INPUT_LIVE_V51_CONTENT_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const SLOT_ROLES = new Set<string>(INPUT_LIVE_V51_SLOT_ROLES);
...
export function sceneToNormalizedIr(scene: SceneNodeSnapshot): IRNode {
  ...
  if (
    ...
    const frame = omitContentRowStrokes(
      scene,
