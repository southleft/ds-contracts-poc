...
import {
  ...
  COMBOBOX_LIVE_V41_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V41_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V41_LISTBOX_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V41_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_LISTBOX_CORNER_RADIUS_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_LISTBOX_EMPTY_STROKES_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V41_OBSERVE_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V41_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V41_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER,
  COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_LABEL,
  COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_LABEL_MARKER,
  COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_NAME,
  COMBOBOX_LIVE_V41_OPTION_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V41_OPTION_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER,
  COMBOBOX_LIVE_V41_OPTION_INSTANCE_BINDING_EXTRAS_MARKER,
  COMBOBOX_LIVE_V41_OPTION_INSTANCE_FILLS_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_OVERLAY_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V41_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_SET_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER,
  COMBOBOX_LIVE_V41_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER,
  COMBOBOX_LIVE_V41_RECOVER_COMPONENT_PROPERTY_NAME_MARKER,
  COMBOBOX_LIVE_V41_RECOVER_RECIPE_COMPONENT_REF_MARKER,
  COMBOBOX_LIVE_V41_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V41_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V41_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V41_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V41_TRIGGER_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V41_TRIGGER_COMPILE_CARRY_CHARACTERS,
  COMBOBOX_LIVE_V41_TRIGGER_COMPILE_CARRY_CHARACTERS_MARKER,
  COMBOBOX_LIVE_V41_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER,
  COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER,
  COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPILE_SIBLING_COMPONENT_REFS,
  COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPILE_SIBLING_ROLES,
...
test("compile trigger-slot componentRefs are prefix then clear then popup", () => {
  ...
  const refs = walkIr(trigger)
    .filter(
      (node) =>
        node.kind === "instance" &&
        (COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPILE_SIBLING_ROLES as readonly string[]).includes(
          node.role ?? "",
        ),
    )
    .map((node) =>
