...
const EVIDENCE = "recipe/evidence/checkbox-live-pivot-v1";
  ...
  JSON.stringify(
    {
      ...
      teaching:
        "checkbox@1 selection-control box + dash + label from named package tokens; SVG check paths and AntD rotated tick are receipted",
...
writeFileSync(
  ...
  JSON.stringify(
    {
      artifactVersion: "checkbox-live-pivot-v1-prepare",
      teaching:
        "selection-control box, dash, and label compiled from named Astryx/MUI/AntD package facts; SVG check paths and AntD rotated tick receipted",
      runIdentity: writer.runIdentity,
      pageName: writer.pageName,
      namespace: writer.namespace,
