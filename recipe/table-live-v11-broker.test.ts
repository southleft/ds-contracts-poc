...
import { TABLE_LIVE_V11_CAPTURE_COUNT } from "./table-live-v11-contract.js";

test("Table live v11 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V11_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V11_CAPTURE_COUNT, 20);
