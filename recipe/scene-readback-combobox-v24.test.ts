...
import {
  ...
  COMBOBOX_LIVE_V24_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V24_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V24_LISTBOX_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V24_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V24_LISTBOX_CORNER_RADIUS_OMITTED_MARKER,
  COMBOBOX_LIVE_V24_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER,
  COMBOBOX_LIVE_V24_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V24_OPTION_INSTANCE_BINDING_EXTRAS_MARKER,
  COMBOBOX_LIVE_V24_OPTION_INSTANCE_FILLS_OMITTED_MARKER,
  COMBOBOX_LIVE_V24_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER,
  COMBOBOX_LIVE_V24_OVERLAY_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V24_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER,
  COMBOBOX_LIVE_V24_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER,
  COMBOBOX_LIVE_V24_RECOVER_COMPONENT_PROPERTY_NAME_MARKER,
  COMBOBOX_LIVE_V24_RECOVER_RECIPE_COMPONENT_REF_MARKER,
  COMBOBOX_LIVE_V24_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V24_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V24_TRIGGER_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V24_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER,
...
test("host omits combobox/listbox cornerRadius that compile never emits", () => {
  ...
  assert.deepEqual(
    ...
    [],
    "v24 must not also teach listbox empty strokes",
  );
...
test("host omits empty combobox/listbox effects that compile never emits", () => {
  ...
  assert.equal(
    observed.effects,
    undefined,
    "v24 host must omit empty listbox effects that compile never emits",
  );
  assert.equal(
    "cornerRadius" in observed,
    false,
    "v24 must keep the v23 listbox cornerRadius omit",
  );
  assert.equal(
    "clipsContent" in observed,
    false,
  ...
  assert.equal(
    trigger.effects,
    undefined,
    "v24 must keep the v15 trigger empty-effects omit",
  );
});
