...
import { TABLE_LIVE_V12_CAPTURE_COUNT } from "./table-live-v12-contract.js";

test("Table live v12 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V12_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V12_CAPTURE_COUNT, 20);
