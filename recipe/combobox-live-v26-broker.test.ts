...
import { COMBOBOX_LIVE_V26_CAPTURE_COUNT } from "./combobox-live-v26-contract.js";

test("Combobox live v26 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V26_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V26_CAPTURE_COUNT, 72);
