...
import { TABLE_LIVE_V34_CAPTURE_COUNT } from "./table-live-v34-contract.js";

test("Table live v34 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V34_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V34_CAPTURE_COUNT, 20);
