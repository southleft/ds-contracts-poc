...
import { COMBOBOX_LIVE_V20_CAPTURE_COUNT } from "./combobox-live-v20-contract.js";

test("Combobox live v20 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V20_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V20_CAPTURE_COUNT, 72);
