...
import { TABLE_LIVE_V37_CAPTURE_COUNT } from "./table-live-v37-contract.js";

test("Table live v37 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V37_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V37_CAPTURE_COUNT, 20);
