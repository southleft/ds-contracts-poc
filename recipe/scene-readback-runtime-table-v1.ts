...
/**
 * Table live v1 extract runtime. Keeps set-root envelopeHash omit and
 * ignore-copied-ownershipKey-inside-INSTANCE. Content FILL measure is
 * table/cell/label only when that text is FILL; table@1 labels hug.
 */
