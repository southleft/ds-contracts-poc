...
import { TABLE_LIVE_V13_CAPTURE_COUNT } from "./table-live-v13-contract.js";

test("Table live v13 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V13_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V13_CAPTURE_COUNT, 20);
