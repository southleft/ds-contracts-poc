...
import { COMBOBOX_LIVE_V16_CAPTURE_COUNT } from "./combobox-live-v16-contract.js";

test("Combobox live v16 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V16_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V16_CAPTURE_COUNT, 72);
