...
/**
 * Carried Combobox live v24 scene-readback. Keeps v1 host-normalize,
 ...
 * listbox clipsContent omit, and v23 listbox cornerRadius
 * omit. Teaches host to omit empty `effects` on
 * `combobox/listbox` that compile never emits, not also
 * emit the live listbox empty effects array. Reuses the
 * v15 trigger empty-effects omit path: strip empty
 * `effects` compile omits. Does not invent an effects
 * value. Does not omit overlay drop-shadow (compile
 * emits overlay effects). Does not also teach listbox
 * empty strokes. Does not invent a Combobox-only
 * `if (combobox)`. Does not patch hashed v1–v23
...
export const COMBOBOX_LIVE_V24_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V24_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V24_RECOVER_RECIPE_COMPONENT_REF_MARKER =
  "COMBOBOX-HOST-RECOVER-RECIPE-COMPONENT-REF";
export const COMBOBOX_LIVE_V24_RECOVER_COMPONENT_PROPERTY_NAME_MARKER =
  "COMBOBOX-HOST-RECOVER-COMPONENT-PROPERTY-NAME-BEFORE-HASH";
export const COMBOBOX_LIVE_V24_TRIGGER_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRIGGER-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V24_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LEADING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V24_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-LEADING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V24_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRAILING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V24_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-TRAILING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V24_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-TRIGGER-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V24_OVERLAY_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OVERLAY-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V24_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER =
  "COMBOBOX-OVERLAY-LAYOUT-WIDTH-ALIAS-FROM-WIDTH-VALUE";
export const COMBOBOX_LIVE_V24_LISTBOX_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LISTBOX-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V24_OPTION_INSTANCE_BINDING_EXTRAS_MARKER =
  "COMBOBOX-OPTION-INSTANCE-BINDING-EXTRAS-DROPPED";
export const COMBOBOX_LIVE_V24_OPTION_INSTANCE_FILLS_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-INHERITED-FILLS-OMITTED";
export const COMBOBOX_LIVE_V24_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-PAYLOAD-OMITTED";
export const COMBOBOX_LIVE_V24_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V24_LISTBOX_CORNER_RADIUS_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CORNER-RADIUS-OMITTED";
export const COMBOBOX_LIVE_V24_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER =
...
const surfaceVariantLayoutWidthBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V24_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER;
...
const compileCarriedLeadingSlotVisible = (
  ...
  void COMBOBOX_LIVE_V24_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V24_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V24_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderTrailingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V24_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderOverlayBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V24_OVERLAY_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderListboxBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V24_LISTBOX_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const dropExtraOptionInstanceBindings = (
  ...
  void COMBOBOX_LIVE_V24_OPTION_INSTANCE_BINDING_EXTRAS_MARKER;
  const role = sceneRole(scene);
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V24_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
export function canonicalizeObservedComponentPropertyName(key: string): string {
  void COMBOBOX_LIVE_V24_RECOVER_COMPONENT_PROPERTY_NAME_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V24_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const omitContentRowClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V24_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
...
const omitContentRowCornerRadius = <T extends { cornerRadius?: unknown }>(
  ...
  void COMBOBOX_LIVE_V24_LISTBOX_CORNER_RADIUS_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
    role !== "combobox/trailing-controls" &&
    role !== "combobox/label-row-absent" &&
...
const omitOptionInstanceFills = <T extends { fills?: unknown }>(
  ...
  void COMBOBOX_LIVE_V24_OPTION_INSTANCE_FILLS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const omitOptionInstancePayload = <T extends { payload?: unknown }>(
  ...
  void COMBOBOX_LIVE_V24_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (!isOptionInstanceRole(role)) return frame;
  if (scene.type !== "INSTANCE") return frame;
...
const omitSurfaceEffects = (
  ...
  void COMBOBOX_LIVE_V24_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER;
  void COMBOBOX_LIVE_V24_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER;
  const role = sceneRole(scene);
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V24_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
