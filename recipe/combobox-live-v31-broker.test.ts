...
import { COMBOBOX_LIVE_V31_CAPTURE_COUNT } from "./combobox-live-v31-contract.js";

test("Combobox live v31 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V31_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V31_CAPTURE_COUNT, 72);
