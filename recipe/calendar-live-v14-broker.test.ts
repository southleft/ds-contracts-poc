...
import { CALENDAR_LIVE_V14_CAPTURE_COUNT } from "./calendar-live-v14-contract.js";

test("Calendar live v14 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V14_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V14_CAPTURE_COUNT, 8);
