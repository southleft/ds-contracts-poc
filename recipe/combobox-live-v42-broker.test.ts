...
import { COMBOBOX_LIVE_V42_CAPTURE_COUNT } from "./combobox-live-v42-contract.js";

test("Combobox live v42 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V42_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V42_CAPTURE_COUNT, 72);
