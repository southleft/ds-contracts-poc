...
import { buildFigmaSceneReadbackRuntime } from "./scene-readback-runtime-v66.js";
import {
  INPUT_LIVE_V66_CONTENT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V66_CONTENT_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V66_CONTENT_HIDDEN_HEIGHT_HUG_MARKER,
  INPUT_LIVE_V66_CONTENT_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V66_CONTENT_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V66_CONTENT_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V66_CONTENT_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V66_CONTENT_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V66_LABEL_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V66_LABEL_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V66_LABEL_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V66_LABEL_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V66_LABEL_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V66_LABEL_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V66_LABEL_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V66_LABEL_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V66_LABEL_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V66_SURFACE_STROKE_DASH_PATTERN_OMITTED_MARKER,
  INPUT_LIVE_V66_MESSAGE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V66_MESSAGE_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V66_MESSAGE_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V66_MESSAGE_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V66_MESSAGE_CONTAINER_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V66_MESSAGE_CONTAINER_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V66_MESSAGE_CONTAINER_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V66_MESSAGE_CONTAINER_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V66_VARIANT_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V66_VARIANT_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V66_VARIANT_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V66_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V66_LEADING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V66_LEADING_SLOT_ROLES,
  INPUT_LIVE_V66_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V66_TRAILING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V66_TRAILING_SLOT_ROLES,
  INPUT_LIVE_V66_REQUIRED_INDICATOR_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V66_REQUIRED_INDICATOR_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V66_REQUIRED_INDICATOR_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V66_REQUIRED_INDICATOR_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V66_REQUIRED_INDICATOR_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V66_REQUIRED_INDICATOR_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V66_SET_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V66_SET_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V66_SET_FILLS_OMITTED_MARKER,
  INPUT_LIVE_V66_REQUIRED_INDICATOR_ROLES,
  INPUT_LIVE_V66_MESSAGE_ROLES,
  INPUT_LIVE_V66_LABEL_ROLES,
  INPUT_LIVE_V66_CONTENT_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V66_CONTENT_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V66_CONTENT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V66_CONTENT_ROLES,
  INPUT_LIVE_V66_SLOT_COLOR_BINDING_MARKER,
  INPUT_LIVE_V66_SLOT_FILL_MARKER,
  INPUT_LIVE_V66_SLOT_ROLES,
  INPUT_LIVE_V66_SURFACE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V66_SURFACE_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V66_SURFACE_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V66_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER,
  INPUT_LIVE_V66_SURFACE_LAYOUT_HEIGHT_MARKER,
  INPUT_LIVE_V66_SURFACE_STROKE_WEIGHT_MARKER,
  INPUT_LIVE_V66_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER,
  INPUT_LIVE_V66_VARIANT_LAYOUT_WIDTH_COMPILE_INDEX_MARKER,
  INPUT_LIVE_V66_VARIANT_LAYOUT_WIDTH_MARKER,
  SCENE_READBACK_V12_TAUGHT_FILL_KINDS,
  scenePaintToIr,
  sceneToNormalizedIr,
  type SceneNodeSnapshot,
} from "./scene-readback-v66.js";
...
test("v17 surfaces empty leading-slot fills from instancePayload", () => {
  ...
  assert.equal(INPUT_LIVE_V66_SLOT_FILL_MARKER, "INPUT-SLOT-FILL-FROM-PAYLOAD");
  assert.deepEqual([...INPUT_LIVE_V66_SLOT_ROLES], [
...
test("v26 drops duplicate mapped content color bindings", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V66_CONTENT_ROLES], [
...
test("v66 recovers hug height for hidden content text with FIXED vertical sizing", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fills.0.color",
...
test("v66 does not rewrite visible content FIXED height or invent a height variable", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/value", [
      {
        field: "fontSize.0",
...
test("v66 does not lift hidden FIXED height onto non-content text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v10 live host path does not import hashed scene-readback.ts", () => {
  const verifier = readFileSync(
    "recipe/input-field-live-v66-verifier.ts",
    "utf8",
  );
  const contract = readFileSync(
    "recipe/input-field-live-v66-contract.ts",
    "utf8",
  );
  const carried = readFileSync(
    "recipe/input-field-live-v3-verifier-v66.ts",
    "utf8",
  );
  assert.match(verifier, /input-field-live-v3-verifier-v66/);
  assert.doesNotMatch(verifier, /from "\.\/input-field-live-v3-verifier\.js"/);
  assert.doesNotMatch(verifier, /from "\.\/scene-readback\.js"/);
  assert.match(contract, /input-field-live-v3-verifier-v66/);
  assert.doesNotMatch(contract, /from "\.\/input-field-live-v3-verifier\.js"/);
  assert.doesNotMatch(contract, /from "\.\/scene-readback\.js"/);
  assert.match(carried, /from "\.\/scene-readback-v66\.js"/);
...
test("v66 omits content letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v66 does not omit letterSpacing on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
...
test("v66 omits content textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v66 does not omit textCase on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v66 omits content textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v66 does not omit textDecoration on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v66 omits content-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    clipsContent: true,
...
test("v66 omits label-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v66 omits message-container clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v66 does not omit clipsContent on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v66 omits message-container effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    effects: [],
...
test("v66 does not omit effects on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    effects: [],
...
test("v66 omits message-container strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    strokes: [],
...
test("v66 does not omit strokes on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    strokes: [],
...
test("v66 omits message-container cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    cornerRadius: {
...
test("v66 omits variant cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
...
test("v66 omits variant effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v66 omits variant strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v66 orders leading-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V66_LEADING_SLOT_ROLES], [
    "input-field/slot/leading",
  ]);
  assert.equal(
    INPUT_LIVE_V66_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v66 orders trailing-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V66_TRAILING_SLOT_ROLES], [
    "input-field/slot/trailing",
  ]);
  assert.equal(
    INPUT_LIVE_V66_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v66 drops required-indicator duplicate fills.0.color and orders remaining bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
    requiredIndicatorScene(requiredIndicatorHostBindings),
  );
  assert.equal(ir.role, "input-field/required-indicator");
  ...
  assert.deepEqual([...INPUT_LIVE_V66_REQUIRED_INDICATOR_ROLES], [
...
test("v66 omits required-indicator letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v66 omits required-indicator textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v66 omits required-indicator textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v66 omits set cornerRadius that compile never emits", () => {
...
test("v66 omits set effects that compile never emits", () => {
  const ir = sceneToNormalizedIr(setScene());
  assert.equal(ir.role, "input-field/set");
  assert.equal(ir.kind, "component-set");
  assert.equal(ir.effects, undefined);
...
test("v66 omits set fills that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    fills: [{ type: "SOLID", color: "#f7f7f8ff" }],
  });
...
test("v66 host-normalize emits set layout.mode horizontal from HORIZONTAL", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    layoutMode: "HORIZONTAL",
  });
...
test("v66 does not omit set layout.mode that compile emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    layoutMode: "HORIZONTAL",
  });
...
test("v66 does not omit set clipsContent that compile emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    clipsContent: false,
  });
...
test("v66 keeps variant clipsContent present and variant cornerRadius absent", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v66 does not omit cornerRadius on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    cornerRadius: {
...
test("v66 omits content-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    cornerRadius: {
...
test("v66 omits label-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    cornerRadius: {
...
test("v66 omits content-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    effects: [],
...
test("v66 omits label-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    effects: [],
...
test("v66 omits content-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    strokes: [],
...
test("v66 omits label-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    strokes: [],
...
test("v66 omits surface stroke dashPattern that compile never emits", () => {
...
test("v66 orders message/helper bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
  ...
  assert.deepEqual([...INPUT_LIVE_V66_MESSAGE_ROLES], [
    "input-field/message/helper",
    "input-field/message/error",
  ]);
});

test("v66 orders message/error bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
...
test("v66 omits message/helper letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v66 omits message/error letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v66 omits message/helper textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textCase: "ORIGINAL",
  });
...
test("v66 omits message/error textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textCase: "ORIGINAL",
  });
...
test("v66 omits message/helper textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textDecoration: "NONE",
  });
...
test("v66 omits message/error textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textDecoration: "NONE",
  });
...
test("v66 does not omit surface stroke dashPattern when the host value is not empty", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    dashPattern: [2, 2],
  });
...
test("v66 does not lift surface dashPattern omit onto a non-surface frame", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    name: "other :: Frame",
  });
...
test("v66 drops duplicate label bindings and orders remaining fields to compile", () => {
  const ir = sceneToNormalizedIr(
    labelScene([
      {
        field: "fills.0.color",
  ...
  assert.deepEqual([...INPUT_LIVE_V66_LABEL_ROLES], ["input-field/label"]);
});

test("v66 does not apply label binding teaching to surfaces", () => {
  const ir = sceneToNormalizedIr(
    surfaceScene([
      {
        field: "fills.0.color",
...
test("v66 omits label letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v66 omits label textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v66 omits label textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
