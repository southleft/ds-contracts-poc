...
import { COMBOBOX_LIVE_V25_CAPTURE_COUNT } from "./combobox-live-v25-contract.js";

test("Combobox live v25 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V25_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V25_CAPTURE_COUNT, 72);
