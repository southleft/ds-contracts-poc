...
import { TABLE_LIVE_V17_CAPTURE_COUNT } from "./table-live-v17-contract.js";

test("Table live v17 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V17_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V17_CAPTURE_COUNT, 20);
