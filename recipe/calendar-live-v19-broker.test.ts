...
import { CALENDAR_LIVE_V19_CAPTURE_COUNT } from "./calendar-live-v19-contract.js";

test("Calendar live v19 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V19_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V19_CAPTURE_COUNT, 8);
