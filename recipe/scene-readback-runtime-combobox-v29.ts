...
/**
 * Carried Combobox live v29 extract runtime. Keeps the v3 teaching that
 ...
 * compile-order binding sort, and option
 * `height.value` → `layout.height.value` alias live in
 * scene-readback-combobox-v29.
 * Does not restamp hashed v1–v28 lineage. Writer bytes
 * stay frozen.
 */
