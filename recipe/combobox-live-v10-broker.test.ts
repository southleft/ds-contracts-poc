...
import { COMBOBOX_LIVE_V10_CAPTURE_COUNT } from "./combobox-live-v10-contract.js";

test("Combobox live v10 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V10_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V10_CAPTURE_COUNT, 72);
