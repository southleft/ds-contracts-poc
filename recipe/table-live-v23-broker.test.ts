...
import { TABLE_LIVE_V23_CAPTURE_COUNT } from "./table-live-v23-contract.js";

test("Table live v23 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V23_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V23_CAPTURE_COUNT, 20);
