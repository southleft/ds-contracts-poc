...
/**
 * Carried Combobox live v18 extract runtime. Keeps the v3 teaching that
 ...
 * `width.value` → `layout.width.value` alias, and listbox
 * compile-order binding sort live in
 * scene-readback-combobox-v18. Does not restamp hashed v1–v17
