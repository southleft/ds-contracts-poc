...
import { sceneToNormalizedIr as sceneToNormalizedIrV79 } from "./scene-readback-v79.js";
import { sceneToNormalizedIr as sceneToNormalizedIrV80 } from "./scene-readback-v80.js";
import { sceneToNormalizedIr as sceneToNormalizedIrV81 } from "./scene-readback-v81.js";
import { sceneToNormalizedIr as sceneToNormalizedIrV82 } from "./scene-readback-v82.js";
...
import { sceneToNormalizedIr as sceneToNormalizedIrV66 } from "./scene-readback-v66.js";
import { sceneToNormalizedIr as sceneToNormalizedIrV67 } from "./scene-readback-v67.js";
import { sceneToNormalizedIr as sceneToNormalizedIrV68 } from "./scene-readback-v68.js";
import { buildFigmaSceneReadbackRuntime } from "./scene-readback-runtime-v84.js";
import {
  compareSceneToExpectedPlan as compareSceneToExpectedPlanV70,
  compileExpectedScenePlan as compileExpectedScenePlanV70,
  sceneToNormalizedIr as sceneToNormalizedIrV70,
} from "./scene-readback-v70.js";
import {
  compareSceneToExpectedPlan as compareSceneToExpectedPlanV71,
  compileExpectedScenePlan as compileExpectedScenePlanV71,
  sceneToNormalizedIr as sceneToNormalizedIrV71,
} from "./scene-readback-v71.js";
import {
  compareSceneToExpectedPlan as compareSceneToExpectedPlanV72,
  compileExpectedScenePlan as compileExpectedScenePlanV72,
  sceneToNormalizedIr as sceneToNormalizedIrV72,
} from "./scene-readback-v72.js";
import {
  INPUT_LIVE_V84_CONTENT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_CONTENT_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V84_CONTENT_HIDDEN_HEIGHT_HUG_MARKER,
  INPUT_LIVE_V84_CONTENT_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V84_CONTENT_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V84_CONTENT_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V84_CONTENT_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V84_CONTENT_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_LABEL_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V84_LABEL_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V84_SURFACE_STROKE_DASH_PATTERN_OMITTED_MARKER,
  INPUT_LIVE_V84_MESSAGE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_MESSAGE_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V84_MESSAGE_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V84_MESSAGE_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V84_MESSAGE_CONTAINER_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V84_MESSAGE_CONTAINER_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V84_MESSAGE_CONTAINER_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V84_MESSAGE_CONTAINER_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V84_VARIANT_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V84_VARIANT_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V84_VARIANT_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V84_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_LEADING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V84_LEADING_SLOT_ROLES,
  INPUT_LIVE_V84_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_TRAILING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V84_TRAILING_SLOT_ROLES,
  INPUT_LIVE_V84_REQUIRED_INDICATOR_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V84_REQUIRED_INDICATOR_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_REQUIRED_INDICATOR_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V84_REQUIRED_INDICATOR_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V84_REQUIRED_INDICATOR_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V84_REQUIRED_INDICATOR_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V84_SET_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V84_SET_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V84_SET_FILLS_OMITTED_MARKER,
  INPUT_LIVE_V84_SET_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V84_LABEL_ROW_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_LABEL_ROW_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V84_LABEL_ROW_ROLES,
  INPUT_LIVE_V84_REQUIRED_INDICATOR_ROLES,
  INPUT_LIVE_V84_MESSAGE_ROLES,
  INPUT_LIVE_V84_LABEL_ROLES,
  INPUT_LIVE_V84_CONTENT_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V84_CONTENT_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V84_CONTENT_OPACITY_OMITTED_MARKER,
  INPUT_LIVE_V84_COMPILE_CARRY_LIVE_VISIBLE_MARKER,
  INPUT_LIVE_V84_COMPILE_CARRY_LIVE_OPACITY_MARKER,
  INPUT_LIVE_V84_CONTENT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V84_CONTENT_ROLES,
  INPUT_LIVE_V84_SLOT_COLOR_BINDING_MARKER,
  INPUT_LIVE_V84_SLOT_FILL_MARKER,
  INPUT_LIVE_V84_SLOT_ROLES,
  INPUT_LIVE_V84_SURFACE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_SURFACE_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V84_FONT_PROVENANCE_NAME_ORDER_MARKER,
  INPUT_LIVE_V84_INSTANCE_PAYLOAD_FILL_KIND_MARKER,
  INPUT_LIVE_V84_UNNAMED_SOURCE_PX_CARRIED_MARKER,
  INPUT_LIVE_V84_VARIANT_AXIS_SIZE_ORDER_MARKER,
  canonicalizeObservedVariantAxisSizeOrder,
  INPUT_LIVE_V84_SURFACE_BINDING_ITEM_SPACING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V84_SURFACE_COMPILE_BINDING_FIELDS,
  canonicalizeObservedFontProvenanceName,
  canonicalizeObservedInstancePayloadFillKind,
  compareSceneToExpectedPlan,
  contentTextOwnershipKeysWithoutCompileOpacity,
  requiredEqualsFactValue,
  compileExpectedScenePlan,
  INPUT_LIVE_V84_COLLAPSE_OMIT_INVENTED_CONTENT_TEXT_OPACITY_MARKER,
  INPUT_LIVE_V84_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER,
  INPUT_LIVE_V84_SURFACE_LAYOUT_HEIGHT_MARKER,
  INPUT_LIVE_V84_SURFACE_STROKE_WEIGHT_MARKER,
  INPUT_LIVE_V84_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER,
  INPUT_LIVE_V84_VARIANT_LAYOUT_WIDTH_COMPILE_INDEX_MARKER,
  INPUT_LIVE_V84_VARIANT_LAYOUT_WIDTH_MARKER,
  SCENE_READBACK_V12_TAUGHT_FILL_KINDS,
  scenePaintToIr,
  sceneToNormalizedIr,
  type SceneNodeSnapshot,
} from "./scene-readback-v84.js";
...
test("v17 surfaces empty leading-slot fills from instancePayload", () => {
  ...
  assert.equal(INPUT_LIVE_V84_SLOT_FILL_MARKER, "INPUT-SLOT-FILL-FROM-PAYLOAD");
  assert.deepEqual([...INPUT_LIVE_V84_SLOT_ROLES], [
...
test("v25 places remaining surface bindings at compile field order", () => {
  ...
  assert.deepEqual(
    (ir.bindings ?? []).map((binding) => binding.field),
    [...INPUT_LIVE_V84_SURFACE_COMPILE_BINDING_FIELDS.slice(1)],
  );
  assert.equal(
    INPUT_LIVE_V84_SURFACE_BINDING_COMPILE_ORDER_MARKER,
...
test("v26 drops duplicate mapped content color bindings", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V84_CONTENT_ROLES], [
...
test("v84 recovers hug height for hidden content text with FIXED vertical sizing", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fills.0.color",
...
test("v84 does not rewrite visible content FIXED height or invent a height variable", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/value", [
      {
        field: "fontSize.0",
...
test("v84 does not lift hidden FIXED height onto non-content text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v10 live host path does not import hashed scene-readback.ts", () => {
  const verifier = readFileSync(
    "recipe/input-field-live-v84-verifier.ts",
    "utf8",
  );
  const contract = readFileSync(
    "recipe/input-field-live-v84-contract.ts",
    "utf8",
  );
  const carried = readFileSync(
    "recipe/input-field-live-v3-verifier-v84.ts",
    "utf8",
  );
  assert.match(verifier, /input-field-live-v3-verifier-v84/);
  assert.doesNotMatch(verifier, /from "\.\/input-field-live-v3-verifier\.js"/);
  assert.doesNotMatch(verifier, /from "\.\/scene-readback\.js"/);
  assert.match(contract, /input-field-live-v3-verifier-v84/);
  assert.doesNotMatch(contract, /from "\.\/input-field-live-v3-verifier\.js"/);
  assert.doesNotMatch(contract, /from "\.\/scene-readback\.js"/);
  assert.match(carried, /from "\.\/scene-readback-v84\.js"/);
...
test("v84 omits content letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v84 does not omit letterSpacing on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
...
test("v84 omits content textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v84 does not omit textCase on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v84 collapse cycle omits invented default-1 content TEXT opacity", () => {
  const scene: SceneNodeSnapshot = {
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
  ...
  const compiledIr = sceneToNormalizedIr(scene);
  assert.equal(compiledIr.kind, "text");
  assert.equal(compiledIr.opacity, undefined);
  assert.equal("opacity" in compiledIr, false);
  const invented = compileExpectedScenePlan(compiledIr);
  const inventedOpacity = invented.facts.filter(
    (fact) => fact.channel === "opacity",
  );
  assert.equal(inventedOpacity.length, 1);
  assert.equal(inventedOpacity[0]?.value, 1);
  const naive = compareSceneToExpectedPlan(invented, scene);
  assert.equal(naive.ok, false);
  assert.equal(
    naive.mismatched.filter((pair) => pair.expected.channel === "opacity")
      .length,
    1,
  );
  const omitKeys = contentTextOwnershipKeysWithoutCompileOpacity(compiledIr);
  assert.deepEqual([...omitKeys], ["root"]);
  const cycle = compareSceneToExpectedPlan(invented, scene, {
    omitOpacityOwnershipKeys: omitKeys,
  });
  assert.equal(cycle.ok, true);
  assert.equal(cycle.silent, 0);
  assert.equal(cycle.mismatched.length, 0);
  assert.equal(
    cycle.extra.filter((fact) => fact.channel === "opacity").length,
    0,
  );
  assert.equal(
    INPUT_LIVE_V84_COLLAPSE_OMIT_INVENTED_CONTENT_TEXT_OPACITY_MARKER,
    "INPUT-COLLAPSE-OMIT-INVENTED-CONTENT-TEXT-OPACITY",
  );
});

test("v84 omits content opacity that compile never emits", () => {
  const placeholder = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
        variableName: "imported.text-field.medium.input-font-size",
  ...
  assert.equal(placeholder.opacity, undefined);
  const value = sceneToNormalizedIr({
    ...contentScene("input-field/content/value", [
      {
        field: "fontSize.0",
        variableName: "imported.text-field.medium.input-font-size",
  ...
  assert.equal(value.opacity, undefined);
  assert.equal(
    INPUT_LIVE_V84_CONTENT_OPACITY_OMITTED_MARKER,
    "INPUT-CONTENT-OPACITY-OMITTED",
  );
  assert.equal(
    INPUT_LIVE_V84_COMPILE_CARRY_LIVE_VISIBLE_MARKER,
    "INPUT-COMPILE-CARRY-LIVE-VISIBLE",
  );
  assert.equal(
    INPUT_LIVE_V84_COMPILE_CARRY_LIVE_OPACITY_MARKER,
    "INPUT-COMPILE-CARRY-LIVE-OPACITY",
  );
});

test("v84 host omits visible when extract is true and does not invent false", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
  ...
  assert.equal(ir.visible, undefined);
  assert.notEqual(ir.visible, false);
  assert.equal("visible" in ir, false);
});

test("v84 does not omit opacity on label text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
  ...
  assert.equal(ir.opacity, 0);
});

test("hashed v82 still omits content opacity that compile never emits", () => {
  const ir = sceneToNormalizedIrV82({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
        variableName: "imported.text-field.medium.input-font-size",
  ...
  assert.equal(ir.opacity, undefined);
});

test("hashed v83 scene-readback bytes stay frozen", () => {
  const bytes = readFileSync("recipe/scene-readback-v83.ts");
  assert.equal(sha256(bytes), "5b6e192f058d8883a01835e60d1b17064c9b41eaed6a94b3d9225e52229d99ef");
});

test("hashed v82 scene-readback bytes stay frozen", () => {
  const bytes = readFileSync("recipe/scene-readback-v82.ts");
  assert.equal(
    sha256(bytes),
    "cdff8862ff8efec3f858ec33d50b818eda4f40095d113b40f42ca6fa2c958fa8",
  );
});

test("hashed v81 still omits content opacity that compile never emits", () => {
  const ir = sceneToNormalizedIrV81({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
        variableName: "imported.text-field.medium.input-font-size",
...
test("hashed v80 host already omits visible when extract is true", () => {
  const ir = sceneToNormalizedIrV80({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
        variableName: "imported.text-field.medium.input-font-size",
...
test("hashed v79 scene-readback still emits content opacity", () => {
  const ir = sceneToNormalizedIrV79({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
        variableName: "imported.text-field.medium.input-font-size",
...
test("v84 omits content textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v84 does not omit textDecoration on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v84 omits content-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    clipsContent: true,
...
test("v84 omits label-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v84 omits message-container clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v84 does not omit clipsContent on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v84 omits message-container effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    effects: [],
...
test("v84 does not omit effects on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    effects: [],
...
test("v84 omits message-container strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    strokes: [],
...
test("v84 does not omit strokes on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    strokes: [],
...
test("v84 omits message-container cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    cornerRadius: {
...
test("v84 omits variant cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
...
test("v84 omits variant effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v84 omits variant strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v84 orders leading-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V84_LEADING_SLOT_ROLES], [
    "input-field/slot/leading",
  ]);
  assert.equal(
    INPUT_LIVE_V84_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v84 orders trailing-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V84_TRAILING_SLOT_ROLES], [
    "input-field/slot/trailing",
  ]);
  assert.equal(
    INPUT_LIVE_V84_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v84 drops required-indicator duplicate fills.0.color and orders remaining bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
    requiredIndicatorScene(requiredIndicatorHostBindings),
  );
  assert.equal(ir.role, "input-field/required-indicator");
  ...
  assert.deepEqual([...INPUT_LIVE_V84_REQUIRED_INDICATOR_ROLES], [
...
test("v84 omits required-indicator letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v84 omits required-indicator textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v84 omits required-indicator textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v84 omits set cornerRadius that compile never emits", () => {
...
test("v84 omits set effects that compile never emits", () => {
  const ir = sceneToNormalizedIr(setScene());
  assert.equal(ir.role, "input-field/set");
  assert.equal(ir.kind, "component-set");
  assert.equal(ir.effects, undefined);
...
test("v84 omits set fills that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    fills: [{ type: "SOLID", color: "#f7f7f8ff" }],
  });
...
test("v84 host-normalize emits set layout.mode horizontal from HORIZONTAL", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    layoutMode: "HORIZONTAL",
  });
...
test("v84 does not omit set layout.mode that compile emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    layoutMode: "HORIZONTAL",
  });
...
test("v84 does not omit set clipsContent that compile emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    clipsContent: false,
  });
...
test("v84 keeps variant clipsContent present and variant cornerRadius absent", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v84 does not omit cornerRadius on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    cornerRadius: {
...
test("v84 omits content-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    cornerRadius: {
...
test("v84 omits label-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    cornerRadius: {
...
test("v84 omits content-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    effects: [],
...
test("v84 omits label-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    effects: [],
...
test("v84 omits content-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    strokes: [],
...
test("v84 omits label-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    strokes: [],
...
test("v84 omits surface stroke dashPattern that compile never emits", () => {
...
test("v84 orders message/helper bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
  ...
  assert.deepEqual([...INPUT_LIVE_V84_MESSAGE_ROLES], [
    "input-field/message/helper",
    "input-field/message/error",
  ]);
});

test("v84 orders message/error bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
...
test("v84 omits message/helper letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v84 omits message/error letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v84 omits message/helper textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textCase: "ORIGINAL",
  });
...
test("v84 omits message/error textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textCase: "ORIGINAL",
  });
...
test("v84 omits message/helper textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textDecoration: "NONE",
  });
...
test("v84 omits message/error textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textDecoration: "NONE",
  });
...
test("v84 does not omit surface stroke dashPattern when the host value is not empty", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    dashPattern: [2, 2],
  });
...
test("v84 does not lift surface dashPattern omit onto a non-surface frame", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    name: "other :: Frame",
  });
...
test("v84 drops duplicate label bindings and orders remaining fields to compile", () => {
  const ir = sceneToNormalizedIr(
    labelScene([
      {
        field: "fills.0.color",
  ...
  assert.deepEqual([...INPUT_LIVE_V84_LABEL_ROLES], ["input-field/label"]);
});

test("v84 does not apply label binding teaching to surfaces", () => {
  const ir = sceneToNormalizedIr(
    surfaceScene([
      {
        field: "fills.0.color",
...
test("v84 omits label letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v84 omits label textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v84 omits label textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("hashed v65 scene-readback bytes stay frozen", () => {
  const bytes = readFileSync("recipe/scene-readback-v65.ts");
  assert.equal(
    sha256(bytes),
    "f6e1e83f01816e34d3272747ee8b4e71a7572f359db8be5fe5bd49cd786dd992",
  );
  assert.equal(bytes.byteLength, 71361);
});

test("hashed v66 scene-readback still emits set strokes []", () => {
  const ir = sceneToNormalizedIrV66(setScene());
  assert.equal(ir.role, "input-field/set");
  assert.deepEqual(ir.strokes, []);
});

test("v84 omits set strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr(setScene());
  assert.equal(ir.role, "input-field/set");
  assert.equal(ir.kind, "component-set");
  assert.equal(ir.strokes, undefined);
  ...
  assert.equal(
    INPUT_LIVE_V84_SET_STROKES_OMITTED_MARKER,
    "INPUT-SET-STROKES-OMITTED",
  );
});

test("hashed v66 scene-readback bytes stay frozen", () => {
  const bytes = readFileSync("recipe/scene-readback-v66.ts");
  assert.equal(
    sha256(bytes),
    "e92b695564a56ede1e2c5dc6214229e1dcf26ae8024cfcfc1a68634f7c5c53e9",
  );
  assert.equal(bytes.byteLength, 71415);
});

const polarLabelRowHostBindingScene = (): SceneNodeSnapshot => ({
  ownershipKey: "label-row",
  type: "FRAME",
  name: "input-field/label-row :: Row",
  width: 200,
  height: 24,
  ...
  boundVariables: [
    {
      ...
      variableName: "imported.text-field.medium.label-gap",
      resolvedType: "FLOAT",
    },
    {
      field: "layout.padding.left",
      variableName: "imported.text-field.medium.label-inset-x",
      resolvedType: "FLOAT",
    },
    {
      field: "layout.padding.top",
      variableName: "imported.text-field.medium.label-floating-offset-y",
      resolvedType: "FLOAT",
    },
  ],
  children: [],
...
test("hashed v67 scene-readback still emits label-row padding.left before padding.top", () => {
  const ir = sceneToNormalizedIrV67(polarLabelRowHostBindingScene());
  assert.equal(ir.role, "input-field/label-row");
  assert.deepEqual(
    (ir.bindings ?? []).map((binding) => binding.field),
    ["layout.itemSpacing", "layout.padding.left", "layout.padding.top"],
  );
});

test("v84 orders label-row bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(polarLabelRowHostBindingScene());
  assert.equal(ir.role, "input-field/label-row");
  assert.deepEqual(
    (ir.bindings ?? []).map((binding) => binding.field),
    [...INPUT_LIVE_V84_LABEL_ROW_COMPILE_BINDING_FIELDS],
  ...
  assert.deepEqual(
    [...INPUT_LIVE_V84_LABEL_ROW_COMPILE_BINDING_FIELDS],
    ["layout.itemSpacing", "layout.padding.top", "layout.padding.left"],
  );
  assert.deepEqual([...INPUT_LIVE_V84_LABEL_ROW_ROLES], [
    "input-field/label-row",
  ]);
  assert.equal(
    INPUT_LIVE_V84_LABEL_ROW_BINDING_COMPILE_ORDER_MARKER,
    "INPUT-LABEL-ROW-BINDING-COMPILE-ORDER",
  );
});

test("hashed v67 scene-readback bytes stay frozen", () => {
  const v67Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v67/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v67Index.artifacts["recipe/scene-readback-v67.ts"];
  assert.ok(pinned, "v67 index missing recipe/scene-readback-v67.ts");
  const bytes = readFileSync("recipe/scene-readback-v67.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "9fd064de300cde69f651bda474be0c4cab42e4fb71740703b72e954c8584a7b7",
  );
  assert.equal(bytes.byteLength, 71943);
});

test("v84 MUI surface still emits 12 compile-order bindings", () => {
  const leftover = [
    "cornerRadius.bottomLeft",
    "cornerRadius.bottomRight",
    "fills.0.color",
  ...
  const ir = sceneToNormalizedIr(
    surfaceScene(
      leftover.map((field) => ({
        field,
        variableName: `imported.surface.${field}`,
        resolvedType: field.includes("color")
          ? ("COLOR" as const)
          : ("FLOAT" as const),
      })),
    ),
  ...
  assert.equal(INPUT_LIVE_V84_SURFACE_COMPILE_BINDING_FIELDS.length, 13);
  assert.equal(
    INPUT_LIVE_V84_SURFACE_COMPILE_BINDING_FIELDS[0],
    "layout.itemSpacing",
  );
});

const polarSurfaceHostBindingScene = (): SceneNodeSnapshot =>
  surfaceScene([
    {
      field: "layout.padding.right",
      variableName: "imported.text-field.medium.surface-inset-x",
      resolvedType: "FLOAT",
    },
    {
      field: "layout.padding.left",
    ...
    {
      field: "layout.height.value",
      variableName: "imported.text-field.medium.surface-height",
      resolvedType: "FLOAT",
    },
    {
      field: "layout.minWidth",
      variableName: "imported.text-field.medium.surface-min-width",
      resolvedType: "FLOAT",
    },
    {
      field: "layout.minHeight",
      variableName: "imported.text-field.medium.surface-min-height",
      resolvedType: "FLOAT",
    },
    {
      field: "fills.0.color",
      variableName: "imported.text-field.default.surface",
      resolvedType: "COLOR",
    },
    {
      field: "strokes.0.weight",
      variableName: "imported.text-field.medium.surface-stroke-weight",
      resolvedType: "FLOAT",
    },
    {
      field: "strokes.0.paint.color",
      variableName: "imported.text-field.default.surface-stroke",
      resolvedType: "COLOR",
    },
    {
      field: "cornerRadius.topLeft",
      variableName: "imported.text-field.medium.surface-radius",
      resolvedType: "FLOAT",
    },
    {
      field: "cornerRadius.topRight",
      variableName: "imported.text-field.medium.surface-radius",
      resolvedType: "FLOAT",
    },
    {
      field: "cornerRadius.bottomRight",
      variableName: "imported.text-field.medium.surface-radius",
      resolvedType: "FLOAT",
    },
    {
      field: "cornerRadius.bottomLeft",
      variableName: "imported.text-field.medium.surface-radius",
      resolvedType: "FLOAT",
    },
    {
      field: "layout.itemSpacing",
      variableName: "imported.text-field.medium.surface-gap",
      resolvedType: "FLOAT",
    },
  ]);

test("hashed v68 scene-readback still emits Polar surface itemSpacing last", () => {
  const ir = sceneToNormalizedIrV68(polarSurfaceHostBindingScene());
  assert.equal(ir.role, "input-field/surface");
  assert.deepEqual(
    (ir.bindings ?? []).map((binding) => binding.field),
    [
...
test("v84 orders Polar surface bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(polarSurfaceHostBindingScene());
  assert.equal(ir.role, "input-field/surface");
  assert.deepEqual(
    (ir.bindings ?? []).map((binding) => binding.field),
    [...INPUT_LIVE_V84_SURFACE_COMPILE_BINDING_FIELDS],
...
test("hashed v68 scene-readback bytes stay frozen", () => {
  const v68Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v68/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v68Index.artifacts["recipe/scene-readback-v68.ts"];
  assert.ok(pinned, "v68 index missing recipe/scene-readback-v68.ts");
  const bytes = readFileSync("recipe/scene-readback-v68.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "a7b07c07bdcd76de3425b20eb18edb3daeefa99eb31409e1e4fb41faa4979c8d",
  );
  assert.equal(bytes.byteLength, 72989);
});

test("hashed v69 scene-readback bytes stay frozen", () => {
  const v69Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v69/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v69Index.artifacts["recipe/scene-readback-v69.ts"];
  assert.ok(pinned, "v69 index missing recipe/scene-readback-v69.ts");
  const bytes = readFileSync("recipe/scene-readback-v69.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "1f3a98e56295bd56b6b0d5589168be7bcc10c3535e02d87e278796ba0d503be3",
  );
  assert.equal(bytes.byteLength, 73251);
});

const FONT_PROVENANCE_REQUESTED = {
  requestedFamily: "Roboto",
  requestedStyle: "Regular",
  requestSource: "adapter",
  fallbackChain: [{ family: "Roboto", style: "Regular" }],
  resolvedFamily: "Roboto",
  resolvedStyle: "Regular",
  resolution: "requested" as const,
};

const fontProvenanceName = (
  role: string,
  provenance: typeof FONT_PROVENANCE_REQUESTED,
): string =>
  `${role} :: font-provenance=${encodeURIComponent(JSON.stringify(provenance))}`;

const fontProvenanceTextScene = (
  name: string,
  provenance: typeof FONT_PROVENANCE_REQUESTED,
): SceneNodeSnapshot => ({
  ownershipKey: "root",
  ...
  opacity: 1,
  characters: "Email",
  fontName: { family: provenance.resolvedFamily, style: provenance.resolvedStyle },
  fontProvenance: provenance,
  fontSize: 12,
  lineHeight: { unit: "PIXELS", value: 16 },
  boundVariables: [],
  children: [],
...
test("v84 canonicalizes observed font-provenance name key order to compile fallbackChain-first", () => {
  const hostName = fontProvenanceName(
    "input-field/label",
    FONT_PROVENANCE_REQUESTED,
  );
  assert.match(hostName, /requestedFamily/);
  assert.equal(
    canonicalizeObservedFontProvenanceName(hostName).indexOf(
      encodeURIComponent('"fallbackChain"'),
    ) <
      canonicalizeObservedFontProvenanceName(hostName).indexOf(
        encodeURIComponent('"requestedFamily"'),
      ),
    true,
  );
  assert.equal(
    INPUT_LIVE_V84_FONT_PROVENANCE_NAME_ORDER_MARKER,
    "INPUT-FONT-PROVENANCE-NAME-KEY-ORDER-COMPILE",
  );
  const scene = fontProvenanceTextScene(hostName, FONT_PROVENANCE_REQUESTED);
  const expected = compileExpectedScenePlan(sceneToNormalizedIr(scene));
  const nameFact = expected.facts.find((fact) => fact.channel === "name");
  assert.ok(nameFact);
  assert.match(String(nameFact.value), /fallbackChain/);
  const comparison = compareSceneToExpectedPlan(expected, scene);
  const nameMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "name",
  );
  assert.equal(nameMismatches.length, 0);
  assert.equal(
    comparison.failures.some((failure) => failure.includes("#name@")),
    false,
  );
});

test("v84 does not invent font-provenance keys or hide value drift", () => {
  const expectedScene = fontProvenanceTextScene(
    fontProvenanceName("input-field/label", FONT_PROVENANCE_REQUESTED),
    FONT_PROVENANCE_REQUESTED,
  );
  const drifted = {
    ...FONT_PROVENANCE_REQUESTED,
    ...
    fallbackChain: [{ family: "Inter", style: "Regular" }],
  };
  const observedScene = fontProvenanceTextScene(
    fontProvenanceName("input-field/label", drifted),
    drifted,
  );
  const expected = compileExpectedScenePlan(sceneToNormalizedIr(expectedScene));
  const comparison = compareSceneToExpectedPlan(expected, observedScene);
  const nameMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "name",
  );
  assert.equal(nameMismatches.length, 1);
  assert.notEqual(
    canonicalizeObservedFontProvenanceName("input-field/label"),
    "changed",
  );
  assert.equal(
    canonicalizeObservedFontProvenanceName("input-field/label"),
...
test("hashed v70 scene-readback bytes stay frozen", () => {
  const v70Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v70/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v70Index.artifacts["recipe/scene-readback-v70.ts"];
  assert.ok(pinned, "v70 index missing recipe/scene-readback-v70.ts");
  const bytes = readFileSync("recipe/scene-readback-v70.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "f775aaefc3f03c765882afff9fb85eecf6b836c2365d61ca6967f900015e7141",
  );
  assert.equal(bytes.byteLength, 74005);
  assert.match(bytes.toString("utf8"), /Does not teach instancePayload/);
  assert.doesNotMatch(
    bytes.toString("utf8"),
    /INPUT-INSTANCE-PAYLOAD-FILL-KIND-COMPILE/,
  );
});

const rootInstanceScene = (
  fills: NonNullable<SceneNodeSnapshot["instancePayload"]>["fills"],
  width = 8,
): SceneNodeSnapshot => {
  const base = instanceScene(fills);
  return {
    ...base,
    ownershipKey: "root",
    instancePayload: {
      ...base.instancePayload!,
      fills,
...
test("v84 aliases instancePayload fill type SOLID to compile kind solid without rewriting width", () => {
  assert.equal(
    INPUT_LIVE_V84_INSTANCE_PAYLOAD_FILL_KIND_MARKER,
    "INPUT-INSTANCE-PAYLOAD-FILL-KIND-COMPILE",
  );
  const compileFill = { kind: "solid" as const, color: "#00000099" };
  const hostFill = { type: "SOLID" as const, color: "#00000099" };
  const expectedScene = rootInstanceScene([compileFill]);
  const observedScene = rootInstanceScene([hostFill]);
  const aliased = canonicalizeObservedInstancePayloadFillKind(
    observedScene.instancePayload,
  ) as { fills: Array<{ kind?: string; type?: string }>; intrinsicSize: { width: number } };
  assert.deepEqual(aliased.fills[0], { kind: "solid", color: "#00000099" });
  assert.equal(aliased.intrinsicSize.width, 8);
  assert.equal("type" in (aliased.fills[0] ?? {}), false);
  const expected = compileExpectedScenePlan(sceneToNormalizedIr(expectedScene));
  const comparison = compareSceneToExpectedPlan(expected, observedScene);
  const payloadMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "instancePayload",
  );
  assert.equal(payloadMismatches.length, 0);
});

test("v84 does not require unnamed intrinsicSize.width equals and does not invent compile pixels", () => {
  assert.equal(
    INPUT_LIVE_V84_UNNAMED_SOURCE_PX_CARRIED_MARKER,
    "INPUT-UNNAMED-SOURCE-PX-CARRIED-NOT-REQUIRED-EQUALS",
  );
  const compileFill = { kind: "solid" as const, color: "#616161ff" };
  const hostFill = { type: "SOLID" as const, color: "#616161ff" };
  const expectedScene = rootInstanceScene([compileFill], 8);
  const observedScene = rootInstanceScene([hostFill], 9);
  const projected = requiredEqualsFactValue(
    "instancePayload",
    observedScene.instancePayload,
  ) as { intrinsicSize: { width?: number; height: number } };
  assert.equal("width" in projected.intrinsicSize, false);
  assert.equal(projected.intrinsicSize.height, 20);
  assert.equal(observedScene.instancePayload?.intrinsicSize?.width, 9);
  const expected = compileExpectedScenePlan(sceneToNormalizedIr(expectedScene));
  const comparison = compareSceneToExpectedPlan(expected, observedScene);
  const payloadMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "instancePayload",
  ...
  assert.equal(payloadMismatches.length, 0);
  const payloadFact = expected.facts.find(
    (fact) => fact.channel === "instancePayload",
  );
  assert.equal(
    (payloadFact?.value as { intrinsicSize: { width: number } }).intrinsicSize
      .width,
    8,
  );
});

test("hashed v70 still emits type SOLID instancePayload fills", () => {
  const runtime = readFileSync("recipe/scene-readback-runtime-v70.ts", "utf8");
  assert.match(runtime, /type:"SOLID"/);
  const compileFill = { kind: "solid" as const, color: "#00000099" };
  const hostFill = { type: "SOLID" as const, color: "#00000099" };
  const expectedScene = rootInstanceScene([compileFill]);
  const observedScene = rootInstanceScene([hostFill]);
  const expected = compileExpectedScenePlanV70(
    sceneToNormalizedIrV70(expectedScene),
  );
  const comparison = compareSceneToExpectedPlanV70(expected, observedScene);
  const payloadMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "instancePayload",
  );
  assert.equal(payloadMismatches.length, 1);
  const observedFills = (
    payloadMismatches[0]!.observed.value as {
      fills: Array<{ type?: string; kind?: string }>;
    }
  ).fills;
  assert.equal(observedFills[0]?.type, "SOLID");
  assert.equal(observedFills[0]?.kind, undefined);
});

test("hashed v71 scene-readback bytes stay frozen", () => {
  const v71Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v71/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v71Index.artifacts["recipe/scene-readback-v71.ts"];
  assert.ok(pinned, "v71 index missing recipe/scene-readback-v71.ts");
  const bytes = readFileSync("recipe/scene-readback-v71.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "5443512b681c3abfd5f4e55579001cedb30949bc3de36b93533362fc966d388c",
  );
  assert.equal(bytes.byteLength, 74974);
  assert.match(bytes.toString("utf8"), /Does not teach Size axis order/);
  assert.doesNotMatch(
    bytes.toString("utf8"),
    /INPUT-VARIANT-AXIS-SIZE-ORDER-COMPILE/,
  );
});

const withIrOwnership = (
  scene: SceneNodeSnapshot,
  key = "root",
): SceneNodeSnapshot => ({
  ...scene,
  ownershipKey: key,
  children: (scene.children ?? []).map((child, index) =>
    withIrOwnership(child, `${key}/children/${index}`),
  ),
});

test("v84 canonicalizes Size axis order to compile small,medium and carries unnamed width", () => {
  assert.equal(
    INPUT_LIVE_V84_VARIANT_AXIS_SIZE_ORDER_MARKER,
    "INPUT-VARIANT-AXIS-SIZE-ORDER-COMPILE",
  );
  const aliased = canonicalizeObservedVariantAxisSizeOrder({
    name: "Size",
    values: ["medium", "small"],
  });
  assert.deepEqual(aliased, { name: "Size", values: ["small", "medium"] });
  const expectedScene = withIrOwnership({
    ...setScene(),
    variantGroupProperties: { Size: { values: ["small", "medium"] } },
  });
  const observedScene = withIrOwnership(setScene());
  const expected = compileExpectedScenePlan(sceneToNormalizedIr(expectedScene));
  const comparison = compareSceneToExpectedPlan(expected, observedScene);
  const axisMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "variantAxis",
  );
  assert.equal(axisMismatches.length, 0);
  const compileFill = { kind: "solid" as const, color: "#616161ff" };
  const hostFill = { type: "SOLID" as const, color: "#616161ff" };
  const widthExpected = rootInstanceScene([compileFill], 8);
  const widthObserved = rootInstanceScene([hostFill], 9);
  const widthComparison = compareSceneToExpectedPlan(
    compileExpectedScenePlan(sceneToNormalizedIr(widthExpected)),
    widthObserved,
  );
  const payloadMismatches = widthComparison.mismatched.filter(
    (pair) => pair.expected.channel === "instancePayload",
  );
  assert.equal(payloadMismatches.length, 0);
  assert.equal(widthObserved.instancePayload?.intrinsicSize?.width, 9);
});

test("hashed v71 still mismatches Size axis order", () => {
  const expectedScene = withIrOwnership({
    ...setScene(),
    variantGroupProperties: { Size: { values: ["small", "medium"] } },
  });
  const observedScene = withIrOwnership(setScene());
  const expected = compileExpectedScenePlanV71(
    sceneToNormalizedIrV71(expectedScene),
  );
  const comparison = compareSceneToExpectedPlanV71(expected, observedScene);
  const axisMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "variantAxis",
  );
  assert.equal(axisMismatches.length, 1);
  assert.deepEqual(axisMismatches[0]!.expected.value, {
    name: "Size",
    values: ["small", "medium"],
  });
  assert.deepEqual(axisMismatches[0]!.observed.value, {
    name: "Size",
    values: ["medium", "small"],
  });
});

const focusRingScene = (
  spread: number,
  color = "#005bd3ff",
): SceneNodeSnapshot => ({
  ...surfaceScene([]),
...
test("v84 does not require unnamed effect spread equals and still scores ring color", () => {
  const projected = requiredEqualsFactValue("effect", {
    kind: "drop-shadow",
    offsetX: 0,
    offsetY: 0,
    blur: 0,
    spread: 1,
    color: "#005bd3ff",
  }) as { spread?: number; color: string };
  assert.equal("spread" in projected, false);
  assert.equal(projected.color, "#005bd3ff");
  const expected = compileExpectedScenePlan(
    sceneToNormalizedIr(focusRingScene(1)),
  );
  const sameColor = compareSceneToExpectedPlan(expected, focusRingScene(0));
  const spreadMismatches = sameColor.mismatched.filter(
    (pair) => pair.expected.channel === "effect",
  );
  assert.equal(spreadMismatches.length, 0);
  const colorDrift = compareSceneToExpectedPlan(
    expected,
    focusRingScene(0, "#000000ff"),
  );
  const colorMismatches = colorDrift.mismatched.filter(
    (pair) => pair.expected.channel === "effect",
  );
  assert.equal(colorMismatches.length, 1);
  assert.equal(
    (colorMismatches[0]!.expected.value as { color: string }).color,
    "#005bd3ff",
  );
  assert.equal(
    (colorMismatches[0]!.observed.value as { color: string }).color,
    "#000000ff",
  );
});

test("v84 still requires named instancePayload fills when width is carried", () => {
  const expectedScene = rootInstanceScene(
    [{ kind: "solid" as const, color: "#616161ff" }],
    8,
  );
  const observedScene = rootInstanceScene(
    [{ kind: "solid" as const, color: "#ff0000ff" }],
    9,
  );
  const comparison = compareSceneToExpectedPlan(
    compileExpectedScenePlan(sceneToNormalizedIr(expectedScene)),
    observedScene,
  );
  const payloadMismatches = comparison.mismatched.filter(
    (pair) => pair.expected.channel === "instancePayload",
...
test("v84 source has no polaris library branch and does not stamp 9/30/0 compile truth", () => {
  const source = readFileSync("recipe/scene-readback-v84.ts", "utf8");
  assert.doesNotMatch(source, /library\s*===\s*["']polaris["']/);
  assert.doesNotMatch(source, /if\s*\(\s*library\s*===/);
  assert.doesNotMatch(
    source,
    /intrinsicSize\.width\s*=\s*9|width:\s*9,\s*height:\s*20/,
  );
  assert.doesNotMatch(source, /spread:\s*0,\s*color:\s*["']#005bd3/);
});

test("hashed v72 scene-readback bytes stay frozen", () => {
  const v72Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v72/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v72Index.artifacts["recipe/scene-readback-v72.ts"];
  assert.ok(pinned, "v72 index missing recipe/scene-readback-v72.ts");
  const bytes = readFileSync("recipe/scene-readback-v72.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "542f31a1444ee7d4f5adb7556aa2627919d014678d3bfe59a36e2eeeed55ce12",
  );
  assert.equal(bytes.byteLength, 75876);
  assert.match(bytes.toString("utf8"), /Does not rewrite `intrinsicSize`/);
  assert.doesNotMatch(
    bytes.toString("utf8"),
    /INPUT-UNNAMED-SOURCE-PX-CARRIED-NOT-REQUIRED-EQUALS/,
  );
...
test("hashed v75 scene-readback bytes stay frozen", () => {
  const v75Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v75/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v75Index.artifacts["recipe/scene-readback-v75.ts"];
  assert.ok(pinned, "v75 index missing recipe/scene-readback-v75.ts");
  const bytes = readFileSync("recipe/scene-readback-v75.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(sha256(bytes), "498109497288561295019b2c45c6058bc90b7fa0b314838b9c0ab3cd40a4a2c1");
  assert.match(
    bytes.toString("utf8"),
    /INPUT-UNNAMED-SOURCE-PX-CARRIED-NOT-REQUIRED-EQUALS/,
  );
...
test("hashed v74 scene-readback bytes stay frozen", () => {
  const v74Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v74/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v74Index.artifacts["recipe/scene-readback-v74.ts"];
  assert.ok(pinned, "v74 index missing recipe/scene-readback-v74.ts");
  const bytes = readFileSync("recipe/scene-readback-v74.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(sha256(bytes), "70f70b6820ddb0f1b1297fbc375241c00f40d1270c0582919cc2a19017d719d6");
  assert.match(
    bytes.toString("utf8"),
    /INPUT-UNNAMED-SOURCE-PX-CARRIED-NOT-REQUIRED-EQUALS/,
  );
...
test("hashed v73 scene-readback bytes stay frozen", () => {
  const v73Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v73/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v73Index.artifacts["recipe/scene-readback-v73.ts"];
  assert.ok(pinned, "v73 index missing recipe/scene-readback-v73.ts");
  const bytes = readFileSync("recipe/scene-readback-v73.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(sha256(bytes), "955c3ee37ac726e9923b7d658d8fc610394a21768d08096fa6d0d82ecf848a86");
  assert.match(
    bytes.toString("utf8"),
    /INPUT-UNNAMED-SOURCE-PX-CARRIED-NOT-REQUIRED-EQUALS/,
  );
...
test("hashed v72 still requires unnamed width and spread equals", () => {
  const compileFill = { kind: "solid" as const, color: "#616161ff" };
  const hostFill = { type: "SOLID" as const, color: "#616161ff" };
  const expectedScene = rootInstanceScene([compileFill], 8);
  const observedScene = rootInstanceScene([hostFill], 9);
  const widthComparison = compareSceneToExpectedPlanV72(
    compileExpectedScenePlanV72(sceneToNormalizedIrV72(expectedScene)),
    observedScene,
  );
  const payloadMismatches = widthComparison.mismatched.filter(
    (pair) => pair.expected.channel === "instancePayload",
  ...
  assert.equal(payloadMismatches.length, 1);
  const spreadComparison = compareSceneToExpectedPlanV72(
    compileExpectedScenePlanV72(sceneToNormalizedIrV72(focusRingScene(1))),
    focusRingScene(0),
  );
  const spreadMismatches = spreadComparison.mismatched.filter(
    (pair) => pair.expected.channel === "effect",
  );
  assert.equal(spreadMismatches.length, 1);
});

test("hashed v77 scene-readback bytes stay frozen", () => {
  const v77Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v77/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v77Index.artifacts["recipe/scene-readback-v77.ts"];
  assert.ok(pinned, "v77 index missing recipe/scene-readback-v77.ts");
  const bytes = readFileSync("recipe/scene-readback-v77.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "a8f383bcfbdd2c93045637e7c364c05f0aa9c32e292198c0424d918cbb843a85",
  );
});

test("hashed v80 scene-readback bytes stay frozen", () => {
  const v80Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v80/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v80Index.artifacts["recipe/scene-readback-v80.ts"];
  assert.ok(pinned, "v80 index missing recipe/scene-readback-v80.ts");
  const bytes = readFileSync("recipe/scene-readback-v80.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "c7cb613956b53a0984507f02b744cc8a749a756313865b66ba28070fedc7b7f5",
  );
  assert.doesNotMatch(
    bytes.toString("utf8"),
    /INPUT-COMPILE-CARRY-LIVE-VISIBLE/,
...
test("hashed v79 scene-readback bytes stay frozen", () => {
  const v79Index = JSON.parse(
    readFileSync(
      "recipe/evidence/input-field-live-pivot-v79/antecedent-index.json",
      "utf8",
    ),
  ) as {
    artifacts: Record<string, { bytes: number; sha256: string }>;
  };
  const pinned = v79Index.artifacts["recipe/scene-readback-v79.ts"];
  assert.ok(pinned, "v79 index missing recipe/scene-readback-v79.ts");
  const bytes = readFileSync("recipe/scene-readback-v79.ts");
  assert.equal(bytes.byteLength, pinned.bytes);
  assert.equal(sha256(bytes), pinned.sha256);
  assert.equal(
    sha256(bytes),
    "38b2d4426a7e977b4dc9682e616f4a00c5fccc07b634550d8eaf68452022bcb4",
  );
  assert.doesNotMatch(bytes.toString("utf8"), /INPUT-CONTENT-OPACITY-OMITTED/);
});
