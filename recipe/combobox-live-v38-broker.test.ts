...
import { COMBOBOX_LIVE_V38_CAPTURE_COUNT } from "./combobox-live-v38-contract.js";

test("Combobox live v38 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V38_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V38_CAPTURE_COUNT, 72);
