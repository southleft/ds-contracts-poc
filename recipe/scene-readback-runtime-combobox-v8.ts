...
/**
 * Carried Combobox live v8 extract runtime. Keeps the v3 teaching that
 ...
 * INSTANCE must be ignored. Host omit of empty instance payload lives
 * in scene-readback-combobox-v8. Does not restamp hashed v1–v6 lineage.
