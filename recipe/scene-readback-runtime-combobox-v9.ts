...
/**
 * Carried Combobox live v9 extract runtime. Keeps the v3 teaching that
 ...
 * INSTANCE must be ignored. Host omit of empty instance payload and
 * name-before-`#` property recovery live in scene-readback-combobox-v9.
 * Does not restamp hashed v1–v8 lineage. Writer bytes stay frozen.
 */
