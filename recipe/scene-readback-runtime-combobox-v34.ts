...
/**
 * Carried Combobox live v34 extract runtime. Keeps the v3 teaching that
 ...
 * compile-carry label, and observe empty
 * slot-instance `instancePayload` omit live in
 * scene-readback-combobox-v34.
 * Does not restamp hashed v1–v33 lineage. Writer bytes
 * stay frozen.
 */
