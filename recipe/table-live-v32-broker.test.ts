...
import { TABLE_LIVE_V32_CAPTURE_COUNT } from "./table-live-v32-contract.js";

test("Table live v32 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V32_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V32_CAPTURE_COUNT, 20);
