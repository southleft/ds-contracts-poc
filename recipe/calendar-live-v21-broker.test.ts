...
import { CALENDAR_LIVE_V21_CAPTURE_COUNT } from "./calendar-live-v21-contract.js";

test("Calendar live v21 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V21_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V21_CAPTURE_COUNT, 8);
