...
import { TABLE_LIVE_V25_CAPTURE_COUNT } from "./table-live-v25-contract.js";

test("Table live v25 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V25_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V25_CAPTURE_COUNT, 20);
