...
import { TABLE_LIVE_V38_CAPTURE_COUNT } from "./table-live-v38-contract.js";

test("Table live v38 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V38_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V38_CAPTURE_COUNT, 20);
