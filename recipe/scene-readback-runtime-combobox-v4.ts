...
/**
 * Carried Combobox live v4 extract runtime. Keeps the v3 teaching that
 * owned COMPONENT_SET roots may omit `envelopeHash`. Teaches that
 * Figma-copied `ownershipKey` on descendants inside an owned INSTANCE
 * must be ignored and those nodes treated as generated descendants.
 * Does not restamp hashed v1/v2/v3 lineage. Writer bytes stay frozen.
 */
