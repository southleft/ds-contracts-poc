...
import { TABLE_LIVE_V3_CAPTURE_COUNT } from "./table-live-v3-contract.js";

test("Table live v3 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V3_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V3_CAPTURE_COUNT, 20);
