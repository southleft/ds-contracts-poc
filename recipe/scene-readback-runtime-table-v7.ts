...
/**
 * Table live v7 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. The v7 teaching lives in
 * host-normalize (`scene-readback-table-v1.ts`): fold uniform per-side
 * stroke-weight binds into compile field `strokes.0.weight`.
 */
