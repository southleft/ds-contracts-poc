...
import { CALENDAR_LIVE_V18_CAPTURE_COUNT } from "./calendar-live-v18-contract.js";

test("Calendar live v18 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V18_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V18_CAPTURE_COUNT, 8);
