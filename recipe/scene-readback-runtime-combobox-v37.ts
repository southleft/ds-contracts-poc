...
/**
 * Carried Combobox live v37 extract runtime. Keeps the v3 teaching that
 ...
 * scene-readback-combobox-v37. Trigger-slot
 * `componentRef` compile sibling-order
 * recovery and empty-content trigger
 * compile-carry characters also live
 * there. Does not restamp hashed v1–v36
 * lineage. Writer bytes stay frozen.
 */
