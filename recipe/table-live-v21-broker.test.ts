...
import { TABLE_LIVE_V21_CAPTURE_COUNT } from "./table-live-v21-contract.js";

test("Table live v21 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V21_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V21_CAPTURE_COUNT, 20);
