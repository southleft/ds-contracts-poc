...
import { TABLE_LIVE_V19_CAPTURE_COUNT } from "./table-live-v19-contract.js";

test("Table live v19 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V19_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V19_CAPTURE_COUNT, 20);
