...
import { COMBOBOX_LIVE_V21_CAPTURE_COUNT } from "./combobox-live-v21-contract.js";

test("Combobox live v21 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V21_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V21_CAPTURE_COUNT, 72);
