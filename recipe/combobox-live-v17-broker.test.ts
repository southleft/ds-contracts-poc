...
import { COMBOBOX_LIVE_V17_CAPTURE_COUNT } from "./combobox-live-v17-contract.js";

test("Combobox live v17 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V17_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V17_CAPTURE_COUNT, 72);
