...
import { buildFigmaSceneReadbackRuntime } from "./scene-readback-runtime-v85.js";
import {
...
import {
  INPUT_LIVE_V85_CONTENT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_CONTENT_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V85_CONTENT_HIDDEN_HEIGHT_HUG_MARKER,
  INPUT_LIVE_V85_CONTENT_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V85_CONTENT_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V85_CONTENT_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V85_CONTENT_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V85_CONTENT_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_LABEL_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V85_LABEL_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_ROW_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_ROW_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_ROW_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_ROW_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V85_SURFACE_STROKE_DASH_PATTERN_OMITTED_MARKER,
  INPUT_LIVE_V85_MESSAGE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_MESSAGE_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V85_MESSAGE_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V85_MESSAGE_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V85_MESSAGE_CONTAINER_CLIPS_CONTENT_OMITTED_MARKER,
  INPUT_LIVE_V85_MESSAGE_CONTAINER_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V85_MESSAGE_CONTAINER_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V85_MESSAGE_CONTAINER_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V85_VARIANT_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V85_VARIANT_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V85_VARIANT_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V85_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_LEADING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V85_LEADING_SLOT_ROLES,
  INPUT_LIVE_V85_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_TRAILING_SLOT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V85_TRAILING_SLOT_ROLES,
  INPUT_LIVE_V85_REQUIRED_INDICATOR_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V85_REQUIRED_INDICATOR_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_REQUIRED_INDICATOR_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V85_REQUIRED_INDICATOR_LETTER_SPACING_OMITTED_MARKER,
  INPUT_LIVE_V85_REQUIRED_INDICATOR_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V85_REQUIRED_INDICATOR_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V85_SET_CORNER_RADIUS_OMITTED_MARKER,
  INPUT_LIVE_V85_SET_EFFECTS_OMITTED_MARKER,
  INPUT_LIVE_V85_SET_FILLS_OMITTED_MARKER,
  INPUT_LIVE_V85_SET_STROKES_OMITTED_MARKER,
  INPUT_LIVE_V85_LABEL_ROW_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_LABEL_ROW_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V85_LABEL_ROW_ROLES,
  INPUT_LIVE_V85_REQUIRED_INDICATOR_ROLES,
  INPUT_LIVE_V85_MESSAGE_ROLES,
  INPUT_LIVE_V85_LABEL_ROLES,
  INPUT_LIVE_V85_CONTENT_TEXT_CASE_OMITTED_MARKER,
  INPUT_LIVE_V85_CONTENT_TEXT_DECORATION_OMITTED_MARKER,
  INPUT_LIVE_V85_CONTENT_OPACITY_OMITTED_MARKER,
  INPUT_LIVE_V85_COMPILE_CARRY_LIVE_VISIBLE_MARKER,
  INPUT_LIVE_V85_COMPILE_CARRY_LIVE_OPACITY_MARKER,
  INPUT_LIVE_V85_CONTENT_COMPILE_BINDING_FIELDS,
  INPUT_LIVE_V85_CONTENT_ROLES,
  INPUT_LIVE_V85_SLOT_COLOR_BINDING_MARKER,
  INPUT_LIVE_V85_SLOT_FILL_MARKER,
  INPUT_LIVE_V85_SLOT_ROLES,
  INPUT_LIVE_V85_SURFACE_BINDING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_SURFACE_BINDING_EXTRAS_MARKER,
  INPUT_LIVE_V85_FONT_PROVENANCE_NAME_ORDER_MARKER,
  INPUT_LIVE_V85_INSTANCE_PAYLOAD_FILL_KIND_MARKER,
  INPUT_LIVE_V85_UNNAMED_SOURCE_PX_CARRIED_MARKER,
  INPUT_LIVE_V85_VARIANT_AXIS_SIZE_ORDER_MARKER,
  canonicalizeObservedVariantAxisSizeOrder,
  INPUT_LIVE_V85_SURFACE_BINDING_ITEM_SPACING_COMPILE_ORDER_MARKER,
  INPUT_LIVE_V85_SURFACE_COMPILE_BINDING_FIELDS,
  ...
  INPUT_LIVE_V85_COLLAPSE_OMIT_INVENTED_CONTENT_TEXT_OPACITY_MARKER,
  INPUT_LIVE_V85_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER,
  INPUT_LIVE_V85_SURFACE_LAYOUT_HEIGHT_MARKER,
  INPUT_LIVE_V85_SURFACE_STROKE_WEIGHT_MARKER,
  INPUT_LIVE_V85_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER,
  INPUT_LIVE_V85_VARIANT_LAYOUT_WIDTH_COMPILE_INDEX_MARKER,
  INPUT_LIVE_V85_VARIANT_LAYOUT_WIDTH_MARKER,
  SCENE_READBACK_V12_TAUGHT_FILL_KINDS,
  scenePaintToIr,
  sceneToNormalizedIr,
  type SceneNodeSnapshot,
} from "./scene-readback-v85.js";
...
test("v17 surfaces empty leading-slot fills from instancePayload", () => {
  ...
  assert.equal(INPUT_LIVE_V85_SLOT_FILL_MARKER, "INPUT-SLOT-FILL-FROM-PAYLOAD");
  assert.deepEqual([...INPUT_LIVE_V85_SLOT_ROLES], [
...
test("v25 places remaining surface bindings at compile field order", () => {
  ...
  assert.deepEqual(
    (ir.bindings ?? []).map((binding) => binding.field),
    [...INPUT_LIVE_V85_SURFACE_COMPILE_BINDING_FIELDS.slice(1)],
  );
  assert.equal(
    INPUT_LIVE_V85_SURFACE_BINDING_COMPILE_ORDER_MARKER,
...
test("v26 drops duplicate mapped content color bindings", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V85_CONTENT_ROLES], [
...
test("v85 recovers hug height for hidden content text with FIXED vertical sizing", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fills.0.color",
...
test("v85 does not rewrite visible content FIXED height or invent a height variable", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/value", [
      {
        field: "fontSize.0",
...
test("v85 does not lift hidden FIXED height onto non-content text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v10 live host path does not import hashed scene-readback.ts", () => {
  const verifier = readFileSync(
    "recipe/input-field-live-v85-verifier.ts",
    "utf8",
  );
...
test("v85 omits content letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v85 does not omit letterSpacing on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
...
test("v85 omits content textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v85 does not omit textCase on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v85 collapse cycle omits invented default-1 content TEXT opacity", () => {
  const scene: SceneNodeSnapshot = {
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v85 omits content opacity that compile never emits", () => {
...
test("v85 host omits visible when extract is true and does not invent false", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v85 does not omit opacity on label text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v85 omits content textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...contentScene("input-field/content/placeholder", [
      {
        field: "fontSize.0",
...
test("v85 does not omit textDecoration on non-content non-label non-message text", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "counter",
    type: "TEXT",
    name: "input-field/message/counter :: 0/100",
...
test("v85 omits content-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    clipsContent: true,
...
test("v85 omits label-row clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v85 omits message-container clipsContent that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v85 does not omit clipsContent on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
...
test("v85 omits message-container effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    effects: [],
...
test("v85 does not omit effects on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    effects: [],
...
test("v85 omits message-container strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    strokes: [],
...
test("v85 does not omit strokes on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    strokes: [],
...
test("v85 omits message-container cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/message-container :: Messages",
    cornerRadius: {
...
test("v85 omits variant cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
...
test("v85 omits variant effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v85 omits variant strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v85 orders leading-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V85_LEADING_SLOT_ROLES], [
    "input-field/slot/leading",
  ]);
  assert.equal(
    INPUT_LIVE_V85_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v85 orders trailing-slot bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V85_TRAILING_SLOT_ROLES], [
    "input-field/slot/trailing",
  ]);
  assert.equal(
    INPUT_LIVE_V85_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
...
test("v85 drops required-indicator duplicate fills.0.color and orders remaining bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
    requiredIndicatorScene(requiredIndicatorHostBindings),
  );
  assert.equal(ir.role, "input-field/required-indicator");
  ...
  assert.deepEqual([...INPUT_LIVE_V85_REQUIRED_INDICATOR_ROLES], [
...
test("v85 omits required-indicator letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v85 omits required-indicator textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v85 omits required-indicator textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...requiredIndicatorScene(requiredIndicatorHostBindings),
    letterSpacing: { unit: "PERCENT", value: 0 },
    textCase: "ORIGINAL",
...
test("v85 omits set cornerRadius that compile never emits", () => {
...
test("v85 omits set effects that compile never emits", () => {
  const ir = sceneToNormalizedIr(setScene());
  assert.equal(ir.role, "input-field/set");
  assert.equal(ir.kind, "component-set");
  assert.equal(ir.effects, undefined);
...
test("v85 omits set fills that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    fills: [{ type: "SOLID", color: "#f7f7f8ff" }],
  });
...
test("v85 host-normalize emits set layout.mode horizontal from HORIZONTAL", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    layoutMode: "HORIZONTAL",
  });
...
test("v85 does not omit set layout.mode that compile emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    layoutMode: "HORIZONTAL",
  });
...
test("v85 does not omit set clipsContent that compile emits", () => {
  const ir = sceneToNormalizedIr({
    ...setScene(),
    clipsContent: false,
  });
...
test("v85 keeps variant clipsContent present and variant cornerRadius absent", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "variant",
    type: "COMPONENT",
    name: "input-field/variant/medium/default/placeholder/false/none",
...
test("v85 does not omit cornerRadius on surfaces", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/surface :: Surface",
    cornerRadius: {
...
test("v85 omits content-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    cornerRadius: {
...
test("v85 omits label-row cornerRadius that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    cornerRadius: {
...
test("v85 omits content-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    effects: [],
...
test("v85 omits label-row effects that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    effects: [],
...
test("v85 omits content-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/content-row :: Row",
    strokes: [],
...
test("v85 omits label-row strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceScene([]),
    name: "input-field/label-row :: Row",
    strokes: [],
...
test("v85 omits surface stroke dashPattern that compile never emits", () => {
...
test("v85 orders message/helper bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
  ...
  assert.deepEqual([...INPUT_LIVE_V85_MESSAGE_ROLES], [
    "input-field/message/helper",
    "input-field/message/error",
  ]);
});

test("v85 orders message/error bindings to compile field order", () => {
  const ir = sceneToNormalizedIr(
...
test("v85 omits message/helper letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v85 omits message/error letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
...
test("v85 omits message/helper textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textCase: "ORIGINAL",
  });
...
test("v85 omits message/error textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textCase: "ORIGINAL",
  });
...
test("v85 omits message/helper textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/helper", []),
    textDecoration: "NONE",
  });
...
test("v85 omits message/error textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ...messageScene("input-field/message/error", []),
    textDecoration: "NONE",
  });
...
test("v85 does not omit surface stroke dashPattern when the host value is not empty", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    dashPattern: [2, 2],
  });
...
test("v85 does not lift surface dashPattern omit onto a non-surface frame", () => {
  const ir = sceneToNormalizedIr({
    ...surfaceStrokeScene(),
    name: "other :: Frame",
  });
...
test("v85 drops duplicate label bindings and orders remaining fields to compile", () => {
  const ir = sceneToNormalizedIr(
    labelScene([
      {
        field: "fills.0.color",
  ...
  assert.deepEqual([...INPUT_LIVE_V85_LABEL_ROLES], ["input-field/label"]);
});

test("v85 does not apply label binding teaching to surfaces", () => {
  const ir = sceneToNormalizedIr(
    surfaceScene([
      {
        field: "fills.0.color",
...
test("v85 omits label letterSpacing that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v85 omits label textCase that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v85 omits label textDecoration that compile never emits", () => {
  const ir = sceneToNormalizedIr({
    ownershipKey: "label",
    type: "TEXT",
    name: "input-field/label :: Label",
...
test("v85 omits set strokes that compile never emits", () => {
  const ir = sceneToNormalizedIr(setScene());
  assert.equal(ir.role, "input-field/set");
  assert.equal(ir.kind, "component-set");
  assert.equal(ir.strokes, undefined);
...
test("v85 orders label-row bindings to compile field order", () => {
  ...
  assert.deepEqual([...INPUT_LIVE_V85_LABEL_ROW_ROLES], [
...
test("v85 MUI surface still emits 12 compile-order bindings", () => {
  const leftover = [
    "cornerRadius.bottomLeft",
    "cornerRadius.bottomRight",
    "fills.0.color",
  ...
  assert.equal(INPUT_LIVE_V85_SURFACE_COMPILE_BINDING_FIELDS.length, 13);
  assert.equal(
    INPUT_LIVE_V85_SURFACE_COMPILE_BINDING_FIELDS[0],
    "layout.itemSpacing",
  );
});
...
test("v85 orders Polar surface bindings to compile field order", () => {
...
test("v85 canonicalizes observed font-provenance name key order to compile fallbackChain-first", () => {
...
test("v85 does not invent font-provenance keys or hide value drift", () => {
...
test("v85 aliases instancePayload fill type SOLID to compile kind solid without rewriting width", () => {
  assert.equal(
    INPUT_LIVE_V85_INSTANCE_PAYLOAD_FILL_KIND_MARKER,
    "INPUT-INSTANCE-PAYLOAD-FILL-KIND-COMPILE",
  );
...
test("v85 does not require unnamed intrinsicSize.width equals and does not invent compile pixels", () => {
  assert.equal(
    INPUT_LIVE_V85_UNNAMED_SOURCE_PX_CARRIED_MARKER,
...
test("v85 canonicalizes Size axis order to compile small,medium and carries unnamed width", () => {
  assert.equal(
    INPUT_LIVE_V85_VARIANT_AXIS_SIZE_ORDER_MARKER,
    "INPUT-VARIANT-AXIS-SIZE-ORDER-COMPILE",
  );
...
test("v85 does not require unnamed effect spread equals and still scores ring color", () => {
...
test("v85 still requires named instancePayload fills when width is carried", () => {
...
test("v85 source has no polaris library branch and does not stamp 9/30/0 compile truth", () => {
  const source = readFileSync("recipe/scene-readback-v85.ts", "utf8");
