...
import { CALENDAR_LIVE_V8_CAPTURE_COUNT } from "./calendar-live-v8-contract.js";

test("Calendar live v8 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V8_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V8_CAPTURE_COUNT, 8);
