...
/**
 * Carried Combobox live v28 extract runtime. Keeps the v3 teaching that
 ...
 * omit, set-root clipsContent omit, and option
 * compile-order binding sort live in
 * scene-readback-combobox-v28.
 * Does not restamp hashed v1–v27 lineage. Writer bytes
 * stay frozen.
 */
