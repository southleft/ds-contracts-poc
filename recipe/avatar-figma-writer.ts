...
export const AVATAR_FIGMA_RUN_SUFFIX = "avatar-v7";
/** v6 stay (Chakra Avatar, captured today from a config entry authored as the person's step) is preserved as evidence and never written again. */
export const FORBIDDEN_AVATAR_V6_PAGE_ID = "218:90709";
/** v5 stay (five proposed sources: MUI and AntD from their own captures, Altitude, shadcn and Fluent held out) is preserved as evidence and never written again. */
export const FORBIDDEN_AVATAR_V5_PAGE_ID = "218:87603";
...
const WRITER_RUNTIME_SPEC = {
  ...
  "forbiddenPages": [
    { "id": "218:90709", "marker": "AVATAR-V6-PAGE" },
    { "id": "218:87603", "marker": "AVATAR-V5-PAGE" },
