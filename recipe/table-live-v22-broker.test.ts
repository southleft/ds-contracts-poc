...
import { TABLE_LIVE_V22_CAPTURE_COUNT } from "./table-live-v22-contract.js";

test("Table live v22 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V22_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V22_CAPTURE_COUNT, 20);
