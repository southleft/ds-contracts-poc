...
import { TABLE_LIVE_V24_CAPTURE_COUNT } from "./table-live-v24-contract.js";

test("Table live v24 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V24_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V24_CAPTURE_COUNT, 20);
