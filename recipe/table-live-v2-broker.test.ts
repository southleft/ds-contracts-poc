...
import { TABLE_LIVE_V2_CAPTURE_COUNT } from "./table-live-v2-contract.js";

test("Table live v2 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V2_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V2_CAPTURE_COUNT, 20);
