...
import { COMBOBOX_LIVE_V18_CAPTURE_COUNT } from "./combobox-live-v18-contract.js";

test("Combobox live v18 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V18_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V18_CAPTURE_COUNT, 72);
