...
import { COMBOBOX_LIVE_V33_CAPTURE_COUNT } from "./combobox-live-v33-contract.js";

test("Combobox live v33 broker pins Scratch and 72 captures", () => {
  assert.equal(COMBOBOX_LIVE_V33_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(COMBOBOX_LIVE_V33_CAPTURE_COUNT, 72);
