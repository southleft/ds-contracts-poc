...
import { CALENDAR_LIVE_V3_CAPTURE_COUNT } from "./calendar-live-v3-contract.js";

test("Calendar live v3 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V3_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V3_CAPTURE_COUNT, 8);
