...
import { TABLE_LIVE_V33_CAPTURE_COUNT } from "./table-live-v33-contract.js";

test("Table live v33 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V33_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V33_CAPTURE_COUNT, 20);
