...
export function validatePivotStatus(
  ...
  if (
    ...
    status.combobox?.status !== "live-v6-prepared" ||
    ...
    status.combobox?.liveV6?.runIdentity !==
      "70c24cbd-d27f2e85-combobox-v1" ||
    status.combobox?.liveV6?.attempt1 !== undefined ||
