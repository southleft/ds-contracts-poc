...
const TABLE_LIVE_V4_ATTEMPT_1_PATH =
  "recipe/evidence/table-live-pivot-v4-attempt-1.json";
const TABLE_LIVE_V4_ATTEMPT_1_SHA256 =
  "2119d47324c55ab2aba9a9537a359873ae04d9415798b9c6028bbbc07f9dccb8";
const TABLE_LIVE_V4_STATUS_PATH =
  "recipe/evidence/table-live-pivot-v4-status.json";
const TABLE_LIVE_V4_STATUS_SHA256 =
  "eb420c18907f5302a55ec7cc876b3948b103b7cc8ef15b3a7d7ce78a7c18b94c";
const TABLE_LIVE_V5_ATTEMPT_1_PATH =
  "recipe/evidence/table-live-pivot-v5-attempt-1.json";
const TABLE_LIVE_V5_ATTEMPT_1_SHA256 =
  "66fc8ed2d7195aa3591101d2ee6a5802d142fffd5aa60acaff6a6f535cacea22";
const TABLE_LIVE_V5_STATUS_PATH =
  "recipe/evidence/table-live-pivot-v5-status.json";
const TABLE_LIVE_V5_STATUS_SHA256 =
  "69fa207bbaa6ab6f1f84c5128a5680542fc7e336a9739d59ad07653a01a5a261";
const TABLE_LIVE_V6_ATTEMPT_1_PATH =
  "recipe/evidence/table-live-pivot-v6-attempt-1.json";
const TABLE_LIVE_V6_ATTEMPT_1_SHA256 =
  "402c6ac2d637b97d73221814d7a6ded3cd77846e089abdce10981fa60b898351";
const TABLE_LIVE_V6_STATUS_PATH =
  "recipe/evidence/table-live-pivot-v6-status.json";
const TABLE_LIVE_V6_STATUS_SHA256 =
  "9dbfcfcf068544af096195a4e5466d3b113e724c98a202ebac6ef107bc582a52";
...
export function validatePivotStatus(
  ...
  if (
    ...
    status.table?.status !==
      "live-v7-prepared; product v1 incomplete" ||
    ...
    status.table?.liveV4?.doNotRestartV4Attempt2 !== true ||
    status.table?.liveV4?.attempt1?.status !== "failed-closed" ||
    status.table?.liveV4?.attempt1?.writerAccepted !== false ||
    status.table?.liveV4?.attempt1?.refusedClass !== "TABLE-MIN-WIDTH-ZERO" ||
    status.table?.liveV4?.attempt1?.refused !== "TABLE-MIN-WIDTH-ZERO" ||
    status.table?.liveV4?.attempt1?.ownedRowTextCharactersTeachingCleared !==
      true ||
    status.table?.liveV4?.attempt1?.restoreIssued !== false ||
    status.table?.liveV4?.attempt1?.extractIssued !== false ||
    status.table?.liveV4?.attempt1?.probeIssued !== false ||
    status.table?.liveV4?.attempt1?.capturesIssued !== 0 ||
    status.table?.liveV4?.attempt1?.mintStayed !== false ||
    status.table?.liveV4?.attempt1?.cleanedPageId !== "165:40763" ||
    status.table?.liveV4?.attempt1?.cleanedCollectionId !==
      "VariableCollectionId:165:40765" ||
    status.table?.liveV4?.attempt1?.cleanedCollectionIds?.[0] !==
      "VariableCollectionId:165:40765" ||
    status.table?.liveV4?.attempt1?.cleanedCollectionIds?.[1] !==
      "VariableCollectionId:165:40894" ||
    status.table?.liveV4?.attempt1?.cleanupExecuted !== true ||
    status.table?.liveV4?.attempt1?.signedCleanupIssued !== false ||
    status.table?.liveV4?.nextTeaching !==
      "when host minWidth is 0, unset with null rather than assigning 0" ||
    sha256(readRepositoryEvidence(TABLE_LIVE_V4_ATTEMPT_1_PATH)) !==
      TABLE_LIVE_V4_ATTEMPT_1_SHA256 ||
    sha256(readRepositoryEvidence(TABLE_LIVE_V4_STATUS_PATH)) !==
      TABLE_LIVE_V4_STATUS_SHA256 ||
    status.table?.liveV5?.prepared !== true ||
    status.table?.liveV5?.liveFigma !== false ||
    status.table?.liveV5?.humanSignoff !== "pending" ||
    status.table?.liveV5?.pageId !== null ||
    status.table?.liveV5?.forbiddenInputPageId !== "115:295378" ||
    status.table?.liveV5?.forbiddenComboboxPageId !== "163:35981" ||
    status.table?.liveV5?.runIdentity !== "cc811f47-82d19508-table-v5" ||
    status.table?.liveV5?.namespace !== "ds.contracts.table.recipe.v1" ||
    status.table?.liveV5?.evidenceRoot !==
      "recipe/evidence/table-live-pivot-v5" ||
    status.table?.liveV5?.teaching !==
      "when host minWidth is 0, unset with null rather than assigning 0" ||
    status.table?.liveV5?.namedFromSourceFamily !== "Inter" ||
    status.table?.liveV5?.carriedHostStyle !== "Semi Bold" ||
    status.table?.liveV5?.resolution !== "requested" ||
    status.table?.liveV5?.doNotRestartV1Attempt2 !== true ||
    status.table?.liveV5?.doNotRestartV2Attempt2 !== true ||
    status.table?.liveV5?.doNotRestartV3Attempt2 !== true ||
    status.table?.liveV5?.doNotRestartV4Attempt2 !== true ||
    status.table?.liveV5?.headerFontTeachingUnchangedFromV2 !== true ||
    status.table?.liveV5?.hostNormalizeUnchangedFromV1 !== true ||
    status.table?.liveV5?.ownedRowTextCharactersTeachingUnchangedFromV4 !==
      true ||
    status.table?.liveV5?.doNotRestartV5Attempt2 !== true ||
    status.table?.liveV5?.attempt1?.status !== "failed-closed" ||
    status.table?.liveV5?.attempt1?.writerAccepted !== true ||
    status.table?.liveV5?.attempt1?.restoreAccepted !== true ||
    status.table?.liveV5?.attempt1?.restoredCount !== 8 ||
    status.table?.liveV5?.attempt1?.extractAccepted !== false ||
    status.table?.liveV5?.attempt1?.refusedClass !==
      "SCENE-OWNERSHIP-KEY-ABSENT" ||
    status.table?.liveV5?.attempt1?.refused !==
      "SCENE-OWNERSHIP-KEY-ABSENT:165:40973" ||
    status.table?.liveV5?.attempt1?.minWidthZeroUnsetTeachingCleared !==
      true ||
    status.table?.liveV5?.attempt1?.probeIssued !== false ||
    status.table?.liveV5?.attempt1?.capturesIssued !== 0 ||
    status.table?.liveV5?.attempt1?.mintStayed !== false ||
    status.table?.liveV5?.attempt1?.cleanedPageId !== "165:40914" ||
    status.table?.liveV5?.attempt1?.cleanedCollectionId !==
      "VariableCollectionId:165:40916" ||
    status.table?.liveV5?.attempt1?.cleanedCollectionIds?.[0] !==
      "VariableCollectionId:165:40916" ||
    status.table?.liveV5?.attempt1?.cleanedCollectionIds?.[1] !==
      "VariableCollectionId:165:41045" ||
    status.table?.liveV5?.attempt1?.cleanupExecuted !== true ||
    status.table?.liveV5?.attempt1?.signedCleanupIssued !== true ||
    status.table?.liveV5?.attempt1?.signedCleanupAccepted !== true ||
    status.table?.liveV5?.nextTeaching !==
      "when extract walks a row COMPONENT, skip untagged writer-created table/row/owned-cell-label TEXT nodes that exist only as host-listed characters bind targets" ||
    sha256(readRepositoryEvidence(TABLE_LIVE_V5_ATTEMPT_1_PATH)) !==
      TABLE_LIVE_V5_ATTEMPT_1_SHA256 ||
    sha256(readRepositoryEvidence(TABLE_LIVE_V5_STATUS_PATH)) !==
      TABLE_LIVE_V5_STATUS_SHA256 ||
    status.table?.liveV6?.prepared !== true ||
    status.table?.liveV6?.liveFigma !== false ||
    status.table?.liveV6?.humanSignoff !== "pending" ||
    status.table?.liveV6?.pageId !== null ||
    status.table?.liveV6?.forbiddenInputPageId !== "115:295378" ||
    status.table?.liveV6?.forbiddenComboboxPageId !== "163:35981" ||
    status.table?.liveV6?.runIdentity !== "cc811f47-82d19508-table-v6" ||
    status.table?.liveV6?.namespace !== "ds.contracts.table.recipe.v1" ||
    status.table?.liveV6?.evidenceRoot !==
      "recipe/evidence/table-live-pivot-v6" ||
    status.table?.liveV6?.teaching !==
      "when extract walks a row COMPONENT, skip untagged writer-created table/row/owned-cell-label TEXT nodes that exist only as host-listed characters bind targets" ||
    status.table?.liveV6?.namedFromSourceFamily !== "Inter" ||
    status.table?.liveV6?.carriedHostStyle !== "Semi Bold" ||
    status.table?.liveV6?.resolution !== "requested" ||
    status.table?.liveV6?.doNotRestartV1Attempt2 !== true ||
    status.table?.liveV6?.doNotRestartV2Attempt2 !== true ||
    status.table?.liveV6?.doNotRestartV3Attempt2 !== true ||
    status.table?.liveV6?.doNotRestartV4Attempt2 !== true ||
    status.table?.liveV6?.doNotRestartV5Attempt2 !== true ||
    status.table?.liveV6?.headerFontTeachingUnchangedFromV2 !== true ||
    status.table?.liveV6?.hostNormalizeUnchangedFromV1 !== true ||
    status.table?.liveV6?.ownedRowTextCharactersTeachingUnchangedFromV4 !==
      true ||
    status.table?.liveV6?.minWidthZeroUnsetTeachingUnchangedFromV5 !== true ||
    status.table?.liveV6?.doNotRestartV6Attempt2 !== true ||
    status.table?.liveV6?.attempt1?.status !== "failed-closed" ||
    status.table?.liveV6?.attempt1?.writerAccepted !== true ||
    status.table?.liveV6?.attempt1?.restoreAccepted !== true ||
    status.table?.liveV6?.attempt1?.restoredCount !== 8 ||
    status.table?.liveV6?.attempt1?.extractAccepted !== false ||
    status.table?.liveV6?.attempt1?.refusedClass !==
      "REQUIRED-BINDING-ABSENT" ||
    status.table?.liveV6?.attempt1?.refused !==
      "REQUIRED-BINDING-ABSENT:strokes.0.weight:table/variant/comfortable" ||
    status.table?.liveV6?.attempt1?.rowOwnedCellLabelSkipTeachingCleared !==
      true ||
    status.table?.liveV6?.attempt1?.probeIssued !== false ||
    status.table?.liveV6?.attempt1?.capturesIssued !== 0 ||
    status.table?.liveV6?.attempt1?.mintStayed !== false ||
    status.table?.liveV6?.attempt1?.cleanedPageId !== "165:41173" ||
    status.table?.liveV6?.attempt1?.cleanedCollectionId !==
      "VariableCollectionId:165:41175" ||
    status.table?.liveV6?.attempt1?.cleanedCollectionIds?.[0] !==
      "VariableCollectionId:165:41175" ||
    status.table?.liveV6?.attempt1?.cleanedCollectionIds?.[1] !==
      "VariableCollectionId:165:41304" ||
    status.table?.liveV6?.attempt1?.cleanupExecuted !== true ||
    status.table?.liveV6?.attempt1?.signedCleanupIssued !== true ||
    status.table?.liveV6?.attempt1?.signedCleanupAccepted !== true ||
    status.table?.liveV6?.nextTeaching !==
      "when extract host-normalizes table and cell variants, fold Figma per-side strokeTopWeight/strokeRightWeight/strokeBottomWeight/strokeLeftWeight binds that share one variable into compile field strokes.0.weight" ||
    sha256(readRepositoryEvidence(TABLE_LIVE_V6_ATTEMPT_1_PATH)) !==
      TABLE_LIVE_V6_ATTEMPT_1_SHA256 ||
    sha256(readRepositoryEvidence(TABLE_LIVE_V6_STATUS_PATH)) !==
      TABLE_LIVE_V6_STATUS_SHA256 ||
    status.table?.liveV7?.prepared !== true ||
    status.table?.liveV7?.liveFigma !== false ||
    status.table?.liveV7?.humanSignoff !== "pending" ||
    status.table?.liveV7?.pageId !== null ||
    status.table?.liveV7?.forbiddenInputPageId !== "115:295378" ||
    status.table?.liveV7?.forbiddenComboboxPageId !== "163:35981" ||
    status.table?.liveV7?.runIdentity !== "cc811f47-82d19508-table-v7" ||
    status.table?.liveV7?.namespace !== "ds.contracts.table.recipe.v1" ||
    status.table?.liveV7?.evidenceRoot !==
      "recipe/evidence/table-live-pivot-v7" ||
    status.table?.liveV7?.teaching !==
      "when extract host-normalizes table and cell variants, fold Figma per-side strokeTopWeight/strokeRightWeight/strokeBottomWeight/strokeLeftWeight binds that share one variable into compile field strokes.0.weight" ||
    status.table?.liveV7?.namedFromSourceFamily !== "Inter" ||
    status.table?.liveV7?.carriedHostStyle !== "Semi Bold" ||
    status.table?.liveV7?.resolution !== "requested" ||
    status.table?.liveV7?.doNotRestartV1Attempt2 !== true ||
    status.table?.liveV7?.doNotRestartV2Attempt2 !== true ||
    status.table?.liveV7?.doNotRestartV3Attempt2 !== true ||
    status.table?.liveV7?.doNotRestartV4Attempt2 !== true ||
    status.table?.liveV7?.doNotRestartV5Attempt2 !== true ||
    status.table?.liveV7?.doNotRestartV6Attempt2 !== true ||
    status.table?.liveV7?.headerFontTeachingUnchangedFromV2 !== true ||
    status.table?.liveV7?.ownedRowTextCharactersTeachingUnchangedFromV4 !==
      true ||
    status.table?.liveV7?.minWidthZeroUnsetTeachingUnchangedFromV5 !== true ||
    status.table?.liveV7?.rowOwnedCellLabelSkipTeachingUnchangedFromV6 !==
      true ||
    status.table?.liveV7?.hostFoldsUniformPerSideStrokeWeightBinds !== true
  )
    fail("table live v1 attempt 1 / v2 attempt 1 / v3 attempt 1 / v4 attempt 1 / v5 attempt 1 / v6 attempt 1 / v7 prepare");
