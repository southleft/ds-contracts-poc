...
export function validatePivotStatus(
  ...
  if (
    ...
    status.combobox?.status !== "live-v5-prepared" ||
    ...
    status.combobox?.liveV5?.runIdentity !==
      "70c24cbd-d27f2e85-combobox-v1" ||
    status.combobox?.liveV5?.attempt1 !== undefined ||
