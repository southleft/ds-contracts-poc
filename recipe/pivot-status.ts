...
export function validatePivotStatus(
  ...
  if (
    ...
    status.table?.status !==
      "live-v3-prepared; product v1 incomplete" ||
    ...
    fail("table live v1 attempt 1 / v2 attempt 1 / v3 prepare");
