...
/**
 * Table live v17 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v16. The v17 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit `cornerRadius` on
 * `table/set`, `table/row-set`, and `table/cell-set` because compile
 * component-sets omit `cornerRadius`. Does not omit `table/variant`
 * `cornerRadius`. Does not invent `cornerRadius` onto compile sets.
 */
