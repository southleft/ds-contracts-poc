...
import { CALENDAR_LIVE_V17_CAPTURE_COUNT } from "./calendar-live-v17-contract.js";

test("Calendar live v17 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V17_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V17_CAPTURE_COUNT, 8);
