...
import { CALENDAR_LIVE_V1_CAPTURE_COUNT } from "./calendar-live-v1-contract.js";

test("Calendar live v1 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V1_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V1_CAPTURE_COUNT, 8);
