...
import {
  ...
  COMBOBOX_LIVE_V28_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V28_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V28_LISTBOX_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V28_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_LISTBOX_CORNER_RADIUS_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_LISTBOX_EMPTY_STROKES_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER,
  COMBOBOX_LIVE_V28_OPTION_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V28_OPTION_INSTANCE_BINDING_EXTRAS_MARKER,
  COMBOBOX_LIVE_V28_OPTION_INSTANCE_FILLS_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_OVERLAY_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V28_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_SET_CLIPS_CONTENT_OMITTED_MARKER,
  COMBOBOX_LIVE_V28_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER,
  COMBOBOX_LIVE_V28_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER,
  COMBOBOX_LIVE_V28_RECOVER_COMPONENT_PROPERTY_NAME_MARKER,
  COMBOBOX_LIVE_V28_RECOVER_RECIPE_COMPONENT_REF_MARKER,
  COMBOBOX_LIVE_V28_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V28_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER,
  COMBOBOX_LIVE_V28_TRIGGER_BINDING_COMPILE_ORDER_MARKER,
  COMBOBOX_LIVE_V28_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER,
...
test("host orders combobox/option bindings to compile field order so layout.itemSpacing precedes fills.0.color", () => {
  ...
  assert.deepEqual(
    ...
    "v28 host must order option bindings so layout.itemSpacing precedes padding left/right precedes layout.width.value",
  );
  assert.equal(
    observedFields[0],
    "layout.itemSpacing",
    "v28 must not keep live extract fills.0.color first",
  );
  ...
  assert.deepEqual(
    known,
    COMBOBOX_LIVE_V1_OPTION_COMPILE_BINDING_FIELDS.filter((field) =>
      observedFields.includes(field),
    ),
    "v28 known option fields must follow compile order; do not invent a height alias in this teaching",
  );
});
