...
- 4. compile   fixed point ✔ · 1 variants · 23 carried · 3 receipts · recipe d900b3b5
- 5. emit      writer.plugin.js (25 KB, page "Recipe Pivot / Chip / d900b3b5-chip-v7") and writer.scratch.js
...
## What to do next
1. In Figma desktop, open the file the set should live in, open the development plugin, choose **Paste a script**, paste `writer.plugin.js`, run. It creates its own page named "Recipe Pivot / Chip / d900b3b5-chip-v7" and never touches an existing page.
