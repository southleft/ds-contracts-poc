...
- 4. compile   fixed point ✔ · 4 variants · 73 carried · 4 receipts · recipe 07758707
- 5. emit      writer.plugin.js (42 KB, page "Recipe Pivot / Alert / 07758707-alert-v10") and writer.scratch.js
...
## What to do next
1. In Figma desktop, open the file the set should live in, open the development plugin, choose **Paste a script**, paste `writer.plugin.js`, run. It creates its own page named "Recipe Pivot / Alert / 07758707-alert-v10" and never touches an existing page.
