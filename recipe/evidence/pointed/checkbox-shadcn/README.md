...
- 3. propose   28 leaves read from the ledger · 6 reviewed (named) · 21 archetype spellings · 0 invented → recipe/fixtures/generated/checkbox.shadcn.ts
- 4. compile   fixed point ✔ · 6 variants · 68 carried · 6 receipts · recipe 3ecd6666
- 5. emit      writer.plugin.js (57 KB, page "Recipe Pivot / Checkbox / 3ecd6666-checkbox-v6") and writer.scratch.js
...
## What to do next
1. In Figma desktop, open the file the set should live in, open the development plugin, choose **Paste a script**, paste `writer.plugin.js`, run. It creates its own page named "Recipe Pivot / Checkbox / 3ecd6666-checkbox-v6" and never touches an existing page.
