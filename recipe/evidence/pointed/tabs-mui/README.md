...
- 3. propose   26 leaves read from the ledger · 0 reviewed (named) · 0 archetype spellings · 0 invented → recipe/fixtures/generated/tabs.mui.ts
- 4. compile   fixed point ✔ · 2 variants · 44 carried · 3 receipts · recipe 1b2453fa
- 5. emit      writer.plugin.js (30 KB, page "Recipe Pivot / Tabs / 1b2453fa-tabs-v14") and writer.scratch.js
...
## What to do next
1. In Figma desktop, open the file the set should live in, open the development plugin, choose **Paste a script**, paste `writer.plugin.js`, run. It creates its own page named "Recipe Pivot / Tabs / 1b2453fa-tabs-v14" and never touches an existing page.
