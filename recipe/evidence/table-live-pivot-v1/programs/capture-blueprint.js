...
const page=await figma.getNodeByIdAsync("__WRITER_PAGE_ID__"),set=await figma.getNodeByIdAsync("__FP_TABLE_SET_ID__"),cell={"index":0,"cellKey":"first-party/table/compact","source":"first-party","adapterIdentity":"first-party-table-reviewed-v1","kind":"table","axes":{"Density":"compact"},"strata":{"source":"first-party","kind":"table","density":"compact"},"frame":{"width":464,"height":290}};
...
try{
 ...
 if(bytes.byteLength>1500000)throw new Error("TABLE-V1-CAPTURE-SIZE:"+bytes.byteLength);
