...
const page=await figma.getNodeByIdAsync("__WRITER_PAGE_ID__"),set=await figma.getNodeByIdAsync("__ASTRYX_CALENDAR_SET_ID__"),cell={"index":0,"cellKey":"astryx/calendar/on","source":"astryx","adapterIdentity":"astryx-calendar-reviewed-v1","kind":"calendar","axes":{"WeekNumbers":"on"},"strata":{"source":"astryx","kind":"calendar","density":"on"},"frame":{"width":336,"height":216}};
...
try{
 ...
 if(bytes.byteLength>1500000)throw new Error("CALENDAR-V1-CAPTURE-SIZE:"+bytes.byteLength);
