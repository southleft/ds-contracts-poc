...
const __body=JSON.stringify({run:2,result:__result});
...
return {posted:__res.ok,run:2,writes:__result.writes,variants:__result.variants,bytes:__body.length,sceneSha256:__ack.sceneSha256};