...
const __body=JSON.stringify({slug:"altitude-checkbox",run:2,result:__result});
...
return {posted:true,slug:"altitude-checkbox",run:2,writes:__result.writes,variants:__result.variants,bytes:__body.length,sceneSha256:__ack.sceneSha256};