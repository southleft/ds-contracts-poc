...
const __body=JSON.stringify({slug:"cbds-text-area",run:1,result:__result,error:__error});
...
return {posted:true,slug:"cbds-text-area",run:1,error:__error,writes:__result?__result.writes:null,variants:__result?__result.variants:null,bytes:__body.length,sceneSha256:__ack.sceneSha256||null};