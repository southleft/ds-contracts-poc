...
const __body=JSON.stringify({slug:"altitude-toggle",run:1,result:__result});
...
return {posted:true,slug:"altitude-toggle",run:1,writes:__result.writes,variants:__result.variants,bytes:__body.length,sceneSha256:__ack.sceneSha256};