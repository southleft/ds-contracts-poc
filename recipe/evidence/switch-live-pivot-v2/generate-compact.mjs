...
const RUN = "a8686d63-3d086535-0720db18-switch-v2";
...
const libraries = {
  ...
  antd: {
    ...
    recipeHash:
      "0720db18b3adc4f736a5444aff4a7f2e7de30fded087d4f58342a3bc55ddb85c",
    envelopeHash:
      "15b2d3ab46d8f605e912d4b4c02ce375c99208b8d2d57bd4a2eddea33ead8da6",
    prefix: "antd.switch",
    font: antdFont,
    fontSize: 14,
    wrapper: { width: 44, height: 22, padding: 0 },
    track: { width: 44, height: 22, radius: 100, padding: 2 },
    thumb: { off: 18, on: 18, travel: 22 },
    gap: 8,
    hitClips: false,
    trackClips: false,
    cells: {
