...
const CLEANUP_PAGE_NAME="Recipe Pivot / Calendar / 19be1c96-calendar-v27";
const CLEANUP_RUN_IDENTITY="19be1c96-calendar-v27";
const CLEANUP_PAGE_OWNER="recipe/calendar/19be1c96-calendar-v27";
const CLEANUP_COLLECTION_OWNER="recipe/calendar/19be1c96-calendar-v27/variable-collection";
const CLEANUP_ADAPTERS=new Set(["astryx-calendar-reviewed-v1"]);
const CLEANUP_COLLECTION_NAMES=new Set(["Recipe Calendar / 19be1c96-calendar-v27 / astryx-calendar-reviewed-v1"]);
