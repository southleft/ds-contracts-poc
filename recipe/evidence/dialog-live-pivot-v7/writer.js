...
if(NS==="ds.contracts.input.recipe.v5"||PLAN.runIdentity==="4a074b24-e8503dd5-input-v5")throw new Error("DIALOG-INPUT-IDENTITY-REUSE");
if(NS==="ds.contracts.combobox.recipe.v1"||PLAN.runIdentity==="70c24cbd-d27f2e85-combobox-v1")throw new Error("DIALOG-COMBOBOX-IDENTITY-REUSE");
if(NS==="ds.contracts.table.recipe.v1")throw new Error("DIALOG-TABLE-IDENTITY-REUSE");
if(NS==="ds.contracts.calendar.recipe.v1")throw new Error("DIALOG-CALENDAR-IDENTITY-REUSE");
if(NS==="ds.contracts.checkbox.recipe.v1")throw new Error("DIALOG-CHECKBOX-IDENTITY-REUSE");
if(NS==="ds.contracts.radio.recipe.v1")throw new Error("DIALOG-RADIO-IDENTITY-REUSE");
if(NS==="ds.contracts.switch.recipe.v1")throw new Error("DIALOG-SWITCH-IDENTITY-REUSE");
if(NS==="ds.contracts.textarea.recipe.v1")throw new Error("DIALOG-TEXTAREA-IDENTITY-REUSE");
if(NS==="ds.contracts.alert.recipe.v1")throw new Error("DIALOG-ALERT-IDENTITY-REUSE");
if(NS==="ds.contracts.chip.recipe.v1")throw new Error("DIALOG-CHIP-IDENTITY-REUSE");
if(NS==="ds.contracts.badge.recipe.v1")throw new Error("DIALOG-BADGE-IDENTITY-REUSE");
if(NS==="ds.contracts.avatar.recipe.v1")throw new Error("DIALOG-AVATAR-IDENTITY-REUSE");
if(NS==="ds.contracts.link.recipe.v1")throw new Error("DIALOG-LINK-IDENTITY-REUSE");
if(NS==="ds.contracts.tooltip.recipe.v1")throw new Error("DIALOG-TOOLTIP-IDENTITY-REUSE");
if(NS==="ds.contracts.tabs.recipe.v1")throw new Error("DIALOG-TABS-IDENTITY-REUSE");
if(NS==="ds.contracts.menu.recipe.v1")throw new Error("DIALOG-MENU-IDENTITY-REUSE");
...
void "DIALOG-MUST-NOT-WRITE-DIALOG-V6-PAGE";
void "DIALOG-MUST-NOT-WRITE-DIALOG-V5-PAGE";
void "DIALOG-MUST-NOT-WRITE-DIALOG-V4-PAGE";
void "DIALOG-MUST-NOT-WRITE-DIALOG-V3-PAGE";
void "DIALOG-MUST-NOT-WRITE-DIALOG-V2-PAGE";
void "DIALOG-MUST-NOT-WRITE-INPUT-PAGE";
void "DIALOG-MUST-NOT-WRITE-COMBOBOX-PAGE";
void "DIALOG-MUST-NOT-WRITE-COMBOBOX-V42-PAGE";
void "DIALOG-MUST-NOT-WRITE-BUTTON-PAGE";
void "DIALOG-MUST-NOT-WRITE-PRESERVED-BUTTON-PAGE";
void "DIALOG-MUST-NOT-WRITE-TABLE-PAGE";
void "DIALOG-MUST-NOT-WRITE-CALENDAR-PAGE";
void "DIALOG-MUST-NOT-WRITE-CHECKBOX-PAGE";
void "DIALOG-MUST-NOT-WRITE-RADIO-PAGE";
void "DIALOG-MUST-NOT-WRITE-SWITCH-PAGE";
void "DIALOG-MUST-NOT-WRITE-TEXTAREA-PAGE";
void "DIALOG-MUST-NOT-WRITE-ALERT-PAGE";
void "DIALOG-MUST-NOT-WRITE-CHIP-PAGE";
void "DIALOG-MUST-NOT-WRITE-BADGE-PAGE";
void "DIALOG-MUST-NOT-WRITE-AVATAR-PAGE";
void "DIALOG-MUST-NOT-WRITE-LINK-PAGE";
void "DIALOG-MUST-NOT-WRITE-TOOLTIP-PAGE";
void "DIALOG-MUST-NOT-WRITE-TABS-PAGE";
void "DIALOG-MUST-NOT-WRITE-MENU-PAGE";
if(figma.currentPage&&figma.currentPage.id==="218:90598")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V6-PAGE");
if(figma.currentPage&&figma.currentPage.id==="218:88008")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V5-PAGE");
if(figma.currentPage&&figma.currentPage.id==="218:86515")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V4-PAGE");
if(figma.currentPage&&figma.currentPage.id==="218:85033")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V3-PAGE");
if(figma.currentPage&&figma.currentPage.id==="212:81382")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V2-PAGE");
if(figma.currentPage&&figma.currentPage.id==="115:295378")throw new Error("DIALOG-MUST-NOT-WRITE-INPUT-PAGE");
if(figma.currentPage&&figma.currentPage.id==="163:35981")throw new Error("DIALOG-MUST-NOT-WRITE-COMBOBOX-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:70641")throw new Error("DIALOG-MUST-NOT-WRITE-COMBOBOX-V42-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:69150")throw new Error("DIALOG-MUST-NOT-WRITE-BUTTON-PAGE");
if(figma.currentPage&&figma.currentPage.id==="85:6781")throw new Error("DIALOG-MUST-NOT-WRITE-PRESERVED-BUTTON-PAGE");
if(figma.currentPage&&figma.currentPage.id==="173:48924")throw new Error("DIALOG-MUST-NOT-WRITE-TABLE-PAGE");
if(figma.currentPage&&figma.currentPage.id==="181:64873")throw new Error("DIALOG-MUST-NOT-WRITE-CALENDAR-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:74742")throw new Error("DIALOG-MUST-NOT-WRITE-CHECKBOX-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:75031")throw new Error("DIALOG-MUST-NOT-WRITE-RADIO-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:75302")throw new Error("DIALOG-MUST-NOT-WRITE-SWITCH-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:75495")throw new Error("DIALOG-MUST-NOT-WRITE-TEXTAREA-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:75801")throw new Error("DIALOG-MUST-NOT-WRITE-ALERT-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:75976")throw new Error("DIALOG-MUST-NOT-WRITE-CHIP-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:76022")throw new Error("DIALOG-MUST-NOT-WRITE-BADGE-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:76063")throw new Error("DIALOG-MUST-NOT-WRITE-AVATAR-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:76109")throw new Error("DIALOG-MUST-NOT-WRITE-LINK-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:76151")throw new Error("DIALOG-MUST-NOT-WRITE-TOOLTIP-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:76193")throw new Error("DIALOG-MUST-NOT-WRITE-TABS-PAGE");
if(figma.currentPage&&figma.currentPage.id==="183:76259")throw new Error("DIALOG-MUST-NOT-WRITE-MENU-PAGE");
...
if(page.id==="218:90598")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V6-PAGE");
if(page.id==="218:88008")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V5-PAGE");
if(page.id==="218:86515")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V4-PAGE");
if(page.id==="218:85033")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V3-PAGE");
if(page.id==="212:81382")throw new Error("DIALOG-MUST-NOT-WRITE-DIALOG-V2-PAGE");
if(page.id==="115:295378")throw new Error("DIALOG-MUST-NOT-WRITE-INPUT-PAGE");
if(page.id==="163:35981")throw new Error("DIALOG-MUST-NOT-WRITE-COMBOBOX-PAGE");
if(page.id==="183:70641")throw new Error("DIALOG-MUST-NOT-WRITE-COMBOBOX-V42-PAGE");
if(page.id==="183:69150")throw new Error("DIALOG-MUST-NOT-WRITE-BUTTON-PAGE");
if(page.id==="85:6781")throw new Error("DIALOG-MUST-NOT-WRITE-PRESERVED-BUTTON-PAGE");
if(page.id==="173:48924")throw new Error("DIALOG-MUST-NOT-WRITE-TABLE-PAGE");
if(page.id==="181:64873")throw new Error("DIALOG-MUST-NOT-WRITE-CALENDAR-PAGE");
if(page.id==="183:74742")throw new Error("DIALOG-MUST-NOT-WRITE-CHECKBOX-PAGE");
if(page.id==="183:75031")throw new Error("DIALOG-MUST-NOT-WRITE-RADIO-PAGE");
if(page.id==="183:75302")throw new Error("DIALOG-MUST-NOT-WRITE-SWITCH-PAGE");
if(page.id==="183:75495")throw new Error("DIALOG-MUST-NOT-WRITE-TEXTAREA-PAGE");
if(page.id==="183:75801")throw new Error("DIALOG-MUST-NOT-WRITE-ALERT-PAGE");
if(page.id==="183:75976")throw new Error("DIALOG-MUST-NOT-WRITE-CHIP-PAGE");
if(page.id==="183:76022")throw new Error("DIALOG-MUST-NOT-WRITE-BADGE-PAGE");
if(page.id==="183:76063")throw new Error("DIALOG-MUST-NOT-WRITE-AVATAR-PAGE");
if(page.id==="183:76109")throw new Error("DIALOG-MUST-NOT-WRITE-LINK-PAGE");
if(page.id==="183:76151")throw new Error("DIALOG-MUST-NOT-WRITE-TOOLTIP-PAGE");
if(page.id==="183:76193")throw new Error("DIALOG-MUST-NOT-WRITE-TABS-PAGE");
if(page.id==="183:76259")throw new Error("DIALOG-MUST-NOT-WRITE-MENU-PAGE");
...
const resolveFont=spec=>{
  ...
  if(found.fontName.family!==spec.resolvedFamily||!sameStyle(found.fontName.style,spec.resolvedStyle)||resolution!==spec.resolution)throw new Error("DIALOG-FONT-PROVENANCE-TAMPER:"+found.fontName.family+":"+found.fontName.style);
