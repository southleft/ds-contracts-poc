...
const CLEANUP_PAGE_NAME="Recipe Pivot / Table / 2f9b764f-82a04258-table-v31";
const CLEANUP_RUN_IDENTITY="2f9b764f-82a04258-table-v31";
const CLEANUP_PAGE_OWNER="recipe/table/2f9b764f-82a04258-table-v31";
const CLEANUP_COLLECTION_OWNER="recipe/table/2f9b764f-82a04258-table-v31/variable-collection";
const CLEANUP_ADAPTERS=new Set(["first-party-table-reviewed-v1","material-table-reviewed-v1"]);
const CLEANUP_COLLECTION_NAMES=new Set(["Recipe Table / 2f9b764f-82a04258-table-v31 / first-party-table-reviewed-v1","Recipe Table / 2f9b764f-82a04258-table-v31 / material-table-reviewed-v1"]);
