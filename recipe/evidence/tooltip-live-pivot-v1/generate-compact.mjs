...
const libraries = {
  astryx: {
    ...
    displayName: "Astryx",
    componentLabel: "Astryx Tooltip",
    recipeHash: byAdapter["astryx-tooltip-reviewed-v1"].recipeHash,
    envelopeHash: byAdapter["astryx-tooltip-reviewed-v1"].envelopeHash,
    prefix: "astryx.tooltip",
    ...
    labelFontSize: 14,
    labelLineHeight: 20,
    box: { paddingX: 8, paddingY: 4, radius: 12, borderWidth: 0 },
    rest: {
      boxFill: "#0a1317ff",
      boxBorder: "#00000000",
      boxOpacity: 1,
  ...
  mui: {
    ...
    displayName: "MUI",
    componentLabel: "MUI Tooltip",
    recipeHash: byAdapter["mui-tooltip-reviewed-v1"].recipeHash,
    envelopeHash: byAdapter["mui-tooltip-reviewed-v1"].envelopeHash,
    prefix: "mui.tooltip",
    ...
    labelFontSize: 11,
    labelLineHeight: 0,
    box: { paddingX: 8, paddingY: 4, radius: 4, borderWidth: 0 },
    rest: {
      boxFill: "#616161eb",
      boxBorder: "#00000000",
      boxOpacity: 1,
  ...
  antd: {
    ...
    componentLabel: "Ant Design Tooltip",
    recipeHash: byAdapter["antd-tooltip-reviewed-v1"].recipeHash,
    envelopeHash: byAdapter["antd-tooltip-reviewed-v1"].envelopeHash,
    prefix: "antd.tooltip",
    ...
    labelFontSize: 14,
    labelLineHeight: 22,
    box: { paddingX: 8, paddingY: 6, radius: 6, borderWidth: 0 },
    rest: {
      boxFill: "#000000d9",
      boxBorder: "#00000000",
      boxOpacity: 1,
...
page.name = pageName;
if (signed.includes(page.id)) throw new Error("TOOLTIP-MUST-NOT-WRITE-SIGNED-PAGE:" + page.id);
page.setSharedPluginData(NS, "pageOwner", "recipe/tooltip/" + runIdentity);
