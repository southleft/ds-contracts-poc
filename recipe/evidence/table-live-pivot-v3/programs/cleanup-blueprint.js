...
const CLEANUP_PAGE_NAME="Recipe Pivot / Table / cc811f47-82d19508-table-v3";
const CLEANUP_RUN_IDENTITY="cc811f47-82d19508-table-v3";
const CLEANUP_PAGE_OWNER="recipe/table/cc811f47-82d19508-table-v3";
const CLEANUP_COLLECTION_OWNER="recipe/table/cc811f47-82d19508-table-v3/variable-collection";
const CLEANUP_ADAPTERS=new Set(["first-party-table-reviewed-v1","material-table-reviewed-v1"]);
const CLEANUP_COLLECTION_NAMES=new Set(["Recipe Table / cc811f47-82d19508-table-v3 / first-party-table-reviewed-v1","Recipe Table / cc811f47-82d19508-table-v3 / material-table-reviewed-v1"]);
