...
const adapterIdentity = "mui-link-reviewed-v1";
const recipeHash = "d810f4f22cb942ec2a48930f7d3122f1a41fc4db4ad179cad7356e78b77e2ac5";
const envelopeHash = "d03bd251dafca1440c8be3b3e78e8ddf2162e5506a2d03e41f9e3a91c2033819";
...
const prefix = "mui.link";
const planned = [["FLOAT","mui.link.box-paddingX",0],["FLOAT","mui.link.box-paddingY",0],["FLOAT","mui.link.box-radius",0],["FLOAT","mui.link.box-borderWidth",0],["FLOAT","mui.link.labelFontSize",14],["COLOR","mui.link.rest-boxFill","#00000000"],["COLOR","mui.link.rest-boxBorder","#00000000"],["COLOR","mui.link.rest-label","#1976d2ff"]];
const vars = new Map();
...
const geom = {"labelFontSize":14,"labelLineHeight":0,"lineHeightUnit":"AUTO","decoration":"UNDERLINE","label":"Link","rest":{"boxFill":"#00000000","boxBorder":"#00000000","boxOpacity":1,"label":"#1976d2ff"},"componentLabel":"MUI Link"};
