...
const CLEANUP_PAGE_NAME="Recipe Pivot / Table / cc811f47-82d19508-table-v14";
const CLEANUP_RUN_IDENTITY="cc811f47-82d19508-table-v14";
const CLEANUP_PAGE_OWNER="recipe/table/cc811f47-82d19508-table-v14";
const CLEANUP_COLLECTION_OWNER="recipe/table/cc811f47-82d19508-table-v14/variable-collection";
const CLEANUP_ADAPTERS=new Set(["first-party-table-reviewed-v1","material-table-reviewed-v1"]);
const CLEANUP_COLLECTION_NAMES=new Set(["Recipe Table / cc811f47-82d19508-table-v14 / first-party-table-reviewed-v1","Recipe Table / cc811f47-82d19508-table-v14 / material-table-reviewed-v1"]);
...
if(JSON.stringify(requestedNodeIds)!==JSON.stringify([expectedPageId])||JSON.stringify([...requestedCollectionIds].sort())!==JSON.stringify([...expectedCollectionIds].sort()))throw new Error("TABLE-V2-CLEANUP-EXACT-OWNERSHIP");return{requestedNodeIds,removedNodeIds,requestedCollectionIds,removedCollectionIds,remainingOwnedNodes,remainingOwnedCollections,complete:true};
