...
const V14_NS="ds.contracts.input.recipe.v5";
const V14_PAGE_ID="__WRITER_PAGE_ID__";
const V14_SET_IDS=["__MUI_SET_ID__","__POLARIS_SET_ID__"];
const V14_ROLES=new Set(["input-field/content/placeholder","input-field/content/value"]);
const V14_PARENTS=new Set(["input-field/surface","input-field/content-row"]);
const V14_MARKER="INPUT-TEXT-FILL-TWO-PASS";
const page=await figma.getNodeByIdAsync(V14_PAGE_ID);
if(!page||page.type!=="PAGE")throw new Error("INPUT-V14-RESTORE-PAGE");
if(page.getSharedPluginData(V14_NS,"pageOwner")!=="recipe/input-field/"+"input-live-v14")throw new Error("INPUT-V14-RESTORE-OWNER");
