...
const resolveFont=spec=>{
  ...
  if(found.fontName.family!==spec.resolvedFamily||found.fontName.style!==spec.resolvedStyle||resolution!==spec.resolution)throw new Error("AVATAR-FONT-PROVENANCE-TAMPER:"+found.fontName.family+":"+found.fontName.style);
