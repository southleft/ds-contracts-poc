...
const page=await figma.getNodeByIdAsync("__WRITER_PAGE_ID__"),set=await figma.getNodeByIdAsync("__MUI_SET_ID__"),cell={"index":0,"cellKey":"mui/size=small/state=default/content=placeholder/required=false/adornments=none","source":"mui","adapterIdentity":"material-text-field-reviewed-v1","axes":{"size":"small","state":"default","content":"placeholder","required":"false","adornments":"none"},"strata":{"source":"mui","state":"default","adornment":"none"},"reference":{"path":"recipe/evidence/input-field-comparison-v3/source-reference/cell-5f8248559a93c093fa08.png","sha256":"aefcc710833dd60c4206a22667ee7724293b54f3b48ffff6309f6b786ac6bcc8","width":486,"height":232,"contentBox":{"width":195,"height":68.90625}},"legacy":{"geometry":0.2197669298218354,"perceptual":0.11154858647604134,"pixelInk":0.11154858647604134}};
...
try{
 ...
 if(bytes.byteLength>1500000)throw new Error("INPUT-V6-CAPTURE-SIZE:"+bytes.byteLength);
