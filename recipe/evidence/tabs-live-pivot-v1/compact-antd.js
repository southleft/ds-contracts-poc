...
const adapterIdentity = "antd-tabs-reviewed-v1";
const recipeHash = "20e729469b8ff036fd9a9584feaa5b02c06d8ab2ccec64329b2293008cb4c828";
const envelopeHash = "a15635b4fb7daf7af7fe0b1794ddb6f12aec90ab7b40d69753837dc02c869355";
...
const selectedResolved = await resolvePainted({"requestedFamily":"-apple-system","requestedStyle":"Regular","resolvedFamily":"SF Pro","resolvedStyle":"Regular","resolution":"fallback","fallbackChain":[{"family":"-apple-system","style":"Regular"},{"family":"SF Pro","style":"Regular"},{"family":"Segoe UI","style":"Regular"},{"family":"Roboto","style":"Regular"},{"family":"Helvetica Neue","style":"Regular"},{"family":"Arial","style":"Regular"}],"degradation":"antd --font-family is a CSS stack; Figma cannot load it; first named host font is SF Pro Regular"});
...
const prefix = "antd.tabs";
const planned = [["FLOAT","antd.tabs.list-itemSpacing",32],["FLOAT","antd.tabs.tab-paddingX",0],["FLOAT","antd.tabs.tab-paddingY",12],["FLOAT","antd.tabs.tab-radius",0],["COLOR","antd.tabs.tab-fill","#00000000"],["FLOAT","antd.tabs.indicator-height",2],["FLOAT","antd.tabs.indicator-radius",0],["COLOR","antd.tabs.indicator-fill","#1677ffff"],["FLOAT","antd.tabs.labelFontSize",14],["FLOAT","antd.tabs.labelLineHeight",22],["COLOR","antd.tabs.rest-label","#000000e0"],["COLOR","antd.tabs.selected-label","#1677ffff"]];
const vars = new Map();
...
const geom = {"labelFontSize":14,"labelLineHeight":22,"lineHeightUnit":"PIXELS","textCase":"ORIGINAL","selected":"Item One","rest":"Item Two","list":{"itemSpacing":32},"tab":{"paddingX":0,"paddingY":12,"radius":0,"minWidth":0,"minHeight":0,"fill":"#00000000"},"indicator":{"height":2,"radius":0,"opacity":1,"fill":"#1677ffff"},"colors":{"rest":"#000000e0","selected":"#1677ffff"},"componentLabel":"Ant Design Tabs"};
