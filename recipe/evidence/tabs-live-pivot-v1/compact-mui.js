...
const adapterIdentity = "mui-tabs-reviewed-v1";
const recipeHash = "b5d949f6cbd5217607ca9e943912c806138c723431ff6a5a5a6d883640cf478a";
const envelopeHash = "09c97abb84ebe92b2888885e0702564912cb781dfd8c4fb6ad1a65708cf59283";
...
const restResolved = await resolvePainted({"requestedFamily":"Roboto","requestedStyle":"Medium","resolvedFamily":"Roboto","resolvedStyle":"Medium","resolution":"requested","fallbackChain":[{"family":"Roboto","style":"Medium"},{"family":"Helvetica","style":"Bold"},{"family":"Arial","style":"Bold"}]});
const selectedResolved = await resolvePainted({"requestedFamily":"Roboto","requestedStyle":"Medium","resolvedFamily":"Roboto","resolvedStyle":"Medium","resolution":"requested","fallbackChain":[{"family":"Roboto","style":"Medium"},{"family":"Helvetica","style":"Bold"},{"family":"Arial","style":"Bold"}]});
...
const prefix = "mui.tabs";
const planned = [["FLOAT","mui.tabs.list-itemSpacing",0],["FLOAT","mui.tabs.tab-paddingX",16],["FLOAT","mui.tabs.tab-paddingY",12],["FLOAT","mui.tabs.tab-radius",0],["FLOAT","mui.tabs.tab-minWidth",90],["FLOAT","mui.tabs.tab-minHeight",48],["COLOR","mui.tabs.tab-fill","#00000000"],["FLOAT","mui.tabs.indicator-height",2],["FLOAT","mui.tabs.indicator-radius",0],["COLOR","mui.tabs.indicator-fill","#1976d2ff"],["FLOAT","mui.tabs.labelFontSize",14],["FLOAT","mui.tabs.labelLineHeight",125],["COLOR","mui.tabs.rest-label","#00000099"],["COLOR","mui.tabs.selected-label","#1976d2ff"]];
const vars = new Map();
...
const geom = {"labelFontSize":14,"labelLineHeight":125,"lineHeightUnit":"PERCENT","textCase":"UPPER","selected":"Item One","rest":"Item Two","list":{"itemSpacing":0},"tab":{"paddingX":16,"paddingY":12,"radius":0,"minWidth":90,"minHeight":48,"fill":"#00000000"},"indicator":{"height":2,"radius":0,"opacity":1,"fill":"#1976d2ff"},"colors":{"rest":"#00000099","selected":"#1976d2ff"},"componentLabel":"MUI Tabs"};
