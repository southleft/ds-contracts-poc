...
const adapterIdentity = "mui-menu-reviewed-v1";
const recipeHash = "9f1933de429f55ce16a333c2a31974995ceeac34e62a475511969932c9af24db";
const envelopeHash = "c2b8a833124b43041821515654dd99c3cb50ef2b5c60e18cf5ddb0bb856481ac";
...
const spec = {"requestedFamily":"Roboto","requestedStyle":"Regular","resolvedFamily":"Roboto","resolvedStyle":"Regular","resolution":"requested","fallbackChain":[{"family":"Roboto","style":"Regular"},{"family":"Helvetica","style":"Regular"},{"family":"Arial","style":"Regular"}]};
...
const planned = [["FLOAT","mui.menu.panel-padding",0],["FLOAT","mui.menu.panel-radius",4],["FLOAT","mui.menu.panel-itemSpacing",0],["COLOR","mui.menu.panel-fill","#ffffffff"],["FLOAT","mui.menu.item-paddingX",16],["FLOAT","mui.menu.item-paddingY",6],["FLOAT","mui.menu.item-minHeight",48],["COLOR","mui.menu.item-fill","#00000000"],["FLOAT","mui.menu.labelFontSize",16],["FLOAT","mui.menu.labelLineHeight",24],["COLOR","mui.menu.label","#000000de"]];
const vars = new Map();
...
const prefix = "mui.menu";
const geom = {"adapterIdentity":"mui-menu-reviewed-v1","displayName":"MUI","componentLabel":"MUI Menu","prefix":"mui.menu","recipeHash":"9f1933de429f55ce16a333c2a31974995ceeac34e62a475511969932c9af24db","envelopeHash":"c2b8a833124b43041821515654dd99c3cb50ef2b5c60e18cf5ddb0bb856481ac","fontSize":16,"lineHeight":24,"label":"#000000de","panel":{"padding":0,"radius":4,"gap":0,"fill":"#ffffffff"},"item":{"paddingX":16,"paddingY":6,"minHeight":48,"fill":"#00000000"}};
