...
const astryxLabelFont = {
  ...
  degradation:
    "source -apple-system Medium; Figma cannot load a CSS stack; first named host font is SF Pro Medium (zero-glyph; painted Roboto Medium)",
};
...
const libraries = {
  astryx: {
    ...
    displayName: "Astryx",
    componentLabel: "Astryx Token",
    recipeHash: byAdapter["astryx-chip-reviewed-v1"].recipeHash,
    envelopeHash: byAdapter["astryx-chip-reviewed-v1"].envelopeHash,
    prefix: "astryx.chip",
  ...
  mui: {
    ...
    displayName: "MUI",
    componentLabel: "MUI Chip",
    recipeHash: byAdapter["mui-chip-reviewed-v1"].recipeHash,
    envelopeHash: byAdapter["mui-chip-reviewed-v1"].envelopeHash,
    prefix: "mui.chip",
  ...
  antd: {
    ...
    componentLabel: "Ant Design Tag",
    recipeHash: byAdapter["antd-chip-reviewed-v1"].recipeHash,
    envelopeHash: byAdapter["antd-chip-reviewed-v1"].envelopeHash,
    prefix: "antd.chip",
