...
const adapterIdentity = "mui-chip-reviewed-v1";
const recipeHash = "d960c0d44fe096083e7d434c72bc33f7b1126fef178f7686abb9216a0f4fcdd3";
const envelopeHash = "59f97b861650da6794fede49fc3f518df1d4aba52a5da2440b657049076091ae";
...
const prefix = "mui.chip";
const planned = [["FLOAT","mui.chip.box-height",32],["FLOAT","mui.chip.box-paddingX",12],["FLOAT","mui.chip.box-paddingY",0],["FLOAT","mui.chip.box-radius",16],["FLOAT","mui.chip.box-borderWidth",0],["FLOAT","mui.chip.labelFontSize",13],["FLOAT","mui.chip.labelLineHeight",19.5],["COLOR","mui.chip.rest-boxFill","#00000014"],["COLOR","mui.chip.rest-boxBorder","#00000000"],["COLOR","mui.chip.rest-label","#000000de"]];
const vars = new Map();
...
const geom = {"box":{"height":32,"paddingX":12,"paddingY":0,"radius":16,"borderWidth":0},"labelFontSize":13,"labelLineHeight":19.5,"strokeAlign":"INSIDE","label":"Tag","rest":{"boxFill":"#00000014","boxBorder":"#00000000","boxOpacity":1,"label":"#000000de"},"componentLabel":"MUI Chip"};
