...
const V15_NS="ds.contracts.input.recipe.v5";
const V15_PAGE_ID="__WRITER_PAGE_ID__";
const V15_SET_IDS=["__MUI_SET_ID__","__POLARIS_SET_ID__"];
const V15_ROLES=new Set(["input-field/content/placeholder","input-field/content/value"]);
const V15_PARENTS=new Set(["input-field/surface","input-field/content-row"]);
const V15_MARKER="INPUT-TEXT-FILL-MEASURE-VISIBLE";
const page=await figma.getNodeByIdAsync(V15_PAGE_ID);
if(!page||page.type!=="PAGE")throw new Error("INPUT-V15-RESTORE-PAGE");
if(page.getSharedPluginData(V15_NS,"pageOwner")!=="recipe/input-field/"+"input-live-v15")throw new Error("INPUT-V15-RESTORE-OWNER");
