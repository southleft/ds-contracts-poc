...
const CLEANUP_PAGE_NAME="Recipe Pivot / Calendar / da4456d8-calendar-v30";
const CLEANUP_RUN_IDENTITY="da4456d8-calendar-v30";
const CLEANUP_PAGE_OWNER="recipe/calendar/da4456d8-calendar-v30";
const CLEANUP_COLLECTION_OWNER="recipe/calendar/da4456d8-calendar-v30/variable-collection";
const CLEANUP_ADAPTERS=new Set(["astryx-calendar-reviewed-v1"]);
const CLEANUP_COLLECTION_NAMES=new Set(["Recipe Calendar / da4456d8-calendar-v30 / astryx-calendar-reviewed-v1"]);
