...
const libraries = {
  ...
  mui: {
    ...
    dash: { w: 10, h: 2, r: 0 },
    check: {
      path: "M0 0 L24 0 L24 24 L0 24 Z M10 17 L5 12 L6.41 10.59 L10 14.17 L17.59 6.58 L19 8 Z",
      w: 24,
      h: 24,
      stroke: 0,
      paint: "fill",
    ...
    cells: {
      ...
      "checked/false": { box: "#ffffffff", border: "#00000000", op: 1, label: "#000000de", dash: "#00000000", check: "#1976d2ff" },
      "checked/true": { box: "#ffffffff", border: "#00000000", op: 1, label: "#00000061", dash: "#00000000", check: "#00000042" },
  ...
  antd: {
    ...
    dash: { w: 8, h: 2, r: 0 },
    check: {
      path: "M7.677 0.000 L2.626 5.051 L0.000 2.424",
      w: 7.677,
      h: 5.051,
      stroke: 2,
      paint: "stroke",
...
arrange.name="Arrange / Checkbox / ${lib.displayName} / "+runIdentity;
...
review.name="Review / Checkbox / ${lib.displayName} / "+runIdentity;
