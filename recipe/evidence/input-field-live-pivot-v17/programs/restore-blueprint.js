...
const V17_NS="ds.contracts.input.recipe.v5";
const V17_PAGE_ID="__WRITER_PAGE_ID__";
const V17_SET_IDS=["__MUI_SET_ID__","__POLARIS_SET_ID__"];
const V17_ROLES=new Set(["input-field/content/placeholder","input-field/content/value"]);
const V17_PARENTS=new Set(["input-field/surface","input-field/content-row"]);
const V17_MARKER="INPUT-TEXT-FILL-MEASURE-VISIBLE";
const page=await figma.getNodeByIdAsync(V17_PAGE_ID);
if(!page||page.type!=="PAGE")throw new Error("INPUT-V17-RESTORE-PAGE");
if(page.getSharedPluginData(V17_NS,"pageOwner")!=="recipe/input-field/"+"input-live-v17")throw new Error("INPUT-V17-RESTORE-OWNER");
