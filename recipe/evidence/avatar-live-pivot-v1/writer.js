...
for(const source of PLAN.sources){
  ...
  const mintComponent=async(ir)=>{
    ...
    for(const [childIndex,child] of ir.children.entries())await render(child,component,"avatar/children/"+childIndex);
