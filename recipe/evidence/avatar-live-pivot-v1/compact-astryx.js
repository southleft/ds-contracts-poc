...
const adapterIdentity = "astryx-avatar-reviewed-v1";
const recipeHash = "8b6f943a530d5004a52c12d8bc3b2743c04790d28bf16ac35ef4a50a15b834fe";
const envelopeHash = "9ba9d9f104544a5f7cb7d454666797cd9ea4766aa859efdcf9a9a50035701808";
...
const labelResolved = await resolvePainted({"requestedFamily":"-apple-system","requestedStyle":"Medium","resolvedFamily":"SF Pro","resolvedStyle":"Medium","resolution":"fallback","fallbackChain":[{"family":"-apple-system","style":"Medium"},{"family":"SF Pro","style":"Medium"},{"family":"Segoe UI","style":"Semibold"},{"family":"Roboto","style":"Medium"},{"family":"Helvetica","style":"Bold"},{"family":"Arial","style":"Bold"}],"degradation":"source -apple-system Medium; Figma cannot load a CSS stack; first named host font is SF Pro Medium"});
...
const prefix = "astryx.avatar";
const planned = [["FLOAT","astryx.avatar.box-height",36],["FLOAT","astryx.avatar.box-paddingX",0],["FLOAT","astryx.avatar.box-paddingY",0],["FLOAT","astryx.avatar.box-radius",9999],["FLOAT","astryx.avatar.box-borderWidth",0],["FLOAT","astryx.avatar.labelFontSize",14.4],["FLOAT","astryx.avatar.labelLineHeight",14.4],["COLOR","astryx.avatar.rest-boxFill","#0536591a"],["COLOR","astryx.avatar.rest-boxBorder","#00000000"],["COLOR","astryx.avatar.rest-label","#4e606fff"]];
const vars = new Map();
...
const geom = {"box":{"height":36,"paddingX":0,"paddingY":0,"radius":9999,"borderWidth":0},"labelFontSize":14.4,"labelLineHeight":14.4,"strokeAlign":"INSIDE","label":"JD","rest":{"boxFill":"#0536591a","boxBorder":"#00000000","boxOpacity":1,"label":"#4e606fff"},"componentLabel":"Astryx Avatar"};
