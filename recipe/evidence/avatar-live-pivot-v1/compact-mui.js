...
const adapterIdentity = "mui-avatar-reviewed-v1";
const recipeHash = "0b73c85a12e030b2036500d8a3ae401d9a2774611b30a83a9eedb1dd1e07832f";
const envelopeHash = "b5beafe658b9b46be1a194ce5bf56c2c7276a3857db15100fee65f3142967ce3";
...
const prefix = "mui.avatar";
const planned = [["FLOAT","mui.avatar.box-height",40],["FLOAT","mui.avatar.box-paddingX",0],["FLOAT","mui.avatar.box-paddingY",0],["FLOAT","mui.avatar.box-radius",20],["FLOAT","mui.avatar.box-borderWidth",0],["FLOAT","mui.avatar.labelFontSize",20],["FLOAT","mui.avatar.labelLineHeight",20],["COLOR","mui.avatar.rest-boxFill","#bdbdbdff"],["COLOR","mui.avatar.rest-boxBorder","#00000000"],["COLOR","mui.avatar.rest-label","#ffffffff"]];
const vars = new Map();
...
const geom = {"box":{"height":40,"paddingX":0,"paddingY":0,"radius":20,"borderWidth":0},"labelFontSize":20,"labelLineHeight":20,"strokeAlign":"INSIDE","label":"JD","rest":{"boxFill":"#bdbdbdff","boxBorder":"#00000000","boxOpacity":1,"label":"#ffffffff"},"componentLabel":"MUI Avatar"};
