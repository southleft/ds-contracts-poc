...
const V22_NS="ds.contracts.input.recipe.v5";
const V22_PAGE_ID="__WRITER_PAGE_ID__";
const V22_SET_IDS=["__MUI_SET_ID__","__POLARIS_SET_ID__"];
const V22_ROLES=new Set(["input-field/content/placeholder","input-field/content/value"]);
const V22_PARENTS=new Set(["input-field/surface","input-field/content-row"]);
const V22_MARKER="INPUT-TEXT-FILL-MEASURE-VISIBLE";
const page=await figma.getNodeByIdAsync(V22_PAGE_ID);
if(!page||page.type!=="PAGE")throw new Error("INPUT-V22-RESTORE-PAGE");
if(page.getSharedPluginData(V22_NS,"pageOwner")!=="recipe/input-field/"+"input-live-v22")throw new Error("INPUT-V22-RESTORE-OWNER");
