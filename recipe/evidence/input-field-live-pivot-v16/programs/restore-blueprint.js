...
const V16_NS="ds.contracts.input.recipe.v5";
const V16_PAGE_ID="__WRITER_PAGE_ID__";
const V16_SET_IDS=["__MUI_SET_ID__","__POLARIS_SET_ID__"];
const V16_ROLES=new Set(["input-field/content/placeholder","input-field/content/value"]);
const V16_PARENTS=new Set(["input-field/surface","input-field/content-row"]);
const V16_MARKER="INPUT-TEXT-FILL-MEASURE-VISIBLE";
const page=await figma.getNodeByIdAsync(V16_PAGE_ID);
if(!page||page.type!=="PAGE")throw new Error("INPUT-V16-RESTORE-PAGE");
if(page.getSharedPluginData(V16_NS,"pageOwner")!=="recipe/input-field/"+"input-live-v16")throw new Error("INPUT-V16-RESTORE-OWNER");
