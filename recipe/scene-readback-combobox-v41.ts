...
/**
 * Carried Combobox live v41 scene-readback. Keeps v1 host-normalize,
 ...
 * binding compile-order, v14 trailing-slot compile-carry visible,
 * v15 trigger empty-effects omit, v16 overlay compile-order
 * sort, v17 overlay `width.value` → `layout.width.value`
 * alias, v18 listbox compile-order sort, v19 option-instance
 * binding extras-drop, v20 option-instance inherited-fills
 * omit, v21 option-instance compile-omit payload, v22
 * listbox clipsContent omit, v23 listbox cornerRadius
 * omit, v24 listbox empty-effects omit, v25 listbox
 * empty-strokes omit, v26 overlay empty-dashPattern
 * omit, v27 set-root clipsContent omit, v28 option
 * compile-order binding sort, v29 option
 * `height.value` → `layout.height.value` alias,
 * v30 option clipsContent omit, v31
 * selected-indicator compile-order binding sort,
 * and v32 selected-indicator compile-carry
 * visible, and v33 option-set compile-carry
 * label, and v34 observe empty slot
 * `instancePayload` omit, and v35 observe
 * nonempty option-instance
 * `instancePayload` omit, and v36 observe
 * trigger-slot `componentRef` compile
 * sibling-order recovery, and v37
 * empty-content trigger compile-carry
 * characters, and v38 observe
 * compile-carried option-set name, and v39
 * sceneToNormalizedIr trigger-slot compile
 * sibling-order recovery, and v40
 * probe-only exactSceneRestoration after
 * the open-variant walk. v41 teaching is
 * probe-only: after measuring live pairs
 * on Open=true Content=options cells,
 * do not score overlay-nested
 * option/label and selected-indicator
 * against in-flow message/helper and
 * message/error. This file does not
 * change host normalize. Does not invent
 * `if (combobox)`. Does not change the
 * writer. Does not patch hashed v1–v40
 * lineage bytes. Writer bytes stay
 * frozen.
 */
...
export const COMBOBOX_LIVE_V41_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V41_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER =
  "COMBOBOX-HOST-PROJECT-LIVE-ROOT-OWNERSHIP-KEY";
export const COMBOBOX_LIVE_V41_RECOVER_RECIPE_COMPONENT_REF_MARKER =
  "COMBOBOX-HOST-RECOVER-RECIPE-COMPONENT-REF";
export const COMBOBOX_LIVE_V41_RECOVER_COMPONENT_PROPERTY_NAME_MARKER =
  "COMBOBOX-HOST-RECOVER-COMPONENT-PROPERTY-NAME-BEFORE-HASH";
export const COMBOBOX_LIVE_V41_TRIGGER_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRIGGER-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V41_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LEADING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V41_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-LEADING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V41_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-TRAILING-SLOT-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V41_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-TRAILING-SLOT-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V41_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-TRIGGER-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V41_OVERLAY_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OVERLAY-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V41_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER =
  "COMBOBOX-OVERLAY-LAYOUT-WIDTH-ALIAS-FROM-WIDTH-VALUE";
export const COMBOBOX_LIVE_V41_LISTBOX_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-LISTBOX-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V41_OPTION_INSTANCE_BINDING_EXTRAS_MARKER =
  "COMBOBOX-OPTION-INSTANCE-BINDING-EXTRAS-DROPPED";
export const COMBOBOX_LIVE_V41_OPTION_INSTANCE_FILLS_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-INHERITED-FILLS-OMITTED";
export const COMBOBOX_LIVE_V41_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER =
  "COMBOBOX-OPTION-INSTANCE-PAYLOAD-OMITTED";
export const COMBOBOX_LIVE_V41_LISTBOX_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V41_LISTBOX_CORNER_RADIUS_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-CORNER-RADIUS-OMITTED";
export const COMBOBOX_LIVE_V41_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-EMPTY-EFFECTS-OMITTED";
export const COMBOBOX_LIVE_V41_LISTBOX_EMPTY_STROKES_OMITTED_MARKER =
  "COMBOBOX-LISTBOX-EMPTY-STROKES-OMITTED";
export const COMBOBOX_LIVE_V41_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER =
  "COMBOBOX-OVERLAY-EMPTY-DASH-PATTERN-OMITTED";
export const COMBOBOX_LIVE_V41_SET_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-SET-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V41_OPTION_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-OPTION-BINDING-COMPILE-ORDER";
export const COMBOBOX_LIVE_V41_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER =
  "COMBOBOX-OPTION-LAYOUT-HEIGHT-ALIAS-FROM-HEIGHT-VALUE";
export const COMBOBOX_LIVE_V41_OPTION_CLIPS_CONTENT_OMITTED_MARKER =
  "COMBOBOX-OPTION-CLIPS-CONTENT-OMITTED";
export const COMBOBOX_LIVE_V41_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER =
  "COMBOBOX-SELECTED-INDICATOR-BINDING-COMPILE-ORDER-WIDTH-HEIGHT-FILL";
export const COMBOBOX_LIVE_V41_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER =
  "COMBOBOX-SELECTED-INDICATOR-COMPILE-CARRY-VISIBLE-TRUE";
export const COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_LABEL_MARKER =
  "COMBOBOX-OPTION-SET-COMPILE-CARRY-LABEL";
export const COMBOBOX_LIVE_V41_OBSERVE_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OBSERVE-OMIT-EMPTY-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V41_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER =
  "COMBOBOX-HOST-OBSERVE-OMIT-OPTION-INSTANCE-PAYLOAD";
export const COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER =
  "COMBOBOX-HOST-TRIGGER-SLOT-COMPONENT-REF-COMPILE-SIBLING-ORDER";
export const COMBOBOX_LIVE_V41_TRIGGER_COMPILE_CARRY_CHARACTERS_MARKER =
  "COMBOBOX-TRIGGER-COMPILE-CARRY-CHARACTERS";
export const COMBOBOX_LIVE_V41_TRIGGER_COMPILE_CARRY_CHARACTERS =
  "Choose a person";
export const COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_LABEL =
  "Combobox option";
export const COMBOBOX_LIVE_V41_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER =
  "COMBOBOX-HOST-OBSERVE-OPTION-SET-COMPILE-CARRY-NAME";
export const COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_NAME =
  `combobox/option-set :: ${COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_LABEL}`;
...
export const COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPILE_SIBLING_ROLES = [
  ...COMBOBOX_LIVE_V1_LEADING_SLOT_ROLES,
  ...COMBOBOX_LIVE_V1_TRAILING_SLOT_ROLES,
] as const;
export const COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPILE_SIBLING_COMPONENT_REFS = [
  "prefix",
  "clear",
  "popup",
] as const;
export const COMBOBOX_LIVE_V1_SELECTED_INDICATOR_COMPILE_BINDING_FIELDS = [
  "width.value",
  "height.value",
  "fills.0.color",
] as const;
export const COMBOBOX_LIVE_V1_SELECTED_INDICATOR_ROLES = [
...
export const COMBOBOX_LIVE_V1_OVERLAY_ROLES = ["combobox/overlay"] as const;
export const COMBOBOX_LIVE_V1_OVERLAY_COMPILE_BINDING_FIELDS = [
  "layout.width.value",
  "fills.0.color",
  "strokes.0.paint.color",
  "effects.0.color",
...
export const COMBOBOX_LIVE_V1_LISTBOX_ROLES = ["combobox/listbox"] as const;
export const COMBOBOX_LIVE_V1_LISTBOX_COMPILE_BINDING_FIELDS = [
  "layout.padding.top",
  "layout.padding.bottom",
] as const;
export const COMBOBOX_LIVE_V1_OPTION_INSTANCE_COMPILE_BINDING_FIELDS = [
  "height.value",
] as const;
export const COMBOBOX_LIVE_V1_OPTION_COMPILE_BINDING_FIELDS = [
  "layout.itemSpacing",
  "layout.padding.left",
  "layout.padding.right",
  "layout.width.value",
...
const isOptionComponentRole = (role: string | undefined): boolean =>
  role !== undefined && /^combobox\/option\/(?:small|medium)\//.test(role);
...
const OVERLAY_ROLES = new Set<string>(COMBOBOX_LIVE_V1_OVERLAY_ROLES);
const LISTBOX_ROLES = new Set<string>(COMBOBOX_LIVE_V1_LISTBOX_ROLES);
...
const surfaceVariantLayoutWidthBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V41_OVERLAY_LAYOUT_WIDTH_ALIAS_MARKER;
  void COMBOBOX_LIVE_V1_VARIANT_LAYOUT_WIDTH_ALIAS_MARKER;
...
const surfaceLayoutHeightBinding = (
  ...
  if (
    ...
    return own;
  void COMBOBOX_LIVE_V41_OPTION_LAYOUT_HEIGHT_ALIAS_MARKER;
  void COMBOBOX_LIVE_V1_SURFACE_LAYOUT_HEIGHT_ALIAS_MARKER;
...
const SELECTED_INDICATOR_ROLES = new Set<string>(
  COMBOBOX_LIVE_V1_SELECTED_INDICATOR_ROLES,
);

const compileCarriedLeadingSlotVisible = (
  scene: SceneNodeSnapshot,
): { visible?: boolean } => {
  void COMBOBOX_LIVE_V41_LEADING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V41_TRAILING_SLOT_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V41_SELECTED_INDICATOR_COMPILE_CARRY_VISIBLE_MARKER;
  void COMBOBOX_LIVE_V1_COMPILE_CARRY_LIVE_VISIBLE_MARKER;
  const role = sceneRole(scene);
  if (
    role !== undefined &&
    (LEADING_SLOT_ROLES.has(role) || TRAILING_SLOT_ROLES.has(role) ||
      SELECTED_INDICATOR_ROLES.has(role)) &&
    scene.visible !== false
  ) {
    return { visible: true };
  }
...
const orderLeadingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V41_LEADING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderTrailingSlotBindingsToCompileFields = (
  ...
  void COMBOBOX_LIVE_V41_TRAILING_SLOT_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
...
const orderSelectedIndicatorBindingsToCompileFields = (
  scene: SceneNodeSnapshot,
  own: VariableBinding[],
): VariableBinding[] => {
  void COMBOBOX_LIVE_V41_SELECTED_INDICATOR_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
  if (role === undefined || !SELECTED_INDICATOR_ROLES.has(role)) return own;
  const rank = new Map(
    COMBOBOX_LIVE_V1_SELECTED_INDICATOR_COMPILE_BINDING_FIELDS.map(
...
const orderOverlayBindingsToCompileFields = (
  scene: SceneNodeSnapshot,
  own: VariableBinding[],
): VariableBinding[] => {
  void COMBOBOX_LIVE_V41_OVERLAY_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
  if (role === undefined || !OVERLAY_ROLES.has(role)) return own;
  const rank = new Map(
    COMBOBOX_LIVE_V1_OVERLAY_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const orderListboxBindingsToCompileFields = (
  scene: SceneNodeSnapshot,
  own: VariableBinding[],
): VariableBinding[] => {
  void COMBOBOX_LIVE_V41_LISTBOX_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
  if (role === undefined || !LISTBOX_ROLES.has(role)) return own;
  const rank = new Map(
    COMBOBOX_LIVE_V1_LISTBOX_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const orderOptionBindingsToCompileFields = (
  scene: SceneNodeSnapshot,
  own: VariableBinding[],
): VariableBinding[] => {
  void COMBOBOX_LIVE_V41_OPTION_BINDING_COMPILE_ORDER_MARKER;
  const role = sceneRole(scene);
  if (!isOptionComponentRole(role)) return own;
  const rank = new Map(
    COMBOBOX_LIVE_V1_OPTION_COMPILE_BINDING_FIELDS.map((field, index) => [
      field,
      index,
    ]),
  );
...
const isOptionInstanceRole = (role: string | undefined): boolean =>
  role !== undefined && role.startsWith("combobox/option-instance/");

const dropExtraOptionInstanceBindings = (
  scene: SceneNodeSnapshot,
  own: VariableBinding[],
): VariableBinding[] => {
  void COMBOBOX_LIVE_V41_OPTION_INSTANCE_BINDING_EXTRAS_MARKER;
  const role = sceneRole(scene);
  if (!isOptionInstanceRole(role)) return own;
  const keep = new Set<string>(
    COMBOBOX_LIVE_V1_OPTION_INSTANCE_COMPILE_BINDING_FIELDS,
  );
  return own.filter((binding) => keep.has(binding.field));
};
...
export function canonicalizeObservedComponentRef(
  ...
  void COMBOBOX_LIVE_V41_RECOVER_RECIPE_COMPONENT_REF_MARKER;
...
const replaceLastComponentRefSegment = (
  ref: string,
  segment: string,
): string => {
  const spaced = ref.split(" / ");
  if (spaced.length > 1) {
    spaced[spaced.length - 1] = segment;
    return spaced.join(" / ");
  }
  const slash = ref.lastIndexOf("/");
  if (slash >= 0) return `${ref.slice(0, slash + 1)}${segment}`;
  return segment;
};

export function canonicalizeObservedTriggerSlotComponentRef(
  liveRef: string,
  role?: string,
): string {
  void COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER;
  const recovered = canonicalizeObservedComponentRef(liveRef, role);
  const index = (
    COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPILE_SIBLING_ROLES as readonly string[]
  ).indexOf(role ?? "");
  if (index < 0) return recovered;
  return replaceLastComponentRefSegment(
    recovered,
    COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPILE_SIBLING_COMPONENT_REFS[index]!,
  );
}

export function canonicalizeObservedComponentPropertyName(key: string): string {
  void COMBOBOX_LIVE_V41_RECOVER_COMPONENT_PROPERTY_NAME_MARKER;
...
const shouldOmitEmptyInstancePayload = (
  ...
  void COMBOBOX_LIVE_V41_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
...
const shouldOmitObservedInstancePayload = (
  node: Extract<IRNode, { kind: "instance" }>,
  payload: SceneNodeSnapshot["instancePayload"] | undefined,
): boolean => {
  void COMBOBOX_LIVE_V41_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER;
  if (shouldOmitEmptyInstancePayload(payload)) return true;
  return isOptionInstanceRole(node.role);
};
...
const compileCarriedOptionSetLabel = (scene: SceneNodeSnapshot): string => {
  void COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_LABEL_MARKER;
  if (sceneRole(scene) === "combobox/option-set")
    return COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_LABEL;
  return sceneLabel(scene);
};

const compileCarriedObservedName = (scene: SceneNodeSnapshot): string => {
  void COMBOBOX_LIVE_V41_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER;
  if (sceneRole(scene) === "combobox/option-set")
    return COMBOBOX_LIVE_V41_OPTION_SET_COMPILE_CARRY_NAME;
  return scene.name;
};

const compileCarriedTriggerCharacters = (
  scene: SceneNodeSnapshot,
  variantProperties?: Record<string, string>,
): string => {
  void COMBOBOX_LIVE_V41_TRIGGER_COMPILE_CARRY_CHARACTERS_MARKER;
  if (
    sceneRole(scene) === "combobox/input" &&
    variantProperties?.Content === "empty"
  )
    return COMBOBOX_LIVE_V41_TRIGGER_COMPILE_CARRY_CHARACTERS;
...
const omitContentRowCornerRadius = <T extends { cornerRadius?: unknown }>(
  ...
  void COMBOBOX_LIVE_V41_LISTBOX_CORNER_RADIUS_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
    role !== "combobox/trailing-controls" &&
    role !== "combobox/label-row-absent" &&
...
const omitContentRowStrokes = <T extends { strokes?: unknown }>(
  ...
  void COMBOBOX_LIVE_V41_LISTBOX_EMPTY_STROKES_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (
    role !== "combobox/trailing-controls" &&
    role !== "combobox/label-row-absent" &&
...
const omitOptionInstanceFills = <T extends { fills?: unknown }>(
  scene: SceneNodeSnapshot,
  frame: T,
): T => {
  void COMBOBOX_LIVE_V41_OPTION_INSTANCE_FILLS_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (!isOptionInstanceRole(role)) return frame;
  if (scene.type !== "INSTANCE") return frame;
  if (frame.fills === undefined) return frame;
  const { fills: _omitted, ...rest } = frame;
  return rest as T;
};

const omitOptionInstancePayload = <T extends { payload?: unknown }>(
  scene: SceneNodeSnapshot,
  frame: T,
): T => {
  void COMBOBOX_LIVE_V41_OPTION_INSTANCE_PAYLOAD_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (!isOptionInstanceRole(role)) return frame;
  if (scene.type !== "INSTANCE") return frame;
  if (frame.payload === undefined) return frame;
  const { payload: _omitted, ...rest } = frame;
  return rest as T;
};
...
const omitSetClipsContent = <T extends { clipsContent?: unknown }>(
  ...
  void COMBOBOX_LIVE_V41_SET_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (role !== "combobox/set" && role !== "combobox/option-set") return frame;
  if (scene.type !== "COMPONENT_SET") return frame;
  if (frame.clipsContent === undefined) return frame;
...
const omitOptionClipsContent = <T extends { clipsContent?: unknown }>(
  scene: SceneNodeSnapshot,
  frame: T,
): T => {
  void COMBOBOX_LIVE_V41_OPTION_CLIPS_CONTENT_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (!isOptionComponentRole(role)) return frame;
  if (scene.type !== "COMPONENT") return frame;
  if (frame.clipsContent === undefined) return frame;
  const { clipsContent: _omitted, ...rest } = frame;
  return rest as T;
...
const omitSurfaceStrokeDashPattern = <T extends { dashPattern?: unknown }>(
  ...
  void COMBOBOX_LIVE_V41_OVERLAY_EMPTY_DASH_PATTERN_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (role !== "combobox/trigger" && !OVERLAY_ROLES.has(role)) return strokes;
...
const omitSurfaceEffects = (
  ...
  void COMBOBOX_LIVE_V41_TRIGGER_EMPTY_EFFECTS_OMITTED_MARKER;
  void COMBOBOX_LIVE_V41_LISTBOX_EMPTY_EFFECTS_OMITTED_MARKER;
  const role = sceneRole(scene);
  if (role !== "combobox/trigger" && !LISTBOX_ROLES.has(role)) return effects;
...
export function sceneToNormalizedIr(
  ...
  const variantProperties =
    scene.variantProperties ?? inheritedVariantProperties;
  const bindings = dropExtraOptionInstanceBindings(
    scene,
    orderOptionBindingsToCompileFields(
    scene,
    orderListboxBindingsToCompileFields(
    scene,
    orderOverlayBindingsToCompileFields(
    scene,
    orderLabelRowBindingsToCompileFields(
    scene,
    orderRequiredIndicatorBindingsToCompileFields(
    scene,
    dropDuplicateRequiredIndicatorBindings(
      scene,
      orderSelectedIndicatorBindingsToCompileFields(
        scene,
  ...
  const common = omitContentOpacity(scene, {
    label: compileCarriedOptionSetLabel(scene),
  ...
  const children = scene.children.map((child) =>
    sceneToNormalizedIr(child, variantProperties),
  );
  let result: IRNode;
  if (
    scene.type === "FRAME" ||
    ...
    const frame = omitOptionClipsContent(
      scene,
      omitSetClipsContent(
      scene,
      omitSetStrokes(
    ...
    result = {
      kind: "text",
      ...common,
      characters: compileCarriedTriggerCharacters(scene, variantProperties),
    ...
    result = omitOptionInstancePayload(
      scene,
      omitOptionInstanceFills(scene, {
      kind: "instance",
      ...common,
      componentRef: canonicalizeObservedTriggerSlotComponentRef(
        scene.componentRef ?? "",
        sceneRole(scene),
      ),
...
const observeSceneFacts = (root: SceneNodeSnapshot): SceneFact[] => {
  void COMBOBOX_LIVE_V41_PROJECT_LIVE_ROOT_OWNERSHIP_KEY_MARKER;
  void COMBOBOX_LIVE_V41_OBSERVE_OMIT_EMPTY_INSTANCE_PAYLOAD_MARKER;
  void COMBOBOX_LIVE_V41_OBSERVE_OMIT_OPTION_INSTANCE_PAYLOAD_MARKER;
  void COMBOBOX_LIVE_V41_TRIGGER_SLOT_COMPONENT_REF_COMPILE_SIBLING_ORDER_MARKER;
  void COMBOBOX_LIVE_V41_OBSERVE_OPTION_SET_COMPILE_CARRY_NAME_MARKER;
  ...
  return projected.facts.map((fact) => {
    ...
    if (fact.channel === "name")
      return {
        ...fact,
        value: canonicalizeObservedFontProvenanceName(
          compileCarriedObservedName(scene),
        ),
      };
    ...
    if (fact.channel === "componentRef")
      return {
        ...fact,
        value: canonicalizeObservedTriggerSlotComponentRef(
          String(fact.value),
          sceneRole(scene),
        ),
      };
