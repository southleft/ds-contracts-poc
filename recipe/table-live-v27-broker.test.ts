...
import { TABLE_LIVE_V27_CAPTURE_COUNT } from "./table-live-v27-contract.js";

test("Table live v27 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V27_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V27_CAPTURE_COUNT, 20);
