...
import { CALENDAR_LIVE_V16_CAPTURE_COUNT } from "./calendar-live-v16-contract.js";

test("Calendar live v16 broker pins Scratch and 8 captures", () => {
  assert.equal(CALENDAR_LIVE_V16_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(CALENDAR_LIVE_V16_CAPTURE_COUNT, 8);
