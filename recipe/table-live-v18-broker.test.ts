...
import { TABLE_LIVE_V18_CAPTURE_COUNT } from "./table-live-v18-contract.js";

test("Table live v18 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V18_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V18_CAPTURE_COUNT, 20);
