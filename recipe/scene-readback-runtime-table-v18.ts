...
/**
 * Table live v18 extract runtime. Keeps the v6 skip of untagged
 * `table/row/owned-cell-label` TEXT bind hosts. Extract bytes are
 * unchanged from v17. The v18 teaching lives in host-normalize
 * (`scene-readback-table-v1.ts`): omit `effects` on
 * `table/set`, `table/row-set`, and `table/cell-set` because compile
 * component-sets omit `effects`. Does not omit `table/variant`
 * `cornerRadius`. Does not invent `effects` onto compile sets.
 */
