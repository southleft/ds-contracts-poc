...
import { TABLE_LIVE_V5_CAPTURE_COUNT } from "./table-live-v5-contract.js";

test("Table live v5 broker pins Scratch and 20 captures", () => {
  assert.equal(TABLE_LIVE_V5_TARGET.fileKey, "byMp6lt0Ij9b2QbkDGFwBh");
  assert.equal(TABLE_LIVE_V5_CAPTURE_COUNT, 20);
