...
<div class="numbers">
  ...
  <div class="number"><div class="number__value">${n.closed}</div><div class="number__label">components whose canvas→code→canvas<br>round trip <em>closed</em> — <a href="#roundtrip">not lossless</a></div></div>
