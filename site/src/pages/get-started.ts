...
ds-contracts onboard --continue     # capture · promote · emit · bundle · publish`, 'bash', 'phase 1 does everything a machine can decide and stops at the one place a human must; phase 2 runs the rest without stopping and ends with the designer clicking "Check for updates" — no JSON on a clipboard')}</p>
