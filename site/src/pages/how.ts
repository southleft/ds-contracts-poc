...
<p class="section-note"><strong>Current state (2026-08-30).</strong> These pages walk the <em>universal-contract</em> engine (<code>core/</code>, Journeys A–C, the playground). That path still ships. The <strong>v1 proof surface is recipe-IR</strong> (five live-minted, owner-signed archetypes); product v1 is incomplete (F1). A playground or how-it-flows replay is not recipe-IR evidence. See <a href="${REPO_URL}/blob/main/docs/32-recipe-ir-pivot.md">docs/32</a>.</p>
