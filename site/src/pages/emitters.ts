...
<ul>
<li><strong>Pure.</strong> Contract + ctx in, file texts out. No filesystem, no network, no globals — every emitter must be browser-importable (the playground still runs these <em>universal-contract</em> emitters; it is not the recipe-IR v1 proof; Current product plan: <a href="/system/">the whole loop</a>).</li>
