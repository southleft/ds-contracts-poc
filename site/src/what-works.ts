...
export function whatWorksData(): WhatWorksData {
  ...
  return {
    ...
    n: {
      ...
      meanEqual: cell(perLibrary, "all libraries", 2),
      cellWeighted: cell(perLibrary, "all libraries", 7),
      cells: cell(perLibrary, "all libraries", 6),
      over90: cell(perLibrary, "all libraries", 4),
      over80: cell(perLibrary, "all libraries", 5),
