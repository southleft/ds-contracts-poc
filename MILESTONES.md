...
| Published spec + CLI | on public npm, stranger-verified: `@ds-contracts/schema` `latest` 16.0.0 / `next` 16.1.0-rc.1 · `@ds-contracts/cli` `latest` 0.4.0 / `next` 0.5.0-rc.1 (source tree ahead at 0.5.0-rc.2, unpublished) · `@ds-contracts/emitter-web-components` `latest` 0.3.0 / `next` 0.4.0-rc.1 | `cli-smoke` eval (byte-stable double run from scratch) |
