...
- ✅ **The coverage fraction is published with its denominators** — the 113 covered components are **11.1%** of the 1015 in the seven libraries with a measured size ([docs/24 §2](docs/24-what-works.md)). It belongs on the roadmap because it defines what "adoption" currently means: *a hand-picked slice, configured by an expert, one round per novel styling method.*
