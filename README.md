...
| `evals/` | 37 deterministic checks on the machinery itself: byte-identical regeneration, refusal of illegal contracts, detection of every claimed drift class, convergence after promotion. | ✅ |
...
npm run eval     # ④ 37 checks that detection, refusal, and convergence still hold
```
