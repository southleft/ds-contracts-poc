...
export const POST_V1_ENTRIES = Object.freeze([
  ...
  '**Known fidelity and reader ceilings:** text wrapping and webfont metrics (per-library `fonts` loading exists; metrics stay fallback wherever unconfigured), multi-axis geometry/paint products, unopened pseudo-element channels, responsive/viewport constructs, shorthand and `calc()` token references, and the other measured residuals in [§§B and C](23-known-limitations.md#b--not-built-yet).',
