  ...
  return <section className="react-native-inspection">
    ...
    {rows.map(row => {
      ...
      return <details key={id} open={row.caseId === selectedCase}>
        ...
        {comparison && op.comparisonContainerWidth !== undefined && <p>This component fills its parent. The comparison frame is the {op.comparisonContainerWidth} px place the original caller gave it; the reusable main still fills whatever parent it is placed in.</p>}
