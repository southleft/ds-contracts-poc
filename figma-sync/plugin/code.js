...
function nativeCommandValid(c, operationId) {
  const phases = ['token-create', 'token-readback', 'component-create', 'component-readback', 'partial-component-readback', 'library-replacement-readback', 'update-preflight-readback', 'update-apply', 'update-readback', 'comparison-recovery-readback', 'comparison-recovery-apply', 'library-replacement-apply', 'comparison-repair-preflight-readback', 'comparison-repair-apply'];
...
async function nativePoll(resumeOnly) {
  ...
  try {
    ...
    if (saved) {
      ...
      const readback = identity && ['token-readback', 'component-readback', 'partial-component-readback', 'library-replacement-readback', 'update-preflight-readback', 'update-readback', 'comparison-recovery-readback', 'comparison-repair-preflight-readback'].includes(identity.phase);
