...
let SET_NAME = "Table";
const CONTRACT_ID = "ds.table";
const DESCRIPTION = "Structured data in rows and columns. Composes header cells (with the Table's density mapped into them), and a body slot of rows. — governed by contract ds.table v1.1.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
...
const COL_W = 540, ROW_H = 240, PAD = 40;
