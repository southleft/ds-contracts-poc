...
let SET_NAME = "ChatMessageMetadata";
const CONTRACT_ID = "ds.chat-message-metadata";
const DESCRIPTION = "Metadata row for a chat message: delivery status, timestamp, and footer content. API mirrors industry convention (Astryx ChatMessageMetadata): status drives the icon. — governed by contract ds.chat-message-metadata v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
