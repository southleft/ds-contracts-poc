...
let SET_NAME = "Pagination";
const CONTRACT_ID = "ds.pagination";
const DESCRIPTION = "Steps through pages of content, below a table or list. API mirrors industry convention (Astryx Pagination) with three display variants; page math and click behavior are declared boundaries — the pages variant shows a representative trail. — governed by contract ds.pagination v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Label","default":"Pagination"}];
