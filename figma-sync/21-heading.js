...
const DESCRIPTION = "Sectioning heading whose rendered HTML element follows the level prop (h1–h6) via semantics.elementByProp, with a token-governed size ramp. The canvas renders the same ramp as a Level variant set — text nodes carry no element semantics, so only code renders the element itself. — governed by contract ds.heading v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
