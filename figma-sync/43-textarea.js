...
let SET_NAME = "TextArea";
const CONTRACT_ID = "ds.text-area";
const DESCRIPTION = "Multi-line text input for longer-form content — comments, descriptions, messages. API mirrors industry convention (Astryx TextArea); wrapping-label anatomy gives implicit association. — governed by contract ds.text-area v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [{"property":"Required","default":false}];
const TEXT_PROPS = [];
