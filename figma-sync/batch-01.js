...
// Batch sync: AccordionItem, Avatar, AvatarGroup, Badge, Button, Banner (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
  ...
  },
  {
    ...
    "description": "Banner — generated from contract ds.banner v1.0.0",
    "isSet": true,
    "boolProps": [
      {
