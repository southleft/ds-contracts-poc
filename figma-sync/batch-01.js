...
// Batch sync: AccordionItem, Avatar, AvatarGroup, Badge, Button, Banner, Blockquote, BreadcrumbItem (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
  ...
  },
  {
    ...
    "description": "Represents a person or entity with initials. Non-interactive. — governed by contract ds.avatar v1.0.0",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
  ...
  },
  {
    ...
    "description": "Stacked avatars with an overflow count. API mirrors industry convention (Astryx AvatarGroup): overlapping layout — expressed as a negative-margin child rule in CSS and negative item spacing on the canvas. — governed by contract ds.avatar-group v1.0.0",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
  ...
  },
  {
    ...
    "description": "Communicates status or categorization at a glance. Non-interactive. — governed by contract ds.badge v1.1.0",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
  ...
  },
  {
    ...
    "description": "Triggers an action or event. Use one primary button per context. — governed by contract ds.button v1.5.0",
    "isSet": true,
    "boolProps": [
      {
        "property": "Disabled",
  ...
  },
  {
    ...
    "description": "Persistent inline notification for page- or section-level feedback. API mirrors industry convention (Astryx Banner): status drives color, icon, and ARIA role; dismissable banners expose a close affordance; endContent carries actions. — governed by contract ds.banner v1.0.0",
    "isSet": true,
    "boolProps": [
      {
  ...
  },
  {
    ...
    "description": "Styled quotation block with an accent left border for quotes, testimonials, and excerpts. API mirrors industry convention (Astryx Blockquote): content plus an optional cite slot rendered in semantic footer/cite markup. — governed by contract ds.blockquote v1.0.0",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
  ...
  },
  {
    ...
    "description": "One link in a breadcrumb trail with its leading separator. API mirrors industry convention (Astryx BreadcrumbItem); the first item is authored with hasSeparator off (positional part logic is a documented gap), and aria-current needs conditional attributes — also documented. — governed by contract ds.breadcrumb-item v1.0.0",
    "isSet": false,
    "boolProps": [
      {
        "property": "Separator",
