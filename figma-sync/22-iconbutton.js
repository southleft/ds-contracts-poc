...
let SET_NAME = "IconButton";
const CONTRACT_ID = "ds.icon-button";
const DESCRIPTION = "A button showing only an icon, for toolbars, table rows, and compact UI. API mirrors industry convention (Astryx IconButton): the required label is the accessible name and is never rendered visibly. — governed by contract ds.icon-button v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [{"property":"Disabled","default":false}];
const TEXT_PROPS = [{"property":"Label","default":"Action"}];
