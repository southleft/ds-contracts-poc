...
let SET_NAME = "ChatSystemMessage";
const CONTRACT_ID = "ds.chat-system-message";
const DESCRIPTION = "Centered system message for non-sender chat content — date separators, membership changes, status notices. API mirrors industry convention (Astryx ChatSystemMessage): the divider variant adds a line on each side. — governed by contract ds.chat-system-message v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
