...
// Batch sync: TwoColumn, PageShell, Pagination, ProgressBar, Section, SideNavItem, Skeleton, Slider, Spinner, StatusDot, Switch, Tab, TabList, TableCell, TableHeaderCell, TableRow, Table (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "TwoColumn",
    ...
    "version": "1.0.0",
    "anchorKey": null,
    "description": "TwoColumn — generated from contract ds.two-column v1.0.0 † (2 code-only facts — see plugin report)",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
    ...
    "codeOnlyFacts": [
      {
        "part": "end",
        "kind": "channel",
        "channel": "slot \"end\" design-time content",
        "value": "",
      ...
      },
      {
        "part": "start",
        "kind": "channel",
        "channel": "slot \"start\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 1,
  ...
  },
  {
    ...
    "version": "1.0.0",
    "anchorKey": null,
    "description": "PageShell — generated from contract ds.page-shell v1.0.0 † (4 code-only facts — see plugin report)",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
        ...
        "spec": {
          ...
          "children": [
            ...
            },
            {
              ...
              "slotDescription": "Accepts: ds.sidebar-layout (preferred — Figma sorts these first; any component may still be placed).",
              "cell": {
                "row": 1,
                "column": 0
              }
            },
            {
              ...
              "slotDescription": "Accepts: ds.two-column, ds.sidebar-layout, ds.grid-gallery, ds.bento-grid (preferred — Figma sorts these first; any component may still be placed).",
              "cell": {
                "row": 1,
                "column": 1
              }
            },
            {
              ...
              "slotDescription": "Accepts: ds.two-column (preferred — Figma sorts these first; any component may still be placed).",
              "cell": {
                "row": 2,
                "column": 0,
                "columnSpan": 2
    ...
    "codeOnlyFacts": [
      {
        "part": "aside",
        "kind": "channel",
        "channel": "slot \"aside\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 1,
      ...
      },
      {
        "part": "footer",
        "kind": "channel",
        "channel": "slot \"footer\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 1,
      ...
      },
      {
        "part": "header",
        "kind": "channel",
        "channel": "slot \"header\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 1,
                  ...
                  "children": [
                    {
                      ...
                      "fontWeightVar": "font/title/weight",
  ...
  },
  {
    ...
    "description": "ProgressBar — generated from contract ds.progress-bar v1.0.1 † (1 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [
      {
  ...
  },
  {
    ...
    "description": "SideNavItem — generated from contract ds.side-nav-item v1.0.0 † (3 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [
      {
        ...
        "spec": {
          ...
          "children": [
            ...
            },
            {
              ...
              "slotDescription": "Accepts: ds.badge (preferred — Figma sorts these first; any component may still be placed)."
            }
          ]
        }
      },
  ...
  },
  {
    ...
    "description": "Slider — generated from contract ds.slider v1.0.0 † (1 code-only facts — see plugin report)",
    "isSet": false,
    "boolProps": [],
    "textProps": [
      {
  ...
  },
  {
    ...
    "description": "Switch — generated from contract ds.switch v2.0.1 † (1 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
            ...
            },
            {
              ...
              "children": [
                ...
                },
                {
                  ...
                  "fontStyle": "Regular",
                  "fontSizeVar": "font/control/size/sm",
                  "fontWeightVar": "font/weight/regular",
                  "textFill": "color/text/secondary",
                  "fontFamily": "Inter",
    ...
    "codeOnlyFacts": [
      {
        ...
        "channel": "toggle",
        "value": "onToggle",
        "reason": "fires when the input part is activated — the canvas cannot run behaviour, so the event stays a code-side callback (toggles value between off / on)",
        "variants": {
          "count": 2,
          "of": 2
        }
  ...
  },
  {
    ...
    "description": "Tab — generated from contract ds.tab v1.0.0 † (3 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
        ...
        "spec": {
          ...
          "children": [
            ...
            },
            {
              ...
              "fontStyle": "Medium",
              "textStyle": "control/sm",
              "fontWeightVar": "font/tab/default/weight",
            ...
            },
            {
              ...
              "slotDescription": "Accepts: ds.badge, ds.status-dot (preferred — Figma sorts these first; any component may still be placed)."
            }
          ]
        }
      },
        ...
        "spec": {
          ...
          "children": [
            ...
            },
            {
              ...
              "fontStyle": "Semi Bold",
              "fontSizeVar": "font/control/size/sm",
              "fontWeightVar": "font/tab/selected/weight",
          ...
          "children": [
            {
              ...
              "slotDescription": "Accepts: ds.table-cell, ds.table-header-cell (preferred — Figma sorts these first; any component may still be placed). Required — REFUSED BY FIGMA: an empty slot is always legal on canvas.",
              "slotDefault": [
                {
                  "dep": "TableCell",
                  "contractId": "ds.table-cell",
        ...
        "spec": {
          ...
          "children": [
              ...
              "children": [
                {
                  ...
                  "name": "nameHeader",
                  "dep": "TableHeaderCell",
                  "depContractId": "ds.table-header-cell",
                  "depAnchorKey": "91bf99af47cb2e09190eed770012e9c99661294f",
                  "depProps": {
                    "Density": "Comfortable",
                    "Label": "Name"
                  }
            ...
            },
            {
              ...
              "slotDescription": "Accepts: ds.table-row (preferred — Figma sorts these first; any component may still be placed). Required — REFUSED BY FIGMA: an empty slot is always legal on canvas.",
              "slotDefault": [
                {
                  "dep": "TableRow",
                  "contractId": "ds.table-row",
