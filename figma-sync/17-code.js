...
let SET_NAME = "Code";
const CONTRACT_ID = "ds.code";
const DESCRIPTION = "Inline code element with monospace font and muted background. API mirrors industry convention (Astryx Code); block code is a separate component family. — governed by contract ds.code v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
