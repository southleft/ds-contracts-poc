...
let SET_NAME = "TopNavItem";
const CONTRACT_ID = "ds.top-nav-item";
const DESCRIPTION = "A navigation item in a TopNav or SideNav context. API mirrors industry convention (Astryx TopNavItem) with selection flattened to a state enum; the selected state applies aria-current. — governed by contract ds.top-nav-item v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
