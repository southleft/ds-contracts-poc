...
let SET_NAME = "Tab";
const CONTRACT_ID = "ds.tab";
const DESCRIPTION = "A single tab in a TabList. API mirrors industry convention (Astryx Tab) with selection flattened to a state enum so both surfaces render it truthfully; selection behavior itself is a declared boundary. — governed by contract ds.tab v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
