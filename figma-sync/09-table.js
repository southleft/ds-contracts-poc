...
const DESCRIPTION = "Structured data in rows and columns. Composes header cells (with the Table's density mapped into them), and a body slot of rows. — governed by contract ds.table v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
