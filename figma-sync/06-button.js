...
const DESCRIPTION = "Triggers an action or event. Use one primary button per context. — governed by contract ds.button v1.5.0";
const IS_SET = true;
const BOOL_PROPS = [{"property":"Disabled","default":false},{"property":"Loading","default":false}];
const TEXT_PROPS = [];
