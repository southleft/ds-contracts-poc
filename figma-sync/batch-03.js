...
// Batch sync: Field, GridGallery, Heading, IconButton, Kbd, ListItem, List, MetadataListItem, MetadataList, SidebarLayout, TwoColumn, PageShell, Pagination, ProgressBar, Section, SideNavItem, Skeleton, Slider, Spinner, StatusDot (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Field",
    "contractId": "ds.field",
