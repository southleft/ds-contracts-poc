...
// Batch sync: Heading, IconButton, Kbd, ListItem, List, MetadataListItem, MetadataList, Pagination, ProgressBar, Section, SideNavItem, Skeleton, Slider, Spinner, StatusDot, Switch, Tab, TabList (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Heading",
