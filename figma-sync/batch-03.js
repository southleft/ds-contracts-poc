...
// Batch sync: EmptyState, Field, GridGallery, Heading, IconButton, Kbd, ListItem, List, MetadataListItem, MetadataList, SidebarLayout, TwoColumn, PageShell, Pagination, ProgressBar, Section, SideNavItem, Skeleton (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "EmptyState",
    ...
    "codeOnlyFacts": [
      {
        ...
        "value": "{color.action.{variant}.background-hover}",
  ...
  },
  {
    ...
    "description": "SideNavItem — generated from contract ds.side-nav-item v1.0.0 † (1 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [
      {
