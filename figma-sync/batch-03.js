...
// Batch sync: ProgressBar, Section, SideNavItem, Skeleton, Slider, Spinner, StatusDot, Switch, Tab, TabList, TableCell, TableHeaderCell, TableRow, Table, TextArea, TextField, Toast (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "ProgressBar",
