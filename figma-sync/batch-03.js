...
// Batch sync: EmptyState, Field, GridGallery, Heading, IconButton, Kbd, ListItem, List, MetadataListItem, MetadataList, SidebarLayout, TwoColumn, PageShell, Pagination, ProgressBar, Section, SideNavItem, Skeleton, Slider (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "EmptyState",
