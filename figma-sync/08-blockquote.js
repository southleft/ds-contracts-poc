...
let SET_NAME = "Blockquote";
const CONTRACT_ID = "ds.blockquote";
const DESCRIPTION = "Styled quotation block with an accent left border for quotes, testimonials, and excerpts. API mirrors industry convention (Astryx Blockquote): content plus an optional cite slot rendered in semantic footer/cite markup. — governed by contract ds.blockquote v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
