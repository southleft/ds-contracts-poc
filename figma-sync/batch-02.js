...
// Batch sync: Banner, BentoGrid, Blockquote, BreadcrumbItem, Breadcrumbs, Card, ChatMessageMetadata, ChatMessage, ChatSystemMessage (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Banner",
  ...
  },
  {
    ...
    "version": "1.0.0",
    "anchorKey": null,
    "description": "BentoGrid — generated from contract ds.bento-grid v1.0.0 † (5 code-only facts — see plugin report)",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
    ...
    "codeOnlyFacts": [
      ...
      },
      {
        "part": "rail",
        "kind": "channel",
        "channel": "slot \"rail\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 1,
  ...
  },
  {
    ...
    "description": "Blockquote — generated from contract ds.blockquote v1.0.0 † (1 code-only facts — see plugin report)",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
    ...
    "codeOnlyFacts": [
      {
        "part": "citation",
        "kind": "channel",
        "channel": "slot \"cite\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 1,
  ...
  },
  {
    ...
    "description": "ChatMessageMetadata — generated from contract ds.chat-message-metadata v1.0.0 † (1 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
  ...
  },
  {
    ...
    "description": "ChatSystemMessage — generated from contract ds.chat-system-message v1.0.0 † (1 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
