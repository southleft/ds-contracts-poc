...
// Batch sync: Banner, BentoGrid, Blockquote, BreadcrumbItem, Breadcrumbs, Card, ChatMessageMetadata, ChatMessage, ChatSystemMessage, Checkbox, Citation, Code, Divider (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Banner",
  ...
  },
  {
    ...
    "description": "Checkbox — generated from contract ds.checkbox v2.0.1 † (1 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
    ...
    "codeOnlyFacts": [
      {
        ...
        "channel": "toggle",
        "value": "onToggle",
        "reason": "fires when the input part is activated — the canvas cannot run behaviour, so the event stays a code-side callback (toggles value between unchecked / checked)",
        "variants": {
          "count": 6,
          "of": 6
        }
