...
// Batch sync: Card, ChatMessageMetadata, ChatMessage, ChatSystemMessage, Checkbox, Citation, Code, Divider, EmptyState, Field, Heading, IconButton, Kbd, ListItem, List, MetadataListItem, MetadataList (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Card",
    "contractId": "ds.card",
