...
// Batch sync: Banner, Blockquote, BreadcrumbItem, Breadcrumbs, Card, ChatMessageMetadata, ChatMessage, ChatSystemMessage, Checkbox, Citation, Code, Divider, EmptyState, Field (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Banner",
