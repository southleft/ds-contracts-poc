...
// Batch sync: Card, ChatMessageMetadata, ChatMessage, ChatSystemMessage, Checkbox, Citation, Code, Divider, EmptyState, Field, Heading, IconButton, Kbd, ListItem, List, MetadataListItem, MetadataList, Pagination (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Card",
    "contractId": "ds.card",
