...
let SET_NAME = "Card";
const CONTRACT_ID = "ds.card";
const DESCRIPTION = "Groups related content behind one subject. Composes an Avatar, a bound title, a default body slot, and a constrained actions slot. — governed by contract ds.card v1.1.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
