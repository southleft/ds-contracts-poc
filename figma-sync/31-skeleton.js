...
let SET_NAME = "Skeleton";
const CONTRACT_ID = "ds.skeleton";
const DESCRIPTION = "Pulsing placeholder previewing the shape of loading content. API mirrors industry convention (Astryx Skeleton) with the free-form width/height flattened to a shape variant; the pulse is CSS-only — the canvas shows the static shape. — governed by contract ds.skeleton v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
