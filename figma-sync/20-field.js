...
let SET_NAME = "Field";
const CONTRACT_ID = "ds.field";
const DESCRIPTION = "Form field wrapper providing a label, description, and required indicator around any control. API mirrors industry convention (Astryx Field): the label targets the control via inputID; validation status needs structured-object props — a documented gap. — governed by contract ds.field v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [{"property":"Required","default":false}];
const TEXT_PROPS = [{"property":"InputID","default":"field-control"}];
