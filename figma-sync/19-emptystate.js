...
let SET_NAME = "EmptyState";
const CONTRACT_ID = "ds.empty-state";
const DESCRIPTION = "Placeholder for a content area with no data — empty lists, zero results, first-time setup. API mirrors industry convention (Astryx EmptyState): always a title and a next step; the icon is decorative. — governed by contract ds.empty-state v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
