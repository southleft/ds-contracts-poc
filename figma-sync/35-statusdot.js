...
let SET_NAME = "StatusDot";
const CONTRACT_ID = "ds.status-dot";
const DESCRIPTION = "Small colored dot communicating status — presence, severity, activity. API mirrors industry convention (Astryx StatusDot): five semantic variants with a required accessible label. — governed by contract ds.status-dot v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Label","default":"Status"}];
