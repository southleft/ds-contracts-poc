...
let SET_NAME = "Citation";
const CONTRACT_ID = "ds.citation";
const DESCRIPTION = "Inline reference to an external source — attribution in AI-generated responses, articles, anywhere provenance matters. API mirrors industry convention (Astryx Citation): label chips or compact numbered badges. — governed by contract ds.citation v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Href","default":"https://example.com"}];
