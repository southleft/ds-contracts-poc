...
let SET_NAME = "TypeaheadItem";
const CONTRACT_ID = "ds.typeahead-item";
const DESCRIPTION = "Default dropdown item for search results: label with optional icon and description. API mirrors industry convention (Astryx TypeaheadItem) with the item object flattened to explicit props. — governed by contract ds.typeahead-item v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
