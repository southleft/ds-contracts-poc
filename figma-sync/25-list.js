...
let SET_NAME = "List";
const CONTRACT_ID = "ds.list";
const DESCRIPTION = "Vertical collection of items with consistent density. API mirrors industry convention (Astryx List); dividers need sibling-selector styling and marker styles need list-style tokens — documented gaps. — governed by contract ds.list v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
