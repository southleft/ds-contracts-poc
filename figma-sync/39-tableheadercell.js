...
let SET_NAME = "TableHeaderCell";
const CONTRACT_ID = "ds.table-header-cell";
const DESCRIPTION = "A column header cell. — governed by contract ds.table-header-cell v1.1.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
