...
let SET_NAME = "SideNavItem";
const CONTRACT_ID = "ds.side-nav-item";
const DESCRIPTION = "A sidebar navigation row: icon, label, and trailing content, with a selected state. API mirrors industry convention (Astryx SideNavItem); nesting and collapse are behavior-layer boundaries. — governed by contract ds.side-nav-item v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
