...
let SET_NAME = "Section";
const CONTRACT_ID = "ds.section";
const DESCRIPTION = "The standard way to create page regions and group related content — settings groups, form sections, sidebar areas. API mirrors industry convention (Astryx Section) at the variant level; the transparent variant needs transparent color tokens — a documented gap. — governed by contract ds.section v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
