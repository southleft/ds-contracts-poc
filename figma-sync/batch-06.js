...
// Batch sync: Token, Toolbar, TopNavItem, TopNav (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Token",
    "contractId": "ds.token",
    ...
    "variants": [
      {
        ...
        "spec": {
          ...
          "fill": "color/token/default/background",
          "bindings": {
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/red/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/orange/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/yellow/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/green/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/teal/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/cyan/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/blue/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/purple/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/pink/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
      ...
      },
      {
        ...
        "spec": {
          ...
          "fill": "color/token/gray/background",
          "bindings": {
            "topLeftRadius": "radius/100",
            "topRightRadius": "radius/100",
            "bottomLeftRadius": "radius/100",
  ...
  },
  {
    ...
    "description": "Toolbar — generated from contract ds.toolbar v1.0.0 † (3 code-only facts — see plugin report)",
    "isSet": true,
    "boolProps": [],
    "textProps": [
      {
    ...
    "codeOnlyFacts": [
      {
        "part": "centerContent",
        "kind": "channel",
        "channel": "slot \"centerContent\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 3,
      ...
      },
      {
        "part": "startContent",
        "kind": "channel",
        "channel": "slot \"startContent\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 3,
  ...
  },
  {
    ...
    "description": "TopNav — generated from contract ds.top-nav v1.0.0 † (3 code-only facts — see plugin report)",
    "isSet": false,
    "boolProps": [],
    "textProps": [
      {
    ...
    "codeOnlyFacts": [
      ...
      },
      {
        "part": "heading",
        "kind": "channel",
        "channel": "slot \"heading\" design-time content",
        "value": "",
        "reason": "no defaultContent and not the default `children` slot — the canvas draws an EMPTY region (a hugging axis re-measures to Figma's 1px floor) exactly as the code surfaces render nothing: emit-react's story loop has nothing to sample and emit-html renders the wrapper empty. A placeholder here would be content no code surface has, and a minimum box would be geometry no surface declares. Declare `slot.defaultContent` to give this slot design-time content on BOTH surfaces",
        "variants": {
          "count": 1,
