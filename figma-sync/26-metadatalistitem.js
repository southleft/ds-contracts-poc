...
let SET_NAME = "MetadataListItem";
const CONTRACT_ID = "ds.metadata-list-item";
const DESCRIPTION = "One key–value pair in a MetadataList: a label and a value area. API mirrors industry convention (Astryx MetadataListItem). — governed by contract ds.metadata-list-item v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
