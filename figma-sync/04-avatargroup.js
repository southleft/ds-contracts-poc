...
let SET_NAME = "AvatarGroup";
const CONTRACT_ID = "ds.avatar-group";
const DESCRIPTION = "Stacked avatars with an overflow count. API mirrors industry convention (Astryx AvatarGroup): overlapping layout — expressed as a negative-margin child rule in CSS and negative item spacing on the canvas. — governed by contract ds.avatar-group v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
