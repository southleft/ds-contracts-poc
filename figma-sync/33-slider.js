...
let SET_NAME = "Slider";
const CONTRACT_ID = "ds.slider";
const DESCRIPTION = "Numeric selection within bounds — the static surface of a slider: label, filled track to the current value, and thumb. API mirrors industry convention (Astryx Slider); drag behavior and range mode are declared boundaries. — governed by contract ds.slider v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Value","default":"40"},{"property":"Max","default":"100"}];
