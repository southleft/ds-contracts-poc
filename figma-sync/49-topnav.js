...
let SET_NAME = "TopNav";
const CONTRACT_ID = "ds.top-nav";
const DESCRIPTION = "Horizontal main navigation bar with heading, start, center, and end areas. API mirrors industry convention (Astryx TopNav); hover menus and mega-menus are behavior-layer boundaries. — governed by contract ds.top-nav v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Label","default":"Main"}];
