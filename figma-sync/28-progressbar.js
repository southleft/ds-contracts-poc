...
let SET_NAME = "ProgressBar";
const CONTRACT_ID = "ds.progress-bar";
const DESCRIPTION = "Horizontal bar showing completion progress. API mirrors industry convention (Astryx ProgressBar): number-valued value/max drive the fill; the canvas renders the defaults' fraction as its honest static state. Indeterminate mode needs animation on the canvas — a documented boundary. — governed by contract ds.progress-bar v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Value","default":"60"},{"property":"Max","default":"100"},{"property":"Label","default":"Progress"}];
