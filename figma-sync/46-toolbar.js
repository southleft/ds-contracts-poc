...
let SET_NAME = "Toolbar";
const CONTRACT_ID = "ds.toolbar";
const DESCRIPTION = "General-purpose toolbar container with start, center, and end content areas for contextual actions. API mirrors industry convention (Astryx Toolbar); roving-tabindex keyboard behavior is a declared boundary. — governed by contract ds.toolbar v1.0.0";
const IS_SET = true;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Label","default":"Toolbar"}];
