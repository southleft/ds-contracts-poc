...
let SET_NAME = "TextField";
const CONTRACT_ID = "ds.text-field";
const DESCRIPTION = "Single-line text input for short-form values — names, emails, search queries. API mirrors industry convention (Astryx TextInput): required label, description, size scale. The wrapping-label anatomy gives implicit label association. Disabled fields dim and drop pointer interaction via stylesWhen (code-side conditional styling; a declared canvas fidelity limit). — governed by contract ds.text-field v1.1.0";
const IS_SET = true;
const BOOL_PROPS = [{"property":"Required","default":false},{"property":"Disabled","default":false}];
const TEXT_PROPS = [];
