...
const CONTRACT_ID = "ds.spinner";
const DESCRIPTION = "Animated loading indicator for processes of unknown duration. API mirrors industry convention (Astryx Spinner); the size scale needs per-variant icon sizing and the rotation itself is CSS-only — the canvas shows the static arc. — governed by contract ds.spinner v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Label","default":"Loading"}];
