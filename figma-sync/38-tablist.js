...
let SET_NAME = "TabList";
const CONTRACT_ID = "ds.tab-list";
const DESCRIPTION = "Tab-style navigation container holding Tab items. API mirrors industry convention (Astryx TabList); roving-tabindex keyboard behavior and controlled selection are declared boundaries. — governed by contract ds.tab-list v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
