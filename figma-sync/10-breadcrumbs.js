...
let SET_NAME = "Breadcrumbs";
const CONTRACT_ID = "ds.breadcrumbs";
const DESCRIPTION = "Navigation trail from root to the current page. API mirrors industry convention (Astryx Breadcrumbs): a nav landmark holding BreadcrumbItems; keep trails to five levels or fewer. — governed by contract ds.breadcrumbs v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [{"property":"Label","default":"Breadcrumb"}];
