...
let SET_NAME = "MetadataList";
const CONTRACT_ID = "ds.metadata-list";
const DESCRIPTION = "Key–value pairs for object attributes — detail panels, settings summaries, record information. API mirrors industry convention (Astryx MetadataList); multi-column layout and collapse behavior are documented boundaries. — governed by contract ds.metadata-list v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
