...
const DESCRIPTION = "Small inline element for discrete associated data — tags, categories, active filters. API mirrors industry convention (Astryx Token): 11-color vocabulary with size scale; removal and click behavior are a declared boundary. — governed by contract ds.token v1.0.0";
const IS_SET = true;
