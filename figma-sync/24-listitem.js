...
let SET_NAME = "ListItem";
const CONTRACT_ID = "ds.list-item";
const DESCRIPTION = "A single row in a List: label with optional description, leading and trailing content. API mirrors industry convention (Astryx ListItem); click/link behavior is a declared boundary. — governed by contract ds.list-item v1.0.0";
const IS_SET = false;
const BOOL_PROPS = [];
const TEXT_PROPS = [];
