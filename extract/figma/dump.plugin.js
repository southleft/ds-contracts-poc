// Design-side ANATOMY dump — the canonical node-tree capture (dump v1.6).
//
...
const dumps = {
  _provenance: {
    ...
    note: 'Node-tree dump (extract/figma/dump.plugin.js, dump v1.6) for design→contract proposal.',
    dumpVersion: '1.6',
  },
};
