// Design-side ANATOMY dump — the canonical node-tree capture (dump v1.12).
//
...
const dumps = {
  _provenance: {
    ...
    note: 'Node-tree dump (extract/figma/dump.plugin.js, dump v1.12) for design→contract proposal.',
    dumpVersion: '1.12',
  },
};
