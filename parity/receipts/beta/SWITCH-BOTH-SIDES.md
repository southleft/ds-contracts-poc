...
3. **Identity drift.** Authored anchors `nodeId: 11:1286` / key `7936496…`.
   Live set is `4:618` / `1a174ed…`. Same file, redrawn. Catalog / visual-
   parity / `figma-sync` still pin the dead id — do not retarget those in
   this close.
