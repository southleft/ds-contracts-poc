...
The whole thing is pinned by 188 executable claim gates and a 266-file byte-identical
...
| `docs/22-generality.md` | `19d1c97f1860` | 68,406 | coverage denominators (docs/22 §8.3 table) |
