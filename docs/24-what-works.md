...
`extract/computed/out/conformance/` holds **103** more scorecards with a mean of
**95.8%** over 10,556 cells. They are **excluded from §3 entirely** and
...
|---|---|---|---|---|
| synthetic CSS/DOM constructs | 103 | 95.8 | **no** | `extract/computed/out/conformance/*/scorecard.json` |
...
| capture double-sweep identity | 219/219 runs | a capture whose second sweep disagrees with its first | `extract/computed/out/**/numbers.json`, `determinism` |
| browser captures behind the corpus | 11,941 | a floor quoted from a sample smaller than it claims | same files, `captures` |
...
| CSS / DOM frontier | 105 | CARRIED 60 · REFUSED 24 · UNSUPPORTED 17 · LOWERED 4 | `conformance/MANIFEST.json` |
...
| every capture run carries the two-sweep determinism receipt | 219 — `extract/computed/out/**/numbers.json` | 219 — `count of numbers.json files` | ✔ |
...
|---|---|---|---|
| `conformance/MANIFEST.json` | `6d65434cdd0b` | 107,108 | CSS/DOM frontier vocabulary |
| `docs/22-generality.md` | `c8f3b60ba75d` | 73,271 | coverage denominators (docs/22 §8.3 table) |
| `evals/golden.json` | `da09a6c01fdf` | 32,256 | generated-source golden manifest |
...
| `extract/computed/out/**/numbers.json` | `36521c78f65b` | 1,276,136 | capture counts + determinism receipts — 219 files |
| `extract/computed/out/**/scorecard.json` | `f7a5c1d02f37` | 19,855,598 | computed-equality per component — 219 files |
