...
`extract/computed/out/conformance/` holds **113** more scorecards with a mean of
**98.2%** over 27,328 cells. They are **excluded from §3 entirely** and
...
|---|---|---|---|---|
| synthetic CSS/DOM constructs | 113 | 98.2 | **no** | `extract/computed/out/conformance/*/scorecard.json` |
...
| capture double-sweep identity | 229/229 runs | a capture whose second sweep disagrees with its first | `extract/computed/out/**/numbers.json`, `determinism` |
| browser captures behind the corpus | 11,945 | a floor quoted from a sample smaller than it claims | same files, `captures` |
...
| CSS / DOM frontier | 115 | CARRIED 70 · REFUSED 22 · UNSUPPORTED 18 · LOWERED 5 | `conformance/MANIFEST.json` |
...
| every capture run carries the two-sweep determinism receipt | 229 — `extract/computed/out/**/numbers.json` | 229 — `count of numbers.json files` | ✔ |
...
|---|---|---|---|
| `conformance/MANIFEST.json` | `177da23380a9` | 130,447 | CSS/DOM frontier vocabulary |
...
| `extract/computed/out/**/numbers.json` | `d2263d312675` | 1,581,728 | capture counts + determinism receipts — 229 files |
| `extract/computed/out/**/scorecard.json` | `de4abdc6429f` | 19,909,482 | computed-equality per component — 229 files |
