...
corpora there are **103** daggered contracts naming **2,306** facts, and both
...
| `untitled-ui` | 15 | 15 | 70 | `extract/figma/dagger-census.json` |
...
| `evals/golden.json` | `66bd62ccd784` | 32,256 | generated-source golden manifest |
...
| `extract/figma/dagger-census.json` | `83d4848bcd99` | 6,074 | dropped-fact receipt census |
