...
`extract/computed/out/conformance/` holds **119** more scorecards with a mean of
**97.5%** over 27,636 cells. They are **excluded from §3 entirely** and
...
|---|---|---|---|---|
| synthetic CSS/DOM constructs | 119 | 97.5 | **no** | `extract/computed/out/conformance/*/scorecard.json` |
...
| capture double-sweep identity | 235/235 runs | a capture whose second sweep disagrees with its first | `extract/computed/out/**/numbers.json`, `determinism` |
| browser captures behind the corpus | 11,969 | a floor quoted from a sample smaller than it claims | same files, `captures` |
...
| CSS / DOM frontier | 121 | CARRIED 76 · REFUSED 22 · UNSUPPORTED 18 · LOWERED 5 | `conformance/MANIFEST.json` |
...
| every capture run carries the two-sweep determinism receipt | 235 — `extract/computed/out/**/numbers.json` | 235 — `count of numbers.json files` | ✔ |
...
|---|---|---|---|
| `conformance/MANIFEST.json` | `c188b74db0f8` | 134,810 | CSS/DOM frontier vocabulary |
...
| `extract/computed/out/**/numbers.json` | `497828c83f9e` | 1,599,597 | capture counts + determinism receipts — 235 files |
| `extract/computed/out/**/scorecard.json` | `1bebb8338bf3` | 19,928,680 | computed-equality per component — 235 files |
