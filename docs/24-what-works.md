...
`extract/computed/out/conformance/` holds **125** more scorecards with a mean of
**98.2%** over 29,892 cells. They are **excluded from §3 entirely** and
...
|---|---|---|---|---|
| synthetic CSS/DOM constructs | 125 | 98.2 | **no** | `extract/computed/out/conformance/*/scorecard.json` |
...
| capture double-sweep identity | 241/241 runs | a capture whose second sweep disagrees with its first | `extract/computed/out/**/numbers.json`, `determinism` |
| browser captures behind the corpus | 12,029 | a floor quoted from a sample smaller than it claims | same files, `captures` |
...
| CSS / DOM frontier | 127 | CARRIED 78 · REFUSED 27 · UNSUPPORTED 17 · LOWERED 5 | `conformance/MANIFEST.json` |
...
| every capture run carries the two-sweep determinism receipt | 241 — `extract/computed/out/**/numbers.json` | 241 — `count of numbers.json files` | ✔ |
...
|---|---|---|---|
| `conformance/MANIFEST.json` | `5e709dec07a7` | 148,437 | CSS/DOM frontier vocabulary |
| `docs/22-generality.md` | `178f242658bd` | 73,465 | coverage denominators (docs/22 §8.3 table) |
...
| `extract/computed/out/**/numbers.json` | `4fd0c256585a` | 1,621,127 | capture counts + determinism receipts — 241 files |
| `extract/computed/out/**/scorecard.json` | `e1dda60efd3d` | 19,960,163 | computed-equality per component — 241 files |
