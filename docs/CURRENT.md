...
This demonstrates the shared uniform padding-box rule and migration for this retained case. It does not qualify the remaining Button cases, the complete journey, or reverse reconstruction of the paint layer. Direct radius-token edits still require recompilation of the derived inner radius. Checks cover repeat execution, lost acknowledgements, concurrent edits and journal recovery, but the complete two-way recovery journey still needs live proof.
