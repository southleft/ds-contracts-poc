...
- **What it delivers, measured** ([24 §3](24-what-works.md)): **86.8% mean
  ...
  libraries and six styling architectures: 86.0% cell-weighted over 719,534
  cells, 58 of 116 at ≥90%, 90 of 116 at ≥80%. Every one of the 116 is listed
...
- **Coverage per library is partial, and it is the number that decides
  ...
  limit, and the 86.8% above describes only the tractable 11.1%.
