...
- **What it delivers, measured** ([24 §3](24-what-works.md)): **86.7% mean
  ...
  libraries and six styling architectures: 85.9% cell-weighted over 718,018
...
- **Coverage per library is partial, and it is the number that decides
  ...
  limit, and the 86.7% above describes only the tractable 11.1%.
