...
- **What it delivers, measured** ([24 §3](24-what-works.md)): **86.3% mean
  ...
  libraries and six styling architectures: 85.7% cell-weighted over 749,127
  cells, 59 of 126 at ≥90%, 98 of 126 at ≥80%. Every one of the 116 is listed
...
- **Coverage per library is partial, and it is the number that decides
  ...
  limit, and the 86.3% above describes only the tractable 11.1%.
