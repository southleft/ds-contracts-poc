...
| A5du | PREPARE INPUT V51. Copy the v50 stack. Do not patch hashed v50 scene-readback, extract, restore, writer, or runtime bytes. Teach host to omit `strokes` on `input-field/message-container` that compile never emits (extract proved 128/128 both). Do not invent variables. Do not invent a strokes value. Do not lift onto surface. Do not teach FIXED as a fill. | Antecedent index SHA-256 `a8ea2199a911f4e5f411efb07741053b11d0ffd4938098d40411e6870a8051cd`. AUTHORIZE as a later commit. |
| A5dv | AUTHORIZE INPUT V51 as a **separate** later commit. New prepare-era Ed25519 signer. Antecedent is the PREPARE V51 commit. Auth lifecycle stays out of the hash set. Do not patch hashed v50 or v51 bytes. | `--expect-authorized` after publish. Then attestation + Scratch-only live. Max 3. If a hashed v51 file fails closed, open v52. |
