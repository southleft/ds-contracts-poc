...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v10 AUTHORIZE `ae64b978f`. **Attempt 1 failed closed 2026-08-29** at extract `unsupported structural edit at $.children[0].children[0].children[2].children[0].clipsContent`. Writer accepted (page `173:50902`, sets `173:50932` / `173:50964` / `173:51081`); restore 4 held; week-number order held. Compile `calendar/week/0` omits `clipsContent`; host emitted `true`. Signed cleanup removed the page and collection `173:50904`. Input/Combobox/Button/Table stayed. Do not restart v10 attempt 2 as-is. Next teaching: host-omit week-frame clipsContent. `react-day-picker@10.0.1` remains a named refusal. Do not remint Table. |
...
| Calendar    | **live v10 attempt 1 failed closed at extract week/0 clipsContent; writer accepted; restore 4 held; week-number order held; mint cleaned; Input/Combobox/Button/Table stayed; no mint; no human grade; overall false** | Do not restart v10 attempt 2 as-is. Next teaching: host-omit week-frame clipsContent. Do not invent a Calendar human grade. |
