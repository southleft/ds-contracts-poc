...
| A5ht | PREPARE INPUT V83. Copy the v82 stack. Do not patch hashed v19 writer (`0ed357db…59e0` / `5d0f2323…1681`) or hashed v82 scene-readback (`cdff8862…8fa8`). When compile IR has no TEXT `opacity` key, collapse/recompile cycle compare must not invent default 1 (same class as V80 host omit). Do not emit TEXT `opacity` onto compile IR. Do not invent an opacity variable. Accounting still uses the frozen V82 plan (24 occupancy opacity 0). Polar gzip stays byte-identical to V82. Keep V73–V82 probe/accounting/occupancy/visible/opacity-carry teachings. Do not invent Polar 9/30/0, a Polar content-row, FIXED, or a pixel gap. Do not restart V82 attempt 2. | **Done** — hashes pinned in this PREPARE; antecedent commit is this commit. Antecedent index SHA-256 `07759dd6ac3098caafb564254a2765bd6739389140d245a4d6a2ff3f98c91c4a`. |
| A5hu | AUTHORIZE INPUT V83 as a **separate** later commit. New prepare-era Ed25519 signer. Auth lifecycle stays out of the hash set. Do not patch hashed v16, v17, v18, v19, or v82 bytes. | Pending separate commit after PREPARE. |
| A5hv | Attempt 1 Scratch-only live after attestation and preflight. New txn `private/input-live-v83-transaction`. Scratch `byMp6lt0Ij9b2QbkDGFwBh` only. Never reuse page `111:281145` or the v82 txn. If collapse + accounting pass, probe must run. | Pending live. |
...
V83 PREPARE teaches collapse omit of invented default-1 content TEXT opacity. Frozen V82 expected-plans are byte-identical (MUI 24 occupancy opacity 0; Polar unchanged). Hashed v82 scene-readback and v19 writer stay frozen. Live remains forbidden until a separate authorization. Do not invent compile TEXT opacity. Do not invent host `visible:false`. Do not invent an opacity variable. Do not invent overlap-zero. Do not restart V82 attempt 2. Do not claim v1 complete.
