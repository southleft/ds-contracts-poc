...
| A5do | PREPARE INPUT V49. Copy the v48 stack. Do not patch hashed v48 scene-readback, extract, restore, writer, or runtime bytes. Teach host to omit `cornerRadius` on `input-field/message-container` that compile never emits (extract proved 128/128 both). Do not invent variables. Do not invent a cornerRadius value. Do not lift onto surface. Do not omit effects/strokes in the same prepare. Do not teach FIXED as a fill. | **Draft prepared** on top of `68d2849b28cbf5c925c4e4403733ae1d3f3969fd`. Do not self-hash this prepare commit. |
| A5dp | AUTHORIZE INPUT V49 as a **separate** later commit. New prepare-era Ed25519 signer. Pin the PREPARE SHA. Auth lifecycle stays out of the hash set. Do not patch hashed v48 or v49 bytes. | Open after PREPARE. |
...
After PREPARE INPUT V49 is published:

```
# AUTHORIZE INPUT V49 — pin prepare-era operator signer
# then attestation + Scratch-only live. Max 3. If a hashed v49 file fails closed, open v50.
```
