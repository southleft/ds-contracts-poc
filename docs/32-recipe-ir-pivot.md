...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v1 PREPARE `2b2dca528` / AUTHORIZE `ca7b8df4e`. **Attempt 1 failed closed 2026-08-30** at writer `CALENDAR-TEXT-GEOMETRY:calendar/day/label`: hug label `26` collapsed to width 0 inside a still-HUG day component (FIXED 32px box is applied after children). Cleanup removed page `173:49763` and collection `173:49765`. Input `115:295378`, Combobox `163:35981`, Button `85:6781`, Table `173:48924` stayed. Do not restart v1 attempt 2 as-is. Next teaching: day-box before children, plus hug-text intrinsic before parent collapse. `react-day-picker@10.0.1` remains a named refusal. Do not remint Table. |
...
| Calendar    | **live v1 attempt 1 failed closed at writer CALENDAR-TEXT-GEOMETRY:calendar/day/label; hug label collapsed in unsized day box; cleanup executed; Input/Combobox/Button/Table stayed; no mint; no human grade; overall false** | Do not restart v1 attempt 2 as-is. Next teaching: day-box before children + hug-text intrinsic. Astryx only. Do not invent a Calendar human grade. |
