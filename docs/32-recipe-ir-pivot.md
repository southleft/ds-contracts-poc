...
| One teaching? | **No.** Teaching Polar content-row, Label property restore, or MUI clip alone cannot satisfy the conjunction. Do not open V75 until one class is chosen from a further diagnosis. |
