...
| Data Table  | **live v2 prepared; one teaching host-listed Inter Semi Bold; not live; no human grade; overall false**                                                     | AUTHORIZE then attempt 1 on a new Scratch page. Do not restart v1 attempt 2 as-is. Do not invent a Data Table human grade. Do not write Input `115:295378` or Combobox `163:35981`. |
