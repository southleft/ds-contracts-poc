...
After RECORD INPUT V42 is published:

```
# PREPARE INPUT V43 — copy v42; omit surface stroke dashPattern compile never emits
# do not patch hashed v42; do not restart v42 attempt 2 as-is
```
