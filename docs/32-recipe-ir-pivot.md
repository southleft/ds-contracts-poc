...
AUTHORIZE INPUT V81 as a **separate** later commit. New prepare-era Ed25519 signer. Antecedent is the V81 PREPARE commit. Auth lifecycle stays out of the hash set. Do not patch hashed v16, v17, v18, v19, or v80 bytes. Do not invent host `visible:false`. Do not restart V80 attempt 2. Do not claim v1 complete.
