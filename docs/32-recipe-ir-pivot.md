...
| A5co | AUTHORIZE INPUT V40 as a **separate** later commit. New prepare-era Ed25519 signer. Antecedent `2cc7315b1c8352b398a3187d75c5b993bf87d4d1`. Auth lifecycle stays out of the hash set. Artifact SHA-256 `af94e16aa7458b2a83798ac5c0bed00d5dd34177ab3c783634e7e844ef365203`; SPKI SHA-256 `8fa620654380c8eced8affbed4ca55b3a076ad7116eab9ab5d9a2fd21317790a`. Do not patch hashed v39 or v40 bytes. | `--expect-authorized` after publish. Then attestation + Scratch-only live. Max 3. If a hashed v40 file fails closed, open v41. |
...
After AUTHORIZE INPUT V40 is published:

```
npm run recipe:input-field:live:v40:history:verify -- --expect-authorized
