...
After RECORD INPUT V48 is published:

```
# PREPARE INPUT V49 — copy v48; omit message-container cornerRadius compile never emits
# do not patch hashed v48; do not restart v48 attempt 2 as-is
```
