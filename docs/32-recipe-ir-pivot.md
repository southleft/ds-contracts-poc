...
> Do not restart v4 attempt 2 as-is. Not live. Product **v1 is
...
was cleaned. No Data Table live mint and no Data Table human grade.
...
| D2 | Scratch-only Data Table live, same receipts bar. | **Table live v4 attempt 1 failed closed 2026-08-29.** Writer refused `TABLE-MIN-WIDTH-ZERO`. Row-owned TEXT `characters` teaching cleared. PREPARE `145fd0518` / AUTHORIZE `41ed34e85`. Do not restart v4 attempt 2 as-is. Not live. |
...
| Data Table  | **live v4 attempt 1 failed closed at writer TABLE-MIN-WIDTH-ZERO; row-owned TEXT characters teaching cleared; mint cleaned; not live; no human grade; overall false**                                                     | Do not restart v4 attempt 2 as-is. Next teaching: when host minWidth is 0, unset with null rather than assigning 0. Do not invent a Data Table human grade. Do not write Input `115:295378` or Combobox `163:35981`. |
