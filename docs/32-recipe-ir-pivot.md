...
After RECORD INPUT V34 ATTEMPT 1 is published:

```
# PREPARE INPUT V35 as a separate commit. Do not patch hashed v34.
# Copy the v34 stack. Drop label binding extras and order label bindings to compile.
```
