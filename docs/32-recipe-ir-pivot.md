...
After AUTHORIZE INPUT V74 is published:

```
npm run recipe:input-field:live:v74:history:verify -- --expect-authorized
```

Then attestation (private 0600) + Scratch-only live attempt 1. New txn `private/input-live-v74-transaction`. Keep v17 writer. Do **not** invent 9/30/0. Do **not** restart V73. Do **not** reuse page `111:242670` or `private/input-live-v73-transaction`.
