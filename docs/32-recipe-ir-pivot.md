...
V84 authorization is declared. Live remains forbidden until attestation and Scratch-only preflight pass. Do not revert v19. Do not invent overlap-zero. Do not restart V83 attempt 2. Do not claim v1 complete.
