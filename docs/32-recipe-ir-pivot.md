...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v22 RECORD: writer accepted; restore 4 held; extract accepted; probe accepted (all source booleans true, 8/8 cells, overlap 0; hug-root reflow held). Capture 0 was not issued: technical gates persist wrote 1 Astryx root; validate required 2 roots (Table leftover). Cleanup accepted; page `173:53540` and collection `VariableCollectionId:173:53542` removed. Input/Combobox/Button/Table stayed. **Calendar live v23 PREPARE** on the measured teaching: gates validate one Astryx root. Do not invent a second library. react-day-picker stays a named refusal. Run `19be1c96-calendar-v23`. Do not remint Table. Do not restart v22 attempt 2 as-is. |
...
| Calendar    | **live v22 attempt 1 failed closed at gates 2-root leftover after green probe; v23 PREPARE (gates one Astryx root); Astryx only; no mint; no human grade; overall false** | AUTHORIZE then attempt 1 on a new Scratch page. Do not restart v22 attempt 2 as-is. Do not invent a Calendar human grade. |
