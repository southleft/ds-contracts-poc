...
| Calendar    | **live v30 attempt 1 mint stayed on `180:56126`.** 2026-08-30 site-vs-mint diagnosis: compiled `astryx-calendar-reviewed-v1` August 2026 3-week fixture (vendored light tokens, square selected 12), not the docs showcase (`value='2026-04-15'`, 6-row default, nav chevrons, site theme, dark chrome). Evidence `recipe/evidence/calendar-v30-astryx-site-vs-mint.json`. No remint. No grade. Astryx only. Overall false; product v1 incomplete | Open Calendar page `180:56126` only. Do not remint to match the Astryx PNG. TJ pick: keep fixture slice vs expand adapter from the live component. Do not invent 6 rows, chevrons, circle, April, or site-theme #262626/#ebebeb. Do not invent Polar/MUI/Fluent calendars. Do not open Input `115:295378`, Combobox `163:35981`, Table `173:48924`, or Button `85:6781` as Calendar. Product v1 incomplete. |
