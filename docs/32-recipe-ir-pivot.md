...
| Calendar    | **live v30 attempt 1 mint stayed on `180:56126`.** V31 compile names the vendored 6-row default, nav, 28 circle, root padding 12; capture month April 2026; vendored light `#0064E0`. **V31 attempt 1 failed closed** at writer FILL caption (`CALENDAR-FONT-ZERO-INTRINSIC`). Partial page cleaned. V30 stays. **V32 PREPARE** teaches writer to skip pre-parent intrinsic and post-append zero-geometry for FILL text. Live pending. No grade. Astryx only. Overall false; product v1 incomplete | Open Calendar page `180:56126` only until V32 mints a new page. Do not restart v31 attempt 2 as-is. Do not invent Polar/MUI/Fluent calendars. Do not use docs dark canvas or site `#262626`/`#ebebeb`. Do not open Input `115:295378`, Combobox `163:35981`, Table `173:48924`, or Button `85:6781` as Calendar. Product v1 incomplete. |
