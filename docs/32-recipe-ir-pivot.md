...
> `163:35981` stayed. Do not restart v3 attempt 2 as-is. Product **v1 is incomplete**. Remaining: Data Table,
...
the partial page `165:40704` was cleaned. No Data Table live mint and no
...
| D2 | Scratch-only Data Table live, same receipts bar. | **Table live v3 attempt 1 failed closed 2026-08-29.** PREPARE `868ec9b0a` / AUTHORIZE `1c03d3665`. Writer refused `TABLE-COMPONENT-PROPERTY-REFERENCES-INSTANCE-SUBLAYER`. Nested cell-label TEXT `characters` teaching cleared. Page `165:40704` cleaned. Do not restart v3 attempt 2 as-is. Not live. |
...
| Data Table  | **live v3 attempt 1 failed closed at writer TABLE-COMPONENT-PROPERTY-REFERENCES-INSTANCE-SUBLAYER; mint cleaned; not live; no human grade; overall false**                                                     | Do not restart v3 attempt 2 as-is. Next teaching: bind row Cell N on original non-instance-sublayer TEXT in the row component. Do not invent a Data Table human grade. Do not write Input `115:295378` or Combobox `163:35981`. |
