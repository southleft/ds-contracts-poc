...
| A5cw | PREPARE INPUT V43. Copy the v42 stack. Do not patch hashed v42 scene-readback, extract, restore, writer, or runtime bytes. Teach host to omit surface stroke `dashPattern` that compile never emits. Surface stroke only. Do not invent variables. Do not invent a dashPattern value. Do not teach FIXED as a fill. | **Draft prepared** on top of `ef594ad743547ceda32bfae0c1d18ef94072206c`. Antecedent index SHA-256 `92182006293e6fc003492f98651f898b55bea63a0272a7619d22139e11135d3b`. |
| A5cx | AUTHORIZE INPUT V43 as a **separate** later commit. New prepare-era Ed25519 signer. Antecedent is the PREPARE commit. Auth lifecycle stays out of the hash set. Do not patch hashed v42 or v43 bytes. | Open after PREPARE. |
...
After PREPARE INPUT V43 is published:

```
# AUTHORIZE INPUT V43 — pin prepare-era operator signer
# do not patch hashed v42 or v43; do not restart v42 attempt 2 as-is
```
