...
| Data Table  | **offline recipe v1 authored; writer `ds.contracts.table.recipe.v1` mock-mint green (20 variants / 22 instances per source); no live; no human grade; overall false**                                                     | next hill is PREPARE Table live v1 on a new Scratch page. Do not invent a Data Table human grade. Do not write Input `115:295378` or Combobox `163:35981`. |
