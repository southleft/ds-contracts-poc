...
**Stop.** Size-axis order held. Remaining leftovers are Polar `intrinsicSize.width` value drift and Polar effect spread value drift only. Do not invent Polar pixels or spreads. Do not open V73 for those values.
