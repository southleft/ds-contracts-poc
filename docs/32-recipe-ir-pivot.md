...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v12 RECORD `60da70581`. **Calendar live v13 PREPARE opening** on the measured teaching: host-omit `effects` on `calendar/week/${n}` frames. Astryx only. Run `19be1c96-calendar-v13`. AUTHORIZE and attempt 1 still ahead. `react-day-picker@10.0.1` remains a named refusal. Do not remint Table. Do not restart v12 attempt 2 as-is. |
...
| Calendar    | **live v12 attempt 1 failed closed; v13 PREPARE opening (host-omit week-frame effects); Astryx only; no mint; no human grade; overall false** | AUTHORIZE then attempt 1 on a new Scratch page. Do not restart v12 attempt 2 as-is. Do not invent a Calendar human grade. |
