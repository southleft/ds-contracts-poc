...
> PREPARE lands the one teaching: bind row Cell N on original,
> non-instance-sublayer TEXT in the row component through host-listed
> `characters`; do not set `componentPropertyReferences` on TEXT nested
> inside a cell INSTANCE. Header Inter `Semi Bold` stays. Cell instances
> stay. Not live. Product **v1 is incomplete**. Remaining: Data Table,
...
the partial page `165:40704` was cleaned. Table live v4 PREPARE lands the
one row-owned TEXT `characters` teaching. No Data Table live mint and no
...
| D2 | Scratch-only Data Table live, same receipts bar. | **Table live v4 prepared 2026-08-29.** One teaching: bind row Cell N on original non-instance-sublayer TEXT through host-listed `characters`. v3 RECORD `b023b417a` stands. Do not restart v3 attempt 2 as-is. Not live. |
...
| Data Table  | **live v4 prepared; one teaching bind row Cell N on original non-instance-sublayer TEXT characters; v3 attempt 1 failed closed; not live; no human grade; overall false**                                                     | Do not restart v3 attempt 2 as-is. Do not invent a Data Table human grade. Do not write Input `115:295378` or Combobox `163:35981`. |
