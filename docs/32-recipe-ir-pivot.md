...
| A5bd | PREPARE INPUT V28. Copy the v27 stack. Do not patch hashed v27 scene-readback, extract, restore, writer, or runtime bytes. Teach host to omit content/placeholder and content/value `type.letterSpacing` that compile never emits. Do not invent variables. Do not invent a letterSpacing value. Do not teach FIXED as a fill. | **Draft prepared** on top of `1f455f99710f617106e192c904b6609d0f04b6ee`. Antecedent index SHA-256 `ae452c62e4867fddca3b2a1b4ac0a123c8a057ce7581020cfee4ad72e7c3f3cd`. |
| A5be | AUTHORIZE INPUT V28 as a **separate** commit. New prepare-era Ed25519 signer. Antecedent is this PREPARE commit. Auth lifecycle stays out of the hash set. Do not patch hashed v27 or v28 bytes. | Open. |
...
After PREPARE INPUT V28 is published:

```
npm run recipe:input-field:live:v28:history:verify -- --expect-pending
# then AUTHORIZE INPUT V28 as a separate commit; live remains forbidden until authorization, attestation, and preflight pass
```
