...
V84 attempt 1 closed after required cleanup. Probe teaching held: overlap 0 after excluding opacity-0 occupancy spacers; trailing stayed at x=165. Accounting 0/0 both; collapse stable both; 128 captures technicalPassed. Mint cleaned; mint did not stay. Probe was otherwise green, so V85 cleanup-on-failure-only is named. Do not revert v19. Do not invent overlap-zero. Do not restart V84 attempt 2 without a new teaching. Do not restart V83 attempt 2. Do not claim v1 complete.
