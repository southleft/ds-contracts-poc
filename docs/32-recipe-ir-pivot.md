...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v1 RECORD `b6182cb8e`. **Calendar live v2 PREPARE opening** on the measured teaching: FIXED day-cell box before children, plus hug-text intrinsic before a 0-width parent can collapse it. Astryx only. Run `19be1c96-calendar-v2`. AUTHORIZE and attempt 1 still ahead. `react-day-picker@10.0.1` remains a named refusal. Do not remint Table. Do not restart v1 attempt 2 as-is. |
...
| Calendar    | **live v1 attempt 1 failed closed; v2 PREPARE opening (day-box-before-children + hug-text intrinsic); Astryx only; no mint; no human grade; overall false** | AUTHORIZE then attempt 1 on a new Scratch page. Do not restart v1 attempt 2 as-is. Do not invent a Calendar human grade. |
