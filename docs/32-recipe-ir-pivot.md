...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v9 AUTHORIZE `e009bf0a3`. **Attempt 1 failed closed 2026-08-29** at extract `unsupported structural edit at $.children[0].children[0].children[2].children[0].children[0].bindings[0].field`. Writer accepted (page `173:50722`, sets `173:50752` / `173:50784` / `173:50901`); restore 4 held; week-frame itemSpacing held. Role `calendar/week/0/number`: compile `type.fontSize`, `fills.0.color`, `width.value`; host emitted fills first. Signed cleanup removed the page and collection `173:50724`. Input/Combobox/Button/Table stayed. Do not restart v9 attempt 2 as-is. Next teaching: host-order week-number TEXT bindings. `react-day-picker@10.0.1` remains a named refusal. Do not remint Table. |
...
| Calendar    | **live v9 attempt 1 failed closed at extract week/0/number bindings[0].field; writer accepted; restore 4 held; week-frame itemSpacing held; mint cleaned; Input/Combobox/Button/Table stayed; no mint; no human grade; overall false** | Do not restart v9 attempt 2 as-is. Next teaching: host-order week-number TEXT bindings. Do not invent a Calendar human grade. |
