...
AUTHORIZE INPUT V73 as a **separate** later commit. New prepare-era Ed25519 signer. Antecedent is this PREPARE commit (do not self-hash it here). Auth lifecycle stays out of the hash set. Keep v17 writer. Scratch-only `byMp6lt0Ij9b2QbkDGFwBh`. New txn `private/input-live-v73-transaction`. Do **not** invent 9/30/0. Do **not** restart V72. Do **not** reuse page `110:239941` or `private/input-live-v72-transaction`.
