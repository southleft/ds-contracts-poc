...
After AUTHORIZE INPUT V73 is published:

```
npm run recipe:input-field:live:v73:history:verify -- --expect-authorized
```

Then attestation (private 0600) + Scratch-only live attempt 1. New txn `private/input-live-v73-transaction`. Keep v17 writer. Do **not** invent 9/30/0. Do **not** restart V72. Do **not** reuse page `110:239941` or `private/input-live-v72-transaction`.
