...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v11 AUTHORIZE `cc89c18e0`. **Attempt 1 failed closed 2026-08-29** at extract `unsupported structural edit at $.children[0].children[0].children[2].children[0].cornerRadius`. Writer accepted (page `173:51082`, sets `173:51112` / `173:51144` / `173:51261`); restore 4 held; week-frame clipsContent omit held. Compile `calendar/week/0` omits `cornerRadius`; host emitted the key. Signed cleanup removed the page and collection `173:51084`. Input/Combobox/Button/Table stayed. Do not restart v11 attempt 2 as-is. Next teaching: host-omit week-frame cornerRadius. `react-day-picker@10.0.1` remains a named refusal. Do not remint Table. |
...
| Calendar    | **live v11 attempt 1 failed closed at extract week/0 cornerRadius; writer accepted; restore 4 held; clipsContent omit held; mint cleaned; Input/Combobox/Button/Table stayed; no mint; no human grade; overall false** | Do not restart v11 attempt 2 as-is. Next teaching: host-omit week-frame cornerRadius. Do not invent a Calendar human grade. |
