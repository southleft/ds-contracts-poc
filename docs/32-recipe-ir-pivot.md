...
AUTHORIZE INPUT V78 as a **separate** later commit. New prepare-era Ed25519 signer. Antecedent is the V78 PREPARE commit. Auth lifecycle stays out of the hash set. Do not patch hashed v16, v17, v18, or v77 bytes. Do not invent Polar 9/30/0 or a Polar content-row. Do not invent overlap-zero. Do not teach FIXED. Do not claim v1 complete.
