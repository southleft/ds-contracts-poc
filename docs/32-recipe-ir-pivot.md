...
| Calendar    | **live v23 attempt 1 mint stayed on `173:53929`; probe and 8 captures passed; cleanup persisted not executed; Astryx only; no human grade; overall true (mint-stayed pin)** | Open Calendar page `173:53929` only. Do not open Input `115:295378`, Combobox `163:35981`, Table `173:48924`, or Button `85:6781` as Calendar. Do not invent a Calendar human grade. Do not start Button leftover. Product v1 incomplete. |
