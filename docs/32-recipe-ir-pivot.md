...
PREPARE V79 (this commit): one writer teaching — hidden FILL placeholder still occupies the main axis. Hashed v16/v17/v18 writer and v78 scene-readback stay frozen. Separate AUTHORIZE, attest, Scratch-only live on `byMp6lt0Ij9b2QbkDGFwBh`, RECORD. Do **not** invent overlap-zero. Do **not** probe-hide. Do **not** invent Polar 9/30/0 or a Polar content-row. Do **not** teach FIXED. Do **not** invent plugin `layoutSizingHorizontal`. Do **not** restart V77 or V78 attempt 2. Do **not** claim v1 complete. If live still overlaps because Figma still drops the node, RECORD the truth.
