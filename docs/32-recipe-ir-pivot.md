...
V84 prepare is named (probe exclude of opacity-0 occupancy overlap). Live remains forbidden until a separate authorization. Do not revert v19. Do not invent overlap-zero. Do not restart V83 attempt 2. Do not claim v1 complete.
