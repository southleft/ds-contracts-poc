...
| A5eb | AUTHORIZE INPUT V53 as a **separate** later commit. New prepare-era Ed25519 signer. Antecedent `34f5b20a738770c073d8b2ebffc236293066ddbb`. Auth lifecycle stays out of the hash set. Artifact SHA-256 `9bd80794f13755c6b0712162151307da72addd4c87250fa52a82aa358761876c`; SPKI SHA-256 `6d4081f61748a588bc1a323f47c11730758de10a3a0319d8f51d2e846563dd02`. Do not patch hashed v52 or v53 bytes. | `--expect-authorized` after publish. Then attestation + Scratch-only live. Max 3. If a hashed v53 file fails closed, open v54. |
