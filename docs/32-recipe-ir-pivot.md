...
| A5ba | PREPARE INPUT V27. Copy the v26 stack. Do not patch hashed v26 scene-readback, extract, restore, writer, or runtime bytes. Teach host to emit hug height for hidden content/placeholder and content/value text whose live `layoutSizingVertical` is FIXED after measure-while-visible. Do not invent variables. Do not teach FIXED as a fill. | **Draft prepared** on top of `b4f12c030ec24ae2e90541fa84981f7d2ec63bc1`. Antecedent index SHA-256 `692ba21729c1949819e10452fe815fe09b8d16b8ab44aa9c139fc3f26a461827`. |
| A5bb | AUTHORIZE INPUT V27 as a **separate** commit. New prepare-era Ed25519 signer. Antecedent is this PREPARE commit. Auth lifecycle stays out of the hash set. Do not patch hashed v26 or v27 bytes. | Open. |
...
After PREPARE INPUT V27 is published:

```
npm run recipe:input-field:live:v27:history:verify -- --expect-pending
# then AUTHORIZE INPUT V27 as a separate commit; live remains forbidden until authorization, attestation, and preflight pass
```
