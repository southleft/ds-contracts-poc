...
| Calendar    | **live v30 attempt 1 mint stayed on `180:56126`; probe and 8 captures passed; cleanup persisted not executed; named captionGap 8 (`header.marginBottom`); 3-week fixture-complete; Astryx only (no other reviewed calendar adapter); no human grade; overall false; product v1 incomplete** | Open Calendar page `180:56126` only. Do not open Input `115:295378`, Combobox `163:35981`, Table `173:48924`, or Button `85:6781` as Calendar. Do not invent a Calendar human grade. Do not invent weeks, month cosmetics, or a second library. Do not start Button leftover. Product v1 incomplete. |
