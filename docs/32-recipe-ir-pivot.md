...
> **Current correction status (2026-08-28 ~16:45 UTC-5; supersedes status
...
> Cleanup accepted; that Combobox page is gone. Input `115:295378` stayed.
> Do not restart v3 attempt 2 as-is. Combobox live v4 PREPARE teaches extract
> must ignore Figma-copied `ownershipKey` on descendants inside an owned
> INSTANCE and treat those nodes as generated descendants. Writer is
> unchanged. Combobox is **not live**. Do not invent a Combobox human grade.
