...
| D4 | Human review of Table/Calendar adapters before live if a human-authored adapter is required. | **Table adapters already reviewed in the v32 climb.** Calendar adapter honesty pass 2026-08-29. Calendar live v8 AUTHORIZE `728272f6d`. **Attempt 1 failed closed 2026-08-30** at extract `unsupported structural edit at $.children[0].children[0].children[2].children[0].bindings`. Writer accepted (page `173:50542`, sets `173:50572` / `173:50604` / `173:50721`); restore 4 held; Label-from-set held. Compile `calendar/week/0` carries `layout.itemSpacing`; the scene binds `itemSpacing`; host treats `calendar/week/${n}` as a row-instance and drops the key. Cleanup removed the page and collection `173:50544`. Input/Combobox/Button/Table stayed. Do not restart v8 attempt 2 as-is. Next teaching: emit week-frame itemSpacing. `react-day-picker@10.0.1` remains a named refusal. Do not remint Table. |
...
| Calendar    | **live v8 attempt 1 failed closed at extract week/0 bindings; writer accepted; restore 4 held; mint cleaned; Input/Combobox/Button/Table stayed; no mint; no human grade; overall false** | Do not restart v8 attempt 2 as-is. Next teaching: host-emit week-frame layout.itemSpacing. Do not invent a Calendar human grade. |
