...
> sanitization taught; name first-segment then held (300/301). Silent is now
> Altitude **451/8706**, Fluent **451/8778**. Remaining is
> font/set/componentRef/value drift. Roboto/SemiBold were not
...
| B2 | Fresh scene-derived inversion/accounting from the live Button page, not stamped/self-selected IR. Do not collide with or rewrite that page except as an explicit later proof if required. | **Measured 2026-08-28.** First run: Altitude 8706 / 5795 / **2911 silent**; Fluent 8778 / 5891 / **2887 silent**. Then role, unique same-key token sanitize, and name first-segment. After those: Altitude 8706 / 8255 / **451 silent**; Fluent 8778 / 8327 / **451 silent**. Fixed point still not stable (`button/set` on live set name `Button / button@1 proof`). Page `85:6781` unread-write; Input page `115:295378` untouched. Not silent-zero. |
...
| zero-silent accounting                    | **measured / not zero** | silent derived as expectedFacts − matched: Altitude **451/8706**, Fluent **451/8778** after role+token+name first-segment teachings |
...
- After those: Altitude **451/8706** (8255 matched), Fluent **451/8778**
  (8327 matched). Name leftover 1 (set). Binding leftover 144/144 (compile
...
zero (Altitude **451/8706**, Fluent **451/8778** after role+token+name first-segment teachings),
